...
(async ()=>{
  await inspect('http://localhost:4174/legacy/Change%20Maturity%20Assessment%20Tool%20V5.20.html');
  await inspect('http://localhost:4174/refactored/Refactored-Maturity-V5.html');
})();
