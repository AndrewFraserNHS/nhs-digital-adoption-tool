...
adoption.`,Pt={"Pathway 1 - We are starting product for the first time":"pathway-1","Pathway 2 - We have piloted product and need to scale up":"pathway-2","Pathway 3 - product is live but adoption is patchy":"pathway-3","Pathway 1 - Pilot":"pathway-1","Pathway 2 - Scale up":"pathway-2","Pathway 3 - Reassess":"pathway-3"},Lr={vision:"Vision",case_for_change:"Case for Change",sponsorship:"Senior Sponsorship and Governance",change_network:"Change Network",benefits:"Benefits and WIIFM",stakeholder:"Stakeholder Engagement and Communication",process_change:"Process Change and Ways of Working",change_impact:"Change Impact and Risk",risk_management:"Change Impact and Risk",skills_learning:"Skills, Learning, Capability and Confidence",capability:"Skills, Learning, Capability and Confidence",change_adoption:"Change Adoption",transfer_bau:"Transfer to BAU",reinforcement:"Reinforcement",resistance:"Resistance",cm_readiness:"Readiness and Planning",org_maturity:"Organisational Change Management Maturity"};function Mr(n){return n.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,"")}function Dt(n){return n.replace(/\bAVT\b/g,"${productName}")}function Br(n){const t=n.split(/\r?\n/).map(i=>i.trim()),s={};let a=0;for(;a<t.length;){const i=t[a],l=Pt[i];if(!l){a+=1;continue}for(a+=1;a<t.length&&!t[a];)a+=1;if(a>=t.length)break;const o=t[a];for(a+=1;a<t.length&&(!t[a]||t[a]==="Are you on track?");)a+=1;let r="";if(a<t.length&&t[a].startsWith("Descriptor:"))for(r=Dt(t[a].replace("Descriptor:","").trim()),a+=1;a<t.length&&t[a]&&!t[a].startsWith("☐")&&!t[a].startsWith("ARE YOU ON TRACK?")&&!Pt[t[a]];)r=Dt(`${r} ${t[a]}`.trim()),a+=1;const c=[];for(;a<t.length&&t[a].startsWith("☐");){const h=Dt(t[a].replace(/^☐\s*/,"").trim()),d=`${l}:${Mr(o)}:${c.length+1}`;c.push({key:d,text:h}),a+=1}for(s[o]||(s[o]={}),s[o][l]={domain:o,descriptor:r,checklist:c};a<t.length&&t[a]&&!Pt[t[a]];)a+=1}return s}const Gr=Br(Tr);function Fr(n){return Lr[n]||null}function si(n,t){var a;const s=Fr(n);return s&&((a=Gr[s])==null?void 0:a[t])||null}function Ur(n,t){if(!t||t.checklist.length===0)return{status:"on-track",completionPct:100,checkedCount:0,totalCount:0};const s=t.checklist.length,a=new Set(n),i=t.checklist.filter(o=>a.has(o.key)).length,l=Math.round(i/s*100);return l>=80?{status:"on-track",completionPct:l,checkedCount:i,totalCount:s}:l>=45?{status:"attention",completionPct:l,checkedCount:i,totalCount:s}:{status:"off-track",completionPct:l,checkedCount:i,totalCount:s}}function Hr(n){const t=Ur(n.checkedItemKeys,n.rule);return!n.rule||n.rule.checklist.length===0?{status:n.averageScore>=n.targetScore?"on-track":"attention",completionPct:t.completionPct,checkedCount:t.checkedCount,totalCount:t.totalCount}:t.status==="off-track"?t:n.averageScore<Math.max(1,n.targetScore-1)&&t.status!=="on-track"?{...t,status:"attention"}:t}const $t=[1,2,3,4,5];function Wr(n,t){const s=n.lenses.reduce((a,i)=>a+Number(t(n.id,i).score||0),0);return n.lenses.length?Number((s/n.lenses.length).toFixed(1)):0}function Vr(n,t,s,a,i,l){if(n.phase>s)return{label:"Not in current phase yet",rowClass:l?"border-slate-600 bg-slate-800/80":"border-slate-200 bg-slate-50",chipClass:l?"bg-slate-700 text-slate-100":"bg-slate-200 text-slate-700",barClass:"bg-slate-400"};const o=si(n.id,a),r=Hr({averageScore:t,targetScore:n.target,checkedItemKeys:i,rule:o});return r.status==="off-track"?{label:`Off track (${r.completionPct}% checklist)`,rowClass:l?"border-red-700 bg-red-950/45":"border-red-200 bg-red-50",chipClass:l?"bg-red-900 text-red-100":"bg-red-100 text-red-700",barClass:"bg-red-500"}:r.status==="attention"?{label:`Needs attention (${r.completionPct}% checklist)`,rowClass:l?"border-amber-700 bg-amber-950/45":"border-amber-200 bg-amber-50",chipClass:l?"bg-amber-900 text-amber-100":"bg-amber-100 text-amber-700",barClass:"bg-amber-500"}:t>=n.target?{label:`On track (${r.completionPct}% checklist)`,rowClass:l?"border-green-700 bg-green-950/45":"border-green-200 bg-green-50",chipClass:l?"bg-green-900 text-green-100":"bg-green-100 text-green-700",barClass:"bg-green-500"}:n.phase<s?{label:"Behind timeline",rowClass:l?"border-red-700 bg-red-950/45":"border-red-200 bg-red-50",chipClass:l?"bg-red-900 text-red-100":"bg-red-100 text-red-700",barClass:"bg-red-500"}:n.phase===s?{label:"Due this phase",rowClass:l?"border-amber-700 bg-amber-950/45":"border-amber-200 bg-amber-50",chipClass:l?"bg-amber-900 text-amber-100":"bg-amber-100 text-amber-700",barClass:"bg-amber-500"}:{label:"In progress",rowClass:l?"border-blue-700 bg-blue-950/45":"border-blue-200 bg-blue-50",chipClass:l?"bg-blue-900 text-blue-100":"bg-blue-100 text-blue-700",barClass:"bg-blue-500"}}function qr({components:n,metrics:t,getEntry:s,onComponentClick:a,pathway:i,pathwayChecks:l,darkMode:o=!1}){const r=pn("component-delivery-timeline"),c=n.map(h=>{var f;const d=Wr(h,s),m=((f=l[h.id])==null?void 0:f[i])||[];return{component:h,average:d,status:Vr(h,d,t.currentPhase,i,m,o)}});return e.jsxs("section",{className:"max-w-6xl mx-auto space-y-6",children:[e.jsxs("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-2xl border p-6 shadow-sm`,children:[e.jsx("p",{className:`text-sm font-semibold uppercase tracking-[0.18em] ${o?"text-slate-300":"text-slate-500"}`,children:"Component Delivery Timeline"}),e.jsxs("div",{className:"mt-2 flex items-center gap-2",children:[e.jsx("h2",{className:`text-2xl font-bold ${o?"text-slate-100":"text-slate-900"}`,children:"Component delivery timeline"}),e.jsx(yn,{onClick:r.reopen,darkMode:o})]}),e.jsx("p",{className:`mt-2 text-sm ${o?"text-slate-300":"text-slate-600"}`,children:"This gantt-style view shows when each component should be completed by phase. Components are coloured by whether they are on track against the current phase. Select a row to jump into the matching assessment tab."})]}),e.jsx(vn,{open:r.isOpen,onClose:r.close,title:"Component Delivery Timeline",darkMode:o,body:e.jsx("p",{children:"A gantt-style view of when each component should be completed by phase, coloured by whether it's on track. Select a row to jump straight into that component's assessment."})}),e.jsx("div",{className:"lg:hidden space-y-3",children:c.map(({component:h,average:d,status:m})=>e.jsxs("button",{type:"button",onClick:()=>a(h.id),className:`w-full rounded-xl border p-4 text-left transition-colors ${o?"hover:border-slate-500":"hover:border-slate-300"} ${m.rowClass}`,children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-2",children:[e.jsxs("div",{children:[e.jsx("div",{className:`text-sm font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:h.label}),e.jsxs("div",{className:`mt-1 text-xs ${o?"text-slate-300":"text-slate-500"}`,children:["Target readiness: ",Kt(h.target)," · completes by Phase"," ",h.phase]})]}),e.jsx("span",{className:`rounded-full px-4 py-1 text-xs font-semibold ${m.chipClass}`,children:m.label})]}),e.jsxs("div",{className:"mt-3",children:[e.jsxs("div",{className:`mb-1 flex items-center justify-between text-xs ${o?"text-slate-300":"text-slate-600"}`,children:[e.jsx("span",{children:"Timeline"}),e.jsxs("span",{children:["Average ",d]})]}),e.jsx("div",{className:"grid grid-cols-5 gap-1",children:$t.map(f=>{const b=f<=h.phase,y=f===h.phase;return e.jsxs("div",{children:[e.jsx("div",{className:`h-2 rounded-full ${o?"bg-slate-700/70":"bg-white/80"}`,children:b?e.jsx("div",{className:`h-full rounded-full ${m.barClass} ${y?"opacity-100":"opacity-35"}`,title:y?"Expected completion phase":"Planned timeline"}):null}),e.jsxs("div",{className:`mt-1 text-center text-[10px] ${o?"text-slate-400":"text-slate-500"}`,children:["P",f]})]},`${h.id}-mobile-${f}`)})})]})]},`mobile-${h.id}`))}),e.jsx("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} hidden lg:block rounded-2xl border p-5 shadow-sm overflow-x-auto`,children:e.jsxs("div",{className:"min-w-[860px]",children:[e.jsxs("div",{className:`grid grid-cols-[230px_repeat(5,minmax(92px,1fr))_90px_115px] gap-2 border-b pb-3 text-xs font-semibold uppercase tracking-wider ${o?"border-slate-700 text-slate-400":"border-slate-200 text-slate-500"}`,children:[e.jsx("div",{children:"Component"}),$t.map(h=>e.jsxs("div",{className:"text-center",children:["Phase ",h]},h)),e.jsx("div",{className:"text-center",children:"Average"}),e.jsx("div",{className:"text-center",children:"Status"})]}),e.jsx("div",{className:"mt-4 space-y-3",children:c.map(({component:h,average:d,status:m})=>e.jsxs("button",{type:"button",onClick:()=>a(h.id),className:`grid w-full grid-cols-[230px_repeat(5,minmax(92px,1fr))_90px_115px] gap-2 rounded-xl border p-2.5 text-left transition-colors ${o?"hover:border-slate-500":"hover:border-slate-300"} ${m.rowClass}`,children:[e.jsxs("div",{children:[e.jsx("div",{className:`text-sm font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:h.label}),e.jsxs("div",{className:`mt-1 text-xs ${o?"text-slate-300":"text-slate-500"}`,children:["Target readiness: ",Kt(h.target)," · completes by Phase"," ",h.phase]})]}),$t.map(f=>{const b=f<=h.phase,y=f===h.phase;return e.jsx("div",{className:"flex items-center justify-center",children:e.jsx("div",{className:`h-7 w-full rounded-full px-1 py-1 ${o?"bg-slate-700/70":"bg-white/70"}`,children:b?e.jsx("div",{className:`h-full rounded-full ${m.barClass} ${y?"opacity-100":"opacity-35"}`,title:y?"Expected completion phase":"Planned timeline"}):null})},`${h.id}-${f}`)}),e.jsx("div",{className:`flex items-center justify-center text-sm font-semibold ${o?"text-slate-100":"text-slate-700"}`,children:d}),e.jsx("div",{className:"flex items-center justify-center",children:e.jsx("span",{className:`rounded-full text-center px-2.5 py-1 text-xs font-semibold ${m.chipClass}`,children:m.label})})]},h.id))}),e.jsxs("div",{className:`mt-4 rounded-md border p-3 text-xs ${o?"border-slate-700 bg-slate-900 text-slate-300":"border-slate-200 bg-slate-50 text-slate-700"}`,children:[e.jsx("span",{className:"font-semibold",children:"Key:"})," Grey rows are not yet due for the current phase. Red rows indicate overdue or off-track work."]})]})})]})}function Yr(n){return Pi.sanitize(n,{USE_PROFILES:{html:!0}})}const Kr=[{label:"Bold",command:"bold",icon:"B"},{label:"Italic",command:"italic",icon:"I"},{label:"Bullet list",command:"insertUnorderedList",icon:"•"},{label:"Numbered list",command:"insertOrderedList",icon:"1."}];function ca({value:n,onChange:t,placeholder:s,className:a}){const i=g.useRef(null);g.useEffect(()=>{const c=i.current;c&&c.innerHTML!==n&&(c.innerHTML=n)},[n]);const l=()=>{const c=i.current;c&&t(Yr(c.innerHTML))},o=c=>{var h;(h=i.current)==null||h.focus(),document.execCommand(c,!1),l()},r=!n||n==="<br>";return e.jsxs("div",{className:`rounded-md border border-slate-300 bg-white ${a||""}`,children:[e.jsx("div",{"data-print-hide":"true",className:"flex items-center gap-1 border-b border-slate-200 bg-slate-50 px-1.5 py-1",children:Kr.map(c=>e.jsx("button",{type:"button",title:c.label,"aria-label":c.label,onMouseDown:h=>h.preventDefault(),onClick:()=>o(c.command),className:"flex h-6 min-w-[1.5rem] items-center justify-center rounded px-1 text-xs font-bold text-slate-600 hover:bg-slate-200",children:c.icon},c.command))}),e.jsxs("div",{className:"relative",children:[r&&s?e.jsx("span",{className:"pointer-events-none absolute left-2 top-1.5 text-sm text-slate-400",children:s}):null,e.jsx("div",{ref:i,contentEditable:!0,suppressContentEditableWarning:!0,onInput:l,onBlur:l,className:"min-h-[4.5rem] px-2 py-1.5 text-sm text-slate-800 outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5"})]})]})}function sn(){return`${Date.now()}-${Math.random().toString(36).slice(2,8)}`}const Jt="nhs-highlight-builder-layout",Tt=[{id:"executive-summary",label:"Executive Summary"},{id:"change-dashboard",label:"Change Dashboard"},{id:"adoption-metrics",label:"Adoption Metrics"},{id:"what-went-well",label:"What Went Well"},{id:"risks-issues",label:"Key Risks and Issues"},{id:"stakeholder-insights",label:"Stakeholder Insights"},{id:"interventions-delivered",label:"Change Interventions Delivered"},{id:"upcoming-priorities",label:"Upcoming Priorities"},{id:"decisions-required",label:"Decisions Required"},{id:"change-lead-assessment",label:"Change Lead Assessment"}],zr={"executive-summary":{label:"Headline scorecard",kind:"donut"},"change-dashboard":{label:"RAG trend chart",kind:"trend"},"adoption-metrics":{label:"KPI scorecard",kind:"bars"},"what-went-well":{label:"Achievement tiles",kind:"steps"},"risks-issues":{label:"Risk heat map",kind:"risk"},"stakeholder-insights":{label:"Sentiment split",kind:"donut"},"interventions-delivered":{label:"Intervention timeline",kind:"steps"},"upcoming-priorities":{label:"30-day roadmap",kind:"steps"},"decisions-required":{label:"Decision funnel",kind:"trend"},"change-lead-assessment":{label:"Confidence profile",kind:"bars"}},Fn=["#005eb8","#41a6c8","#78be20","#ffb81c","#da291c"],xn={title:"Executive Highlight Report",themeColor:"#005eb8",logoDataUrl:"",programmeName:"",reportingPeriod:"",changeLeadName:"",sroName:"",overallStatus:"Amber",orientation:"landscape",bragSlides:[],sections:["executive-summary","change-dashboard","adoption-metrics","what-went-well","risks-issues","stakeholder-insights","interventions-delivered","upcoming-priorities","decisions-required","change-lead-assessment"],sectionNarratives:{},metricRows:[],riskRows:[],stakeholderPositivePct:0,stakeholderNeutralPct:0,stakeholderNegativePct:0,interventionRows:[],decisionRows:[],assessmentRows:[]},Jr={Green:"bg-green-100 text-green-800 border-green-200",Amber:"bg-amber-100 text-amber-800 border-amber-200",Red:"bg-red-100 text-red-800 border-red-200"},Xr={Green:"bg-green-500",Amber:"bg-amber-500",Red:"bg-red-500"};function da({status:n}){return e.jsxs("span",{className:`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs font-semibold ${Jr[n]}`,children:[e.jsx("span",{className:`h-2 w-2 rounded-full ${Xr[n]}`}),n]})}function Qr({rows:n}){const t=Math.max(5,...n.flatMap(s=>[s.current,s.target]));return e.jsxs("div",{className:"space-y-5","aria-label":"Current component scores compared with targets",children:[n.map(s=>e.jsxs("div",{className:"grid grid-cols-[minmax(130px,1fr),minmax(220px,2fr),48px] items-center gap-3",children:[e.jsx("span",{className:"text-sm font-semibold text-[#425563]",children:s.label}),e.jsxs("div",{className:"relative h-8 rounded bg-[#e8edee]",children:[e.jsx("div",{className:"absolute inset-y-0 left-0 rounded bg-[#005eb8]",style:{width:`${Math.min(100,s.current/t*100)}%`}}),e.jsx("div",{className:"absolute inset-y-[-4px] w-0.5 bg-[#da291c]",style:{left:`${Math.min(100,s.target/t*100)}%`},title:`Target ${s.target}`})]}),e.jsx("span",{className:"text-right text-sm font-bold text-[#005eb8]",children:s.current.toFixed(1)})]},s.label)),e.jsxs("div",{className:"flex flex-wrap gap-5 border-t border-[#d8dde0] pt-4 text-xs text-[#425563]",children:[e.jsxs("span",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"h-3 w-3 rounded-sm bg-[#005eb8]"})," Current average"]}),e.jsxs("span",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"h-4 w-0.5 bg-[#da291c]"})," Target marker"]})]})]})}function Zr(){return e.jsx("span",{className:"flex h-4 w-4 shrink-0 items-center justify-center rounded bg-green-500 text-[10px] font-bold text-white",children:"✓"})}function Jn(n,t){return`${n+1}. ${t}`}function ai(n){return Array.isArray(n)?n.filter(t=>!!t&&typeof t=="object").map(t=>({id:t.id||sn(),componentId:t.componentId||"",rows:Array.isArray(t.rows)?t.rows.filter(s=>!!s&&typeof s=="object").map(s=>({id:s.id||sn(),preventingGreenHtml:s.preventingGreenHtml||"",returnToGreenHtml:s.returnToGreenHtml||"",ownerId:s.ownerId||"",targetDate:s.targetDate||"",linkedActionId:s.linkedActionId})):[]})):[]}function st(n,t){return Array.isArray(n)?n.filter(s=>!!s&&typeof s=="object").map(t):[]}function ii(n){return st(n,t=>({id:t.id||sn(),measure:t.measure||"",target:t.target||"",current:t.current||"",status:t.status==="Green"||t.status==="Amber"||t.status==="Red"?t.status:"Amber"}))}function oi(n){return st(n,t=>({id:t.id||sn(),risk:t.risk||"",impact:t.impact||"",mitigation:t.mitigation||"",status:t.status||"Open"}))}function ri(n){return st(n,t=>({id:t.id||sn(),text:t.text||""}))}function li(n){return st(n,t=>({id:t.id||sn(),decision:t.decision||"",owner:t.owner||"",requiredBy:t.requiredBy||""}))}function ci(n){return st(n,t=>({id:t.id||sn(),area:t.area||"",confidence:t.confidence==="High"||t.confidence==="Medium"||t.confidence==="Low"?t.confidence:"Medium"}))}function el(){const n=Sn(Jt);if(!n)return xn;try{return{...xn,...n,overallStatus:n.overallStatus==="Green"||n.overallStatus==="Amber"||n.overallStatus==="Red"?n.overallStatus:xn.overallStatus,orientation:n.orientation==="portrait"||n.orientation==="landscape"?n.orientation:xn.orientation,bragSlides:ai(n.bragSlides),sections:Array.isArray(n.sections)&&n.sections.length>0?n.sections:xn.sections,metricRows:ii(n.metricRows),riskRows:oi(n.riskRows),stakeholderPositivePct:Number(n.stakeholderPositivePct)||0,stakeholderNeutralPct:Number(n.stakeholderNeutralPct)||0,stakeholderNegativePct:Number(n.stakeholderNegativePct)||0,interventionRows:ri(n.interventionRows),decisionRows:li(n.decisionRows),assessmentRows:ci(n.assessmentRows)}}catch{return xn}}function nl({store:n,metrics:t,lenses:s,components:a=tt,getEntry:i,trustName:l,projectName:o,themeColor:r,onLayoutSaved:c,darkMode:h=!1,currentUserId:d}){const m=pn("highlight-builder"),f=n.orgProfile.teamMembers||[],[b,y]=g.useState(()=>{const S=el();return r&&!S.themeColor?{...S,themeColor:r}:S}),[E,j]=g.useState(""),[x,I]=g.useState(0),q=g.useRef(null),C=g.useMemo(()=>new Set(b.sections),[b.sections]),T=g.useMemo(()=>b.sections.reduce((S,R,k)=>(S[R]=k,S),{}),[b.sections]),P=b.orientation==="landscape",ue=P?"overflow-hidden rounded-lg border border-[#003087] bg-white shadow-md":"rounded-md border border-slate-200 bg-white p-4",B=P?{}:{borderLeft:`3px solid ${b.themeColor}`};function z({children:S}){return P?e.jsx("div",{className:"-mx-0 -mt-0 mb-4 px-5 py-3 text-base font-bold uppercase tracking-wide text-white",style:{backgroundColor:b.themeColor||It.blue},children:S}):e.jsx("div",{className:"mb-2 border-b border-slate-200 pb-1 text-xs font-bold uppercase tracking-wider text-slate-500",children:S})}function le({children:S}){return P?e.jsx("div",{className:"px-5 pb-5 text-[15px]",children:S}):e.jsx(e.Fragment,{children:S})}const ie=g.useMemo(()=>a.map(S=>{let R=0;S.lenses.forEach(A=>{R+=Number(i(S.id,A).score||0)});const k=Number((R/S.lenses.length).toFixed(1));return{component:S,average:k,target:S.target,gap:Number(Math.max(0,S.target-k).toFixed(1))}}),[a,i]),O=g.useMemo(()=>[...ie].sort((S,R)=>R.average-S.average).slice(0,5),[ie]),G=S=>{y(R=>({...R,...S}))},Ne=S=>{y(R=>{const k=C.has(S)?R.sections.filter(A=>A!==S):[...R.sections,S];return{...R,sections:k}})},Ce=(S,R)=>{y(k=>({...k,sectionNarratives:{...k.sectionNarratives,[S]:R}}))},Te=()=>{const S=new Set(b.bragSlides.map(A=>A.componentId)),R=a.find(A=>!S.has(A.id))||a[0],k={id:sn(),componentId:(R==null?void 0:R.id)||"",rows:[]};y(A=>({...A,bragSlides:[...A.bragSlides,k]}))},Ke=S=>{y(R=>({...R,bragSlides:R.bragSlides.filter(k=>k.id!==S)}))},L=(S,R)=>{y(k=>({...k,bragSlides:k.bragSlides.map(A=>A.id===S?{...A,componentId:R}:A)}))},oe=S=>{const R={id:sn(),preventingGreenHtml:"",returnToGreenHtml:"",ownerId:d||"",targetDate:""};y(k=>({...k,bragSlides:k.bragSlides.map(A=>A.id===S?{...A,rows:[...A.rows,R]}:A)}))},se=(S,R,k)=>{y(A=>({...A,bragSlides:A.bragSlides.map(U=>U.id===S?{...U,rows:U.rows.map(H=>H.id===R?{...H,...k}:H)}:U)}))},ge=(S,R)=>{y(k=>({...k,bragSlides:k.bragSlides.map(A=>A.id===S?{...A,rows:A.rows.filter(U=>U.id!==R)}:A)}))};function be(S,R){y(k=>({...k,[S]:[...k[S],R]}))}function ye(S,R,k){y(A=>({...A,[S]:A[S].map(U=>U.id===R?{...U,...k}:U)}))}function ne(S,R){y(k=>({...k,[S]:k[S].filter(A=>A.id!==R)}))}const De=async S=>{var A;const R=(A=S.target.files)==null?void 0:A[0];if(!R)return;const k=await new Promise((U,H)=>{const ee=new FileReader;ee.onload=()=>U(String(ee.result||"")),ee.onerror=()=>H(new Error("Unable to read selected logo file.")),ee.readAsDataURL(R)});j(R.name),y(U=>({...U,logoDataUrl:k})),I(U=>U+1)},$e=()=>{tn(Jt,b),Qn("highlight-builder-layout.json",JSON.stringify(b,null,2),"application/json"),c==null||c()},ze=async S=>{var k;const R=(k=S.target.files)==null?void 0:k[0];if(R)try{const A=await R.text(),U=JSON.parse(A);y({...xn,...U,overallStatus:U.overallStatus==="Green"||U.overallStatus==="Amber"||U.overallStatus==="Red"?U.overallStatus:xn.overallStatus,orientation:U.orientation==="portrait"||U.orientation==="landscape"?U.orientation:xn.orientation,bragSlides:ai(U.bragSlides),sections:Array.isArray(U.sections)&&U.sections.length>0?U.sections:xn.sections,sectionNarratives:U.sectionNarratives||{},metricRows:ii(U.metricRows),riskRows:oi(U.riskRows),stakeholderPositivePct:Number(U.stakeholderPositivePct)||0,stakeholderNeutralPct:Number(U.stakeholderNeutralPct)||0,stakeholderNegativePct:Number(U.stakeholderNegativePct)||0,interventionRows:ri(U.interventionRows),decisionRows:li(U.decisionRows),assessmentRows:ci(U.assessmentRows)})}catch{window.alert("Unable to load the selected layout JSON. Please verify the file contents.")}finally{S.target.value=""}};g.useEffect(()=>{tn(Jt,b)},[b]);const Me=n.history.length>1?n.history[n.history.length-2]:null,Ie=g.useMemo(()=>ie.slice(0,10).map(S=>{const R=Me?Number((S.component.lenses.reduce((H,ee)=>{var ae,Se;return H+Number(((Se=(ae=Me.data[S.component.id])==null?void 0:ae[ee])==null?void 0:Se.score)||0)},0)/S.component.lenses.length).toFixed(1)):S.average,k=S.average>R?"▲":S.average<R?"▼":"►",A=S.average>=S.target?"Green":S.average>=Math.max(1,S.target-1)?"Amber":"Red",U=S.average>=S.target?"Consistently understood by most stakeholder groups.":S.average>=Math.max(1,S.target-1)?"Progressing, with reinforcement still required.":"Below target and requiring focused intervention.";return{area:S.component.label,current:S.average,target:S.target,status:A,trend:k,commentary:U}}),[ie,Me]),cn=g.useMemo(()=>Ie.map(S=>({label:S.area,current:S.current,target:S.target})),[Ie]),Je=g.useMemo(()=>t.nextSteps.slice(0,7).map(S=>S.message),[t.nextSteps]),dn=S=>{if(S==="decisions-required")return b.decisionRows.some(R=>R.decision.trim()||R.owner.trim()||R.requiredBy.trim());if((b.sectionNarratives[S]||"").trim())return!0;switch(S){case"executive-summary":return!0;case"change-dashboard":return Ie.length>0;case"adoption-metrics":return b.metricRows.length>0;case"what-went-well":return O.length>0;case"risks-issues":return b.riskRows.length>0;case"stakeholder-insights":return b.stakeholderPositivePct+b.stakeholderNeutralPct+b.stakeholderNegativePct>0;case"interventions-delivered":return b.interventionRows.length>0;case"upcoming-priorities":return Je.length>0;case"decisions-required":return b.decisionRows.length>0;case"change-lead-assessment":return b.assessmentRows.length>0;default:return!1}},Ze=b.sections.filter(S=>dn(S)),_=S=>{let R=0;return S.reduce((k,A)=>(k[A]=R,R+=A==="change-dashboard"?2:1,k),{})},te=_(b.sections),X=_(Ze);function he({sectionId:S}){if(!P)return null;const R=zr[S],k=H=>{const ee=Number.parseFloat(H.replace("%","").trim());return Number.isFinite(ee)?Math.max(0,ee):0};if(R.kind==="donut"){const H=S==="stakeholder-insights"?[b.stakeholderPositivePct,b.stakeholderNeutralPct,b.stakeholderNegativePct]:[Number(t.overallPct),Math.max(0,100-Number(t.overallPct))],ee=H.reduce((Cn,v)=>Cn+v,0);if(!ee)return null;const ae=H[0]/ee*100,Se=H[1]/ee*100,ve=S==="stakeholder-insights"?"Positive":"Overall progress",Xe=S==="stakeholder-insights"?"Neutral":"Remaining",un=S==="stakeholder-insights"?H[2]/ee*100:0;return e.jsxs("aside",{className:"rounded-lg border border-[#c9e0f2] bg-[#f0f7fc] p-4 text-[#003087]",children:[e.jsx("p",{className:"text-xs font-bold uppercase tracking-[0.14em]",children:R.label}),e.jsx("div",{className:"mx-auto mt-4 h-32 w-32 rounded-full",style:{background:S==="stakeholder-insights"?`conic-gradient(#78be20 0 ${ae}%, #ffb81c ${ae}% ${ae+Se}%, #da291c ${ae+Se}% ${ae+Se+un}%, #d8eaf6 ${ae+Se+un}% 100%)`:`conic-gradient(#005eb8 0 ${ae}%, #41a6c8 ${ae}% ${ae+Se}%, #d8eaf6 ${ae+Se}% 100%)`,mask:"radial-gradient(circle, transparent 55%, #000 56%)",WebkitMask:"radial-gradient(circle, transparent 55%, #000 56%)"}}),e.jsxs("div",{className:"mt-4 grid gap-2 text-xs text-[#425563]",children:[e.jsxs("span",{className:"flex items-center justify-between gap-2",children:[e.jsxs("span",{children:[e.jsx("i",{className:`mr-2 inline-block h-2.5 w-2.5 rounded-full ${S==="stakeholder-insights"?"bg-[#78be20]":"bg-[#005eb8]"}`}),ve]}),e.jsxs("strong",{children:[H[0],"%"]})]}),e.jsxs("span",{className:"flex items-center justify-between gap-2",children:[e.jsxs("span",{children:[e.jsx("i",{className:`mr-2 inline-block h-2.5 w-2.5 rounded-full ${S==="stakeholder-insights"?"bg-[#ffb81c]":"bg-[#41a6c8]"}`}),Xe]}),e.jsxs("strong",{children:[H[1],"%"]})]}),S==="stakeholder-insights"?e.jsxs("span",{className:"flex items-center justify-between gap-2",children:[e.jsxs("span",{children:[e.jsx("i",{className:"mr-2 inline-block h-2.5 w-2.5 rounded-full bg-[#da291c]"}),"Negative"]}),e.jsxs("strong",{children:[H[2],"%"]})]}):null]})]})}if(R.kind==="risk"){const H=b.riskRows.reduce((Se,ve)=>{const Xe=ve.status.trim()||"Open";return Se[Xe]=(Se[Xe]||0)+1,Se},{}),ee=Object.entries(H);if(!ee.length)return null;const ae=Math.max(...ee.map(([,Se])=>Se));return e.jsxs("aside",{className:"rounded-lg border border-[#c9e0f2] bg-[#f0f7fc] p-4 text-[#003087]",children:[e.jsx("p",{className:"text-xs font-bold uppercase tracking-[0.14em]",children:R.label}),e.jsx("div",{className:"mt-5 space-y-3",children:ee.map(([Se,ve])=>e.jsxs("div",{children:[e.jsxs("div",{className:"mb-1 flex justify-between text-xs font-semibold text-[#425563]",children:[e.jsx("span",{children:Se}),e.jsx("span",{children:ve})]}),e.jsx("div",{className:"h-4 rounded bg-white",children:e.jsx("div",{className:"h-4 rounded",style:{width:`${ve/ae*100}%`,backgroundColor:Se.toLowerCase().includes("closed")?"#78be20":Se.toLowerCase().includes("at risk")?"#da291c":"#ffb81c"}})})]},Se))})]})}if(R.kind==="steps"){const H=S==="interventions-delivered"?b.interventionRows.map(ee=>ee.text.trim()).filter(Boolean):S==="upcoming-priorities"?Je:O.map(ee=>ee.component.label);return H.length?e.jsxs("aside",{className:"rounded-lg border border-[#c9e0f2] bg-[#f0f7fc] p-4 text-[#003087]",children:[e.jsx("p",{className:"text-xs font-bold uppercase tracking-[0.14em]",children:R.label}),e.jsx("div",{className:"mt-5 space-y-3",children:H.slice(0,5).map((ee,ae)=>e.jsxs("div",{className:"flex items-start gap-3 text-xs text-[#425563]",children:[e.jsx("span",{className:"flex h-5 w-5 shrink-0 items-center justify-center rounded-full font-bold text-white",style:{backgroundColor:Fn[ae%Fn.length]},children:ae+1}),e.jsx("span",{className:"pt-0.5",children:ee})]},`${ee}-${ae}`))})]}):null}if(R.kind==="trend"&&S==="decisions-required"){const H=b.decisionRows.map(ee=>ee.decision.trim()).filter(Boolean);return H.length?e.jsxs("aside",{className:"rounded-lg border border-[#c9e0f2] bg-[#f0f7fc] p-4 text-[#003087]",children:[e.jsx("p",{className:"text-xs font-bold uppercase tracking-[0.14em]",children:R.label}),e.jsx("div",{className:"mt-5 space-y-3",children:H.slice(0,5).map((ee,ae)=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"h-5 flex-1 rounded bg-white",children:e.jsx("div",{className:"h-5 rounded",style:{width:`${100-ae*15}%`,backgroundColor:Fn[ae%Fn.length]}})}),e.jsx("span",{className:"max-w-[45%] text-right text-xs text-[#425563]",children:ee})]},`${ee}-${ae}`))})]}):null}const U=(S==="adoption-metrics"?b.metricRows.map(H=>({label:H.measure,value:k(H.current),max:Math.max(100,k(H.target))})):S==="change-lead-assessment"?["High","Medium","Low"].map(H=>({label:H,value:b.assessmentRows.filter(ee=>ee.confidence===H).length,max:Math.max(1,b.assessmentRows.length)})):O.map(H=>({label:H.component.label,value:H.average,max:5}))).filter(H=>H.label.trim()&&H.value>0);return U.length?e.jsxs("aside",{className:"rounded-lg border border-[#c9e0f2] bg-[#f0f7fc] p-4 text-[#003087]",children:[e.jsx("p",{className:"text-xs font-bold uppercase tracking-[0.14em]",children:R.label}),e.jsx("div",{className:"mt-5 space-y-3",children:U.slice(0,6).map(H=>e.jsxs("div",{children:[e.jsxs("div",{className:"mb-1 flex justify-between gap-2 text-xs font-semibold text-[#425563]",children:[e.jsx("span",{children:H.label}),e.jsx("span",{children:H.value})]}),e.jsx("div",{className:"h-4 rounded bg-white",children:e.jsx("div",{className:"h-4 rounded",style:{width:`${Math.min(100,H.value/H.max*100)}%`,backgroundColor:Fn[U.indexOf(H)%Fn.length]}})})]},H.label))})]}):null}const xe=S=>{if((b.sectionNarratives[S]||"").trim())return b.sectionNarratives[S].trim();switch(S){case"executive-summary":return`${b.overallStatus}. The programme continues to progress across ${a.length} components and ${s.length} lenses, with overall delivery at ${t.overallPct}%.`;case"change-dashboard":return"Dashboard status is derived from current component averages versus targets, with trend based on the most recent finalised snapshot.";case"adoption-metrics":return"Metrics below provide an operational view of progress against key adoption measures and targets.";case"what-went-well":return"List key achievements for the reporting period, including sponsorship visibility and areas of strengthened adoption.";case"risks-issues":return"The following risks/issues require active monitoring and mitigation.";case"stakeholder-insights":return"Summarise positive feedback themes, concerns, and sentiment from stakeholder listening channels.";case"interventions-delivered":return"Capture interventions completed this month and assess their observed effectiveness.";case"upcoming-priorities":return"Set out the next 30-day focus to maintain delivery momentum and close adoption gaps.";case"decisions-required":return"Record approvals and decisions needed to unblock delivery and sustain adoption progress.";case"change-lead-assessment":return"Provide confidence ratings and the overall professional assessment from the Change Lead.";default:return""}},ke=S=>{const R=xe(S);return S==="change-dashboard"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("div",{className:"mt-3 overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 bg-white",children:[e.jsx("thead",{className:"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Area"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Status"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Trend"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Commentary"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100",children:Ie.map(k=>e.jsxs("tr",{children:[e.jsx("td",{className:"px-3 py-2 text-sm text-slate-700",children:k.area}),e.jsx("td",{className:"px-3 py-2 text-sm",children:e.jsx(da,{status:k.status})}),e.jsx("td",{className:"px-3 py-2 text-sm",children:k.trend}),e.jsx("td",{className:"px-3 py-2 text-sm text-slate-600",children:k.commentary})]},k.area))})]})})]}):S==="adoption-metrics"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("div",{className:"mt-3 overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 bg-white",children:[e.jsx("thead",{className:"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Measure"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Target"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Current"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Status"}),e.jsx("th",{"data-print-hide":"true",className:"px-3 py-2"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-100",children:[b.metricRows.map(k=>e.jsxs("tr",{children:[e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.measure,onChange:A=>ye("metricRows",k.id,{measure:A.target.value}),placeholder:"e.g. Active Users",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.target,onChange:A=>ye("metricRows",k.id,{target:A.target.value}),placeholder:"e.g. 80%",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.current,onChange:A=>ye("metricRows",k.id,{current:A.target.value}),placeholder:"e.g. 62%",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsxs("select",{value:k.status,onChange:A=>ye("metricRows",k.id,{status:A.target.value}),className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm",children:[e.jsx("option",{value:"Green",children:"Green"}),e.jsx("option",{value:"Amber",children:"Amber"}),e.jsx("option",{value:"Red",children:"Red"})]})}),e.jsx("td",{"data-print-hide":"true",className:"px-3 py-2 align-top",children:e.jsx("button",{type:"button",onClick:()=>ne("metricRows",k.id),className:"rounded-md border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})})]},k.id)),b.metricRows.length?null:e.jsx("tr",{children:e.jsx("td",{className:"px-3 py-3 text-sm text-slate-500",colSpan:5,children:"No metrics added yet."})})]})]})}),e.jsx("button",{type:"button","data-print-hide":"true",onClick:()=>be("metricRows",{id:sn(),measure:"",target:"",current:"",status:"Amber"}),className:"mt-3 rounded-md bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200",children:"+ Add Metric"})]}):S==="risks-issues"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("div",{className:"mt-3 overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 bg-white",children:[e.jsx("thead",{className:"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Risk / Issue"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Impact"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Mitigation"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Status"}),e.jsx("th",{"data-print-hide":"true",className:"px-3 py-2"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-100",children:[b.riskRows.map(k=>e.jsxs("tr",{children:[e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.risk,onChange:A=>ye("riskRows",k.id,{risk:A.target.value}),placeholder:"e.g. Inconsistent adoption in Vision",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.impact,onChange:A=>ye("riskRows",k.id,{impact:A.target.value}),placeholder:"e.g. Benefits may not be realised",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.mitigation,onChange:A=>ye("riskRows",k.id,{mitigation:A.target.value}),placeholder:"e.g. Targeted coaching sessions",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.status,onChange:A=>ye("riskRows",k.id,{status:A.target.value}),placeholder:"Open",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{"data-print-hide":"true",className:"px-3 py-2 align-top",children:e.jsx("button",{type:"button",onClick:()=>ne("riskRows",k.id),className:"rounded-md border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})})]},k.id)),b.riskRows.length?null:e.jsx("tr",{children:e.jsx("td",{className:"px-3 py-3 text-sm text-slate-500",colSpan:5,children:"No key risks added yet."})})]})]})}),e.jsx("button",{type:"button","data-print-hide":"true",onClick:()=>be("riskRows",{id:sn(),risk:"",impact:"",mitigation:"",status:"Open"}),className:"mt-3 rounded-md bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200",children:"+ Add Risk / Issue"})]}):S==="upcoming-priorities"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("ol",{className:"mt-3 list-decimal pl-5 space-y-1 text-sm text-slate-700",children:Je.length?Je.map((k,A)=>e.jsx("li",{children:k},`${k}-${A}`)):e.jsx("li",{children:"No immediate priorities detected from current data."})})]}):S==="what-went-well"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("ul",{className:"mt-3 space-y-1.5 text-sm text-slate-700",children:O.slice(0,5).map(k=>e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx(Zr,{}),k.component.label," is tracking at ",k.average," against target ",k.target,"."]},k.component.id))})]}):S==="stakeholder-insights"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsxs("div",{className:"mt-3 grid gap-2 md:grid-cols-3 text-sm",children:[e.jsxs("div",{className:"flex items-center gap-2 rounded border border-green-200 bg-green-50 p-3",children:[e.jsx("span",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-green-500"}),e.jsxs("label",{className:"flex items-center gap-1.5",children:["Positive:",e.jsx("input",{type:"number",min:0,max:100,value:b.stakeholderPositivePct,onChange:k=>G({stakeholderPositivePct:Number(k.target.value)}),className:"w-16 rounded-md border border-slate-300 px-2 py-1 text-sm"}),"%"]})]}),e.jsxs("div",{className:"flex items-center gap-2 rounded border border-amber-200 bg-amber-50 p-3",children:[e.jsx("span",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-amber-500"}),e.jsxs("label",{className:"flex items-center gap-1.5",children:["Neutral:",e.jsx("input",{type:"number",min:0,max:100,value:b.stakeholderNeutralPct,onChange:k=>G({stakeholderNeutralPct:Number(k.target.value)}),className:"w-16 rounded-md border border-slate-300 px-2 py-1 text-sm"}),"%"]})]}),e.jsxs("div",{className:"flex items-center gap-2 rounded border border-red-200 bg-red-50 p-3",children:[e.jsx("span",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-red-500"}),e.jsxs("label",{className:"flex items-center gap-1.5",children:["Negative:",e.jsx("input",{type:"number",min:0,max:100,value:b.stakeholderNegativePct,onChange:k=>G({stakeholderNegativePct:Number(k.target.value)}),className:"w-16 rounded-md border border-slate-300 px-2 py-1 text-sm"}),"%"]})]})]})]}):S==="interventions-delivered"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsxs("ul",{className:"mt-3 space-y-2 text-sm text-slate-700",children:[b.interventionRows.map(k=>e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx("input",{value:k.text,onChange:A=>ye("interventionRows",k.id,{text:A.target.value}),placeholder:"e.g. Sponsor briefing sessions",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"}),e.jsx("button",{type:"button","data-print-hide":"true",onClick:()=>ne("interventionRows",k.id),className:"shrink-0 rounded-md border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})]},k.id)),b.interventionRows.length?null:e.jsx("li",{className:"text-slate-500",children:"No interventions added yet."})]}),e.jsx("button",{type:"button","data-print-hide":"true",onClick:()=>be("interventionRows",{id:sn(),text:""}),className:"mt-3 rounded-md bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200",children:"+ Add Intervention"})]}):S==="decisions-required"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("div",{className:"mt-3 overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 bg-white",children:[e.jsx("thead",{className:"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Decision"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Owner"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Required By"}),e.jsx("th",{"data-print-hide":"true",className:"px-3 py-2"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-100",children:[b.decisionRows.map(k=>e.jsxs("tr",{children:[e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.decision,onChange:A=>ye("decisionRows",k.id,{decision:A.target.value}),placeholder:"e.g. Approval for additional adoption support resource",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.owner,onChange:A=>ye("decisionRows",k.id,{owner:A.target.value}),placeholder:"e.g. Programme Board",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.requiredBy,onChange:A=>ye("decisionRows",k.id,{requiredBy:A.target.value}),placeholder:"TBC",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{"data-print-hide":"true",className:"px-3 py-2 align-top",children:e.jsx("button",{type:"button",onClick:()=>ne("decisionRows",k.id),className:"rounded-md border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})})]},k.id)),b.decisionRows.length?null:e.jsx("tr",{children:e.jsx("td",{className:"px-3 py-3 text-sm text-slate-500",colSpan:4,children:"No decisions added yet."})})]})]})}),e.jsx("button",{type:"button","data-print-hide":"true",onClick:()=>be("decisionRows",{id:sn(),decision:"",owner:"",requiredBy:""}),className:"mt-3 rounded-md bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200",children:"+ Add Decision"})]}):S==="change-lead-assessment"?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R}),e.jsx("div",{className:"mt-3 overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 bg-white",children:[e.jsx("thead",{className:"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Area"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Confidence"}),e.jsx("th",{"data-print-hide":"true",className:"px-3 py-2"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-100",children:[b.assessmentRows.map(k=>e.jsxs("tr",{children:[e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("input",{value:k.area,onChange:A=>ye("assessmentRows",k.id,{area:A.target.value}),placeholder:"e.g. Stakeholder Engagement",className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsxs("select",{value:k.confidence,onChange:A=>ye("assessmentRows",k.id,{confidence:A.target.value}),className:"w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm",children:[e.jsx("option",{value:"High",children:"High"}),e.jsx("option",{value:"Medium",children:"Medium"}),e.jsx("option",{value:"Low",children:"Low"})]})}),e.jsx("td",{"data-print-hide":"true",className:"px-3 py-2 align-top",children:e.jsx("button",{type:"button",onClick:()=>ne("assessmentRows",k.id),className:"rounded-md border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})})]},k.id)),b.assessmentRows.length?null:e.jsx("tr",{children:e.jsx("td",{className:"px-3 py-3 text-sm text-slate-500",colSpan:3,children:"No assessment areas added yet."})})]})]})}),e.jsx("button",{type:"button","data-print-hide":"true",onClick:()=>be("assessmentRows",{id:sn(),area:"",confidence:"Medium"}),className:"mt-3 rounded-md bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200",children:"+ Add Assessment Area"})]}):e.jsx(e.Fragment,{children:e.jsx("p",{className:"mt-2 text-sm whitespace-pre-line text-slate-700",children:R})})},Ae=()=>{if(!q.current){window.alert("Preview content is not ready to print yet.");return}const S=window.open("","_blank");if(!S)return;S.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8" /><title>Highlight Report</title></head><body></body></html>'),document.querySelectorAll('link[rel="stylesheet"], style').forEach(A=>{S.document.head.appendChild(A.cloneNode(!0))});const R=S.document.createElement("style");R.textContent=`
...
`,fs={componentId:"process_change",actionPrefix:"process-change-action",outcomePrefix:"process-change:outcome",fallbackOutcomes:[{id:"process-change:outcome:o1",text:"Current and future processes have been defined"},{id:"process-change:outcome:o2",text:"Process changes have been implemented and adopted"},{id:"process-change:outcome:o3",text:"Processes are optimised and continuously improved"}],lensAliases:{"Process and Sustainment":"Process and Sustainment","People Experience and Culture":"Skills and Behaviour","Planning and Risk":"Process and Sustainment","Analysis and Insight":"Process and Sustainment",Communication:"Skills and Behaviour","Dependency Management":"Process and Sustainment",Design:"Process and Sustainment",Governance:"Process and Sustainment",Implementation:"Process and Sustainment","Measurement and Evaluation":"Process and Sustainment",Reinforcement:"Skills and Behaviour","Testing and Validation":"Process and Sustainment"}},Lc=Ve(Tc,fs);function Mc(n){return qe(n,fs,Lc)}function Bc(n){return Ye(n,fs)}const Gc=`{
  "component": {
    "id": "REINFORCEMENT",
    "name": "Reinforcement"
  },
...
`,ks={componentId:"vision",actionPrefix:"vision-action",outcomePrefix:"vision:outcome",fallbackOutcomes:[{id:"vision:outcome:o1",text:"A compelling future state has been defined"},{id:"vision:outcome:o2",text:"The vision is shared and understood"},{id:"vision:outcome:o3",text:"The vision is visible and guides the change"}]},hd=Ve(pd,ks);function fd(n){return qe(n,ks,hd)}function bd(n){return Ye(n,ks)}function kn(n){return $c(md(Ac(Uc(Mc(ic(gc(ed(qc(ld(Cc(Jc(yc(bc(nc(ad(cc(fd(n))))))))))))))))))}function xd(n){return gd(Oc(Hc(Bc(oc(pc(nd(Yc(cd(jc(Xc(wc(xc(tc(id(dc(bd(n)))))))))))))))))}function Sd(n,t){return t==="pathway-1"?kn(n):xd(n)}const Mt="nhs-digital-adoption-user-settings",Bt="nhs-digital-adoption-report-reminder-dismissed",vd="nhs-digital-adoption-engagement",Gt="nhs-digital-adoption-current-user-id",ja="Default",yd=5*1024*1024,wd=new Set(["application/json","text/json"]),Nd="Unknown user",kd=["introduction","engine-explained","project-details","profile"],Cd={1:"#3b82f6",2:"#8b5cf6",3:"#f59e0b",4:"#f97316",5:"#22c55e"},jd={red:"test-data/adoption-phase1-red.json",amber:"test-data/adoption-phase2-amber.json",green:"test-data/adoption-phase3-green.json"},Ft={name:"",themeColor:"#005eb8",profileImageDataUrl:"",darkMode:!1,colorAccessibilityMode:"standard",phaseFocusMode:"auto",manualPhaseFocus:1,hideGuidedWorkflow:!1,showAdditionalGuidanceLinks:!0,showExternalLinksSection:!1,showActionPriorityColours:!1};function Ed(n){return{...n,linkedTargets:(n.linkedTargets||[]).map(t=>({componentId:t.componentId,lens:t.lens}))}}function Id(n,t){return`${n}:${t}`}function Ea(n){return n.orgProfile.trustName||n.orgProfile.projectName?!1:!Object.values(n.currentDraft).some(t=>Object.values(t).some(s=>s.score>0))}function Ia(n){return!n.trustName.trim()}function Ad(n){var t;if(!((t=n.evidence)!=null&&t.trim()))return!1;try{const s=JSON.parse(n.evidence);return Array.isArray(s)?s.length>0:!!n.evidence.trim()}catch{return!!n.evidence.trim()}}function Od(n){return n.trim()||Nd}function _d(n,t,s){const a=(n.teamMembers||[]).find(i=>i.id===t);return Od((a==null?void 0:a.name)||s)}function Rd(n,t,s){var i;const a=Ki[n];return((i=a==null?void 0:a[t])==null?void 0:i[s])||St[s]||St[0]}function Pd(n=new Date){const t=String(n.getMonth()+1).padStart(2,"0");return`${n.getFullYear()}-${t}`}function Dd(n=new Date){return new Date(n.getFullYear(),n.getMonth()-1,1).toLocaleString("en-GB",{month:"short",year:"numeric"})}function $d(n){const t=new TextEncoder().encode(n);let s="";return t.forEach(a=>{s+=String.fromCharCode(a)}),window.btoa(s)}function Td(n,t=76){const s=[];for(let a=0;a<n.length;a+=t)s.push(n.slice(a,a+t));return s.join(`\r
`)}function Ld(n=new Date){return n.toLocaleString("en-GB",{month:"short",year:"numeric"})}function Yd(){var qn,it;const n=tt,t=g.useMemo(()=>[...Fa],[]),[s,a]=g.useState(n[0].id),[i,l]=g.useState(!1),[o,r]=g.useState(()=>{let p={};try{const M=Sn(Sa);p=rs(pt(M))}catch(M){console.warn("Ignoring invalid persisted adoption data.",M)}const N=ft({view:"dashboard",orgProfile:p==null?void 0:p.orgProfile,currentDraft:p==null?void 0:p.currentDraft,objectives:p==null?void 0:p.objectives,suppressedAutoActions:p==null?void 0:p.suppressedAutoActions,auditLog:p==null?void 0:p.auditLog,history:p==null?void 0:p.history,phaseOverrides:p==null?void 0:p.phaseOverrides,pathwayChecks:p==null?void 0:p.pathwayChecks});return N.orgProfile.cstId||(N.orgProfile={...N.orgProfile,cstId:Us()}),kn(N)}),[c,h]=g.useState(()=>Ea(o)?"introduction":"dashboard"),[d,m]=g.useState(""),f=pn("vision-get-started"),[b,y]=g.useState(()=>Sn(Gt)||""),E=Pn.useRef(b);g.useEffect(()=>{E.current=b},[b]);const[j,x]=g.useState(null),[I,q]=g.useState(()=>{const p=Sn(Mt);return{...Ft,...p}}),C=Pn.useRef(I.name);g.useEffect(()=>{C.current=I.name},[I.name]);const T=Pn.useRef(null),P=Pn.useRef(null),[ue,B]=g.useState(""),z=Pn.useRef(null),le=g.useMemo(()=>Pd(),[]),[ie,O]=g.useState(()=>Sn(Bt)||{}),[G,Ne]=g.useState(!0),[Ce,Te]=g.useState([]),[Ke,L]=g.useState({1:!0}),[oe,se]=g.useState({intro:!0,overview:!0,tools:!0}),[ge,be]=g.useState(null),[ye,ne]=g.useState(!0),[De,$e]=g.useState("medium"),ze=Pn.useRef({}),Me=g.useMemo(()=>{const p=new Date,N=Dd(p),M=p.getDate()===1;return{previousMonthLabel:N,isFirstDayOfMonth:M,shouldNotify:M}},[o.history]),[Ie,cn]=g.useState("test@test.com"),[Je,dn]=g.useState(""),[Ze,_]=g.useState(""),te=Ld(),X=g.useCallback((p,N)=>(o.currentDraft[p]||(o.currentDraft[p]={}),o.currentDraft[p][N]||(o.currentDraft[p][N]=At()),o.currentDraft[p][N]),[o]),he=I.showAdditionalGuidanceLinks!==!1,xe=g.useMemo(()=>{const p=so(o,n);return{...p,nextSteps:p.nextSteps.map(N=>({...N,toolkitLinks:xt(ja,N.componentId,"inputs",void 0,he).slice(0,3)}))}},[o,he]),ke=I.phaseFocusMode==="manual"&&I.manualPhaseFocus?I.manualPhaseFocus:xe.currentPhase;g.useEffect(()=>{var N;if(c!=="assessment")return;const p=(N=n.find(M=>M.id===s))==null?void 0:N.phase;p&&L(M=>({...M,[p]:!0}))},[s,c]),g.useEffect(()=>{c==="where-am-i-now"&&l(!0)},[c]),g.useEffect(()=>{const N={introduction:"intro","engine-explained":"intro","project-details":"intro","where-am-i-now":"intro",dashboard:"overview","daily-checkin":"overview","action-plan":"overview","roadmap-view":"overview","highlight-builder":"tools","force-field-analysis":"tools",compare:"tools","audit-log":"tools"}[c];N&&se(M=>({...M,[N]:!0}))},[c]);const Ae=ro(o,p=>Ht(p)||n[0],X).sort((p,N)=>{const M=p.action.owner.localeCompare(N.action.owner);return M!==0?M:p.component.localeCompare(N.component)});g.useEffect(()=>{tn(Sa,o)},[o]),g.useEffect(()=>{tn(Mt,I)},[I]),g.useEffect(()=>{tn(Gt,b)},[b]),g.useEffect(()=>{tn(Bt,ie)},[ie]),g.useEffect(()=>{Ia(o.orgProfile)&&!kd.includes(c)&&h("introduction")},[o.orgProfile,c]),g.useEffect(()=>{c==="dashboard"&&T.current&&setTimeout(()=>{var M,Z,V;const p=(M=T.current)==null?void 0:M.querySelector("#adoption-radar-chart");if(p){const me=oo(o,t,n,X);vt(p,me)}const N=(Z=T.current)==null?void 0:Z.querySelector("#adoption-component-radar-chart");if(N){const me=Ga(n,X,ke);vt(N,me,{maintainAspectRatio:!1,scales:{r:{min:-1,max:5,ticks:{display:!0,stepSize:1,backdropColor:"transparent",callback:de=>Number(de)<0?"":de}}}},de=>{const Le=n[de];Le&&H(Le.id)})}if(o.history.length>0){const me=(V=T.current)==null?void 0:V.querySelector("#adoption-line-chart");if(me){const de={labels:o.history.map(Le=>Le.monthLabel),datasets:[{label:"Adoption Score",data:o.history.map(Le=>Le.overallPercentage||0),borderColor:"#005EB8",backgroundColor:"rgba(0, 94, 184, 0.1)",fill:!0,tension:.4}]};mi(me,de)}}},100)},[c,o,X,t,n,ke,ye,De]),g.useEffect(()=>{typeof document<"u"&&(document.documentElement.dataset.nhsThemeMode=I.darkMode?"dark":"light")},[I.darkMode]),g.useEffect(()=>{var N;const p=c==="assessment"?`component:${s}`:`view:${c}`;(N=ze.current[p])==null||N.scrollIntoView({block:"nearest",behavior:"smooth"})},[s,c]);const S=()=>typeof window>"u"?!1:window.innerWidth<1024,R=g.useCallback(()=>{var p;(p=P.current)==null||p.scrollTo({top:0,behavior:"auto"})},[]),k=g.useCallback(p=>{h(N=>N===p?N:(Te(M=>[N,...M].slice(0,20)),p)),S()&&l(!1)},[]),A=p=>{k(p)},U=g.useCallback(()=>{Te(p=>{const[N,...M]=p;return N?(h(N),window.innerWidth<1024&&l(!1),M):(window.location.hash="#/",p)})},[]),H=g.useCallback(p=>{Ht(p)&&(a(p),k("assessment"),R())},[k,R]),[ee,ae]=g.useState(null),Se=g.useCallback((p,N,M)=>{ae({lens:N,actionId:M}),H(p)},[H]);g.useEffect(()=>{R()},[R,c]);function ve(p,N){if(!N.length)return p.auditLog;const M=_d(p.orgProfile,E.current,C.current||""),Z=N.map(V=>kl({actor:M,eventType:V.eventType,entityType:V.entityType,entityId:V.entityId,summary:V.summary,trustName:V.trustName??p.orgProfile.trustName,projectName:V.projectName??p.orgProfile.projectName,componentId:V.componentId,lens:V.lens,reason:V.reason,before:V.before,after:V.after,source:V.source,importedAt:V.importedAt}));return kt([...p.auditLog||[],...Z])}const Xe=g.useCallback((p,N,M)=>{r(Z=>{var Oe;const V=((Oe=Z.currentDraft[p])==null?void 0:Oe[N])||At(),me={...Z,currentDraft:{...Z.currentDraft,[p]:{...Z.currentDraft[p],[N]:Ta(M)}}},de=[];V.score!==M.score&&de.push({eventType:"entry-score-updated",entityType:"entry",entityId:`${p}:${N}`,summary:`Updated readiness score for ${p} / ${N}: ${V.score} -> ${M.score}`,componentId:p,lens:N,before:{score:V.score},after:{score:M.score},source:"local"}),(V.justification||"")!==(M.justification||"")&&de.push({eventType:"entry-justification-updated",entityType:"entry",entityId:`${p}:${N}`,summary:`Updated justification for ${p} / ${N}`,componentId:p,lens:N,before:{justification:V.justification||""},after:{justification:M.justification||""},source:"local"}),(V.evidence||"")!==(M.evidence||"")&&de.push({eventType:"entry-evidence-updated",entityType:"entry",entityId:`${p}:${N}`,summary:`Updated evidence for ${p} / ${N}`,componentId:p,lens:N,before:{evidence:V.evidence||""},after:{evidence:M.evidence||""},source:"local"});const Le=new Map(V.actions.map(fe=>[fe.id,fe]));return M.actions.forEach(fe=>{const Re=Le.get(fe.id);if(!Re){de.push({eventType:"action-created",entityType:"action",entityId:fe.id,summary:`Created action in ${p} / ${N}`,componentId:p,lens:N,after:{text:fe.text,status:fe.status,owner:fe.owner,actionType:fe.actionType},source:"local"});return}const jn=JSON.stringify({text:Re.text,status:Re.status,owner:Re.owner,actionType:Re.actionType,notes:Re.notes,dueDate:Re.dueDate,startDate:Re.startDate,evidence:Re.evidence}),mn=JSON.stringify({text:fe.text,status:fe.status,owner:fe.owner,actionType:fe.actionType,notes:fe.notes,dueDate:fe.dueDate,startDate:fe.startDate,evidence:fe.evidence});jn!==mn&&de.push({eventType:"action-updated",entityType:"action",entityId:fe.id,summary:`Updated action in ${p} / ${N}`,componentId:p,lens:N,before:{text:Re.text,status:Re.status,owner:Re.owner,actionType:Re.actionType},after:{text:fe.text,status:fe.status,owner:fe.owner,actionType:fe.actionType},source:"local"})}),{...kn(me),auditLog:ve(Z,de)}})},[ve]),un=g.useCallback((p,N,M,Z)=>{const V=X(p,N);Xe(p,N,{...V,actions:V.actions.map(me=>me.id===M?{...me,status:He(Z)}:me)})},[X,Xe]),Cn=g.useCallback((p,N,M,Z)=>{const V=X(p,N).actions.find(de=>de.id===M);if(He(Z)==="Completed"&&V!==void 0&&!Ad(V)&&!Sn(Zn)){be({componentId:p,lens:N,actionId:M,status:Z});return}un(p,N,M,Z)},[un,X]),v=g.useCallback((p,N)=>{r(M=>{const Z=M.objectives[p]||[],V={...M,objectives:{...M.objectives,[p]:N}};return JSON.stringify(Z)!==JSON.stringify(N)?{...V,auditLog:ve(M,[{eventType:"objectives-updated",entityType:"objective",entityId:p,summary:`Updated component outcomes for ${p}`,componentId:p,before:{objectiveCount:Z.length},after:{objectiveCount:N.length},source:"local"}])}:V})},[ve]),D=g.useCallback(p=>{const N=Za(o.orgProfile);if(N.isValid)return!0;const M=N.errors.map(Z=>`- ${Z.message}`).join(`
`);return window.confirm(`${p} has CST warnings:

${M}

Continue anyway?`)},[o.orgProfile]),W=g.useCallback(p=>{B(p)},[]),ce=g.useCallback(()=>{if(!D("Export"))return;const N=va(o);Qn(`adoption-assessment-${(o.orgProfile.trustName||"export").replace(/\s+/g,"_")}.json`,JSON.stringify(N,null,2),"application/json"),W("Assessment export downloaded.")},[W,D,o]),we=g.useCallback(()=>{var p;(p=z.current)==null||p.click()},[]),Be=g.useCallback(async p=>{var V,me,de,Le;const N=(V=p.target.files)==null?void 0:V[0];if(!N)return;const M=N.name.toLowerCase().endsWith(".json"),Z=!N.type||wd.has(N.type);if(!M||!Z){W("Import failed. Please choose a valid JSON file."),window.alert("Import failed. Please choose a valid JSON file."),p.target.value="";return}if(N.size>yd){W("Import failed. The selected file is larger than 5 MB."),window.alert("Import failed. The selected file is larger than 5 MB."),p.target.value="";return}try{const hn=await N.text(),Oe=pt(JSON.parse(hn)),fe=()=>{r(En=>{const gn=kn(ya(Oe,En));return gn.orgProfile.cstId||(gn.orgProfile={...gn.orgProfile,cstId:Us()}),{...gn,auditLog:ve(gn,[{eventType:"data-imported",entityType:"system",summary:`Imported assessment data from ${N.name}`,after:{fileName:N.name},source:"local"}])}}),h("dashboard"),W("Assessment import complete. Dashboard updated.")};if(Ea(o)){fe();return}const Re=(me=Oe.orgProfile)==null?void 0:me.cstId,jn=o.orgProfile.cstId,mn=o.orgProfile.projectName||o.orgProfile.trustName||"your currently loaded programme",_n=((de=Oe.orgProfile)==null?void 0:de.projectName)||((Le=Oe.orgProfile)==null?void 0:Le.trustName)||N.name;if(Re&&Re!==jn){if(!window.confirm(`"${_n}" looks like a different programme than "${mn}".

Importing will replace everything currently loaded. Continue?`)){W("Import cancelled.");return}fe();return}if(!Re&&!window.confirm(`"${_n}" doesn't carry a programme ID (it may predate this feature).

Click OK to compare it against "${mn}" and merge item by item, or Cancel to load it as a different programme (replace everything).`)){fe();return}const fn=Ql(o,Oe);if(!fn.hasConflicts){r(En=>{const gn=kn(Ca(En,Oe,{}));return{...gn,auditLog:ve(gn,[{eventType:"data-imported",entityType:"system",summary:fn.autoMergeSummary.length?`Merged import from ${N.name} (${fn.autoMergeSummary.join(", ")})`:`Imported ${N.name} - no changes (already up to date)`,after:{fileName:N.name},source:"local"}])}}),h("dashboard"),W(fn.autoMergeSummary.length?`Merged automatically: ${fn.autoMergeSummary.join(", ")}.`:"Already up to date - nothing to import.");return}x({file:N,parsed:Oe,report:fn})}catch{W("Import failed. Please verify the file contents."),window.alert("Unable to import adoption assessment. Please verify the file contents.")}finally{p.target.value=""}},[W,ve,o]),Fe=g.useCallback(p=>{if(!j)return;const{file:N,parsed:M}=j,Z=Object.keys(p).length;r(V=>{const me=kn(Ca(V,M,p));return{...me,auditLog:ve(me,[{eventType:"data-imported",entityType:"system",summary:`Merged import from ${N.name} (${Z} item(s) resolved)`,after:{fileName:N.name},source:"local"}])}}),x(null),h("dashboard"),W("Import merged into current programme.")},[W,ve,j]),Ee=g.useCallback(()=>{x(null),W("Import cancelled.")},[W]),je=g.useCallback(async p=>{try{const N=await fetch(jd[p]);if(!N.ok)throw new Error(`Failed to load sample data: ${N.status}`);const M=pt(await N.json());r(Z=>{const V=kn(ya(M,Z));return{...V,auditLog:ve(V,[{eventType:"example-data-loaded",entityType:"system",summary:"Loaded example assessment data",source:"local"}])}}),h("dashboard"),W("Example assessment data loaded."),S()&&l(!1)}catch(N){console.error(N),W("Unable to load example data right now."),window.alert("Unable to load example data right now. Please try again.")}},[W,ve]),en=g.useCallback(()=>{if(!window.confirm("Warning: this will reset all assessment data (organisation profile, scores, actions, and history) and sign you out. If you are worried, please export your data first. Continue?"))return;const N=kn(ft());r(N),h("introduction"),q(Ft),tn(Mt,Ft),localStorage.removeItem(vd),O({}),tn(Bt,{}),tn(Xt,!1),y(""),tn(Gt,""),Object.keys(localStorage).filter(M=>M.startsWith("nhs-digital-adoption-page-intro-seen:")).forEach(M=>localStorage.removeItem(M)),W("Assessment data has been reset and you have been signed out."),S()&&l(!1)},[W]),Ue=g.useCallback(()=>({generatedAt:new Date().toISOString(),targetMonth:Me.previousMonthLabel,report:va(o)}),[Me.previousMonthLabel,o]),on=g.useCallback(()=>`adoption-point-in-time-${Me.previousMonthLabel.toLowerCase().replace(/\s+/g,"-")}.json`,[Me.previousMonthLabel]);g.useCallback(()=>{const p=on();Qn(p,JSON.stringify(Ue(),null,2),"application/json")},[on,Ue]),g.useCallback(()=>{const p=Ie.trim()||"test@test.com",N=on(),M=`${Ze}

Attachment: ${N}`,Z=`mailto:${p}?subject=${encodeURIComponent(Je)}&body=${encodeURIComponent(M)}`;window.location.href=Z},[on,Ze,Je,Ie]),g.useCallback(()=>{const p=Ie.trim()||"test@test.com",N=on(),M=JSON.stringify(Ue(),null,2),Z=Td($d(M)),V=`----nhs-adoption-reminder-${Date.now()}`,me=[`To: ${p}`,`Subject: ${Je}`,"MIME-Version: 1.0",`Content-Type: multipart/mixed; boundary="${V}"`,"",`--${V}`,'Content-Type: text/plain; charset="UTF-8"',"Content-Transfer-Encoding: 8bit","",Ze,"",`--${V}`,`Content-Type: application/json; name="${N}"`,"Content-Transfer-Encoding: base64",`Content-Disposition: attachment; filename="${N}"`,"",Z,`--${V}--`,""].join(`\r
`),de=Me.previousMonthLabel.toLowerCase().replace(/\s+/g,"-");Qn(`adoption-reminder-${de}.eml`,me,"message/rfc822")},[on,Ue,Ze,Je,Ie,Me.previousMonthLabel]),g.useCallback(()=>{O(p=>({...p,[le]:!0}))},[le]),Me.shouldNotify&&ie[le];const nn=g.useMemo(()=>uo(o,xe,te),[o,xe,te]),wn=g.useMemo(()=>nn.filter(p=>p.completed).length,[nn]),Mn=g.useCallback(p=>{q(p)},[]),Bn=g.useCallback(p=>{r(N=>{const M=N.orgProfile.cst.pathway!==p.cst.pathway,Z={...N,orgProfile:p},V=M?Sd(Z,p.cst.pathway):Z;return JSON.stringify(N.orgProfile)!==JSON.stringify(p)?{...V,auditLog:ve(N,[{eventType:"profile-updated",entityType:"profile",summary:"Updated CST profile details",before:{trustName:N.orgProfile.trustName,projectName:N.orgProfile.projectName,cst:N.orgProfile.cst},after:{trustName:p.trustName,projectName:p.projectName,cst:p.cst},source:"local"},...M?[{eventType:"pathway-changed",entityType:"profile",summary:`Changed pathway from ${N.orgProfile.cst.pathway} to ${p.cst.pathway}`,before:{pathway:N.orgProfile.cst.pathway},after:{pathway:p.cst.pathway},source:"local"}]:[]])}:V})},[]),Gn=p=>{let N=0,M=0,Z=0,V=0;return p.lenses.forEach(me=>{var hn,Oe;const de=(hn=o.currentDraft[p.id])==null?void 0:hn[me];de&&de.score>0&&(N++,(Oe=de.justification)!=null&&Oe.trim()&&M++);const Le=(de==null?void 0:de.actions)||[];Z+=Le.length,V+=Le.filter(fe=>Zt(fe.status)).length}),N===0?{icon:"◯",color:"text-blue-100",label:"Not Started"}:N>M?{icon:"⚠",color:"text-red-300",label:"Missing Justification"}:N<p.lenses.length?{icon:"◐",color:"text-amber-300",label:"In Progress"}:Z<=0||V<Z?{icon:"◐",color:"text-amber-300",label:"In Progress"}:{icon:"✓",color:"text-green-300",label:"Completed"}},An=o.orgProfile.trustName||"Unconfigured Trust",at=o.orgProfile.projectName||"Unnamed Project",On=!Ia(o.orgProfile);return e.jsxs("div",{className:`flex h-screen overflow-hidden ${I.darkMode?"bg-slate-900 text-slate-100":"bg-slate-50 text-slate-800"}`,children:[e.jsx("div",{role:"status","aria-live":"polite",className:"sr-only",children:ue}),e.jsx("input",{ref:z,type:"file",accept:"application/json",className:"hidden",onChange:Be}),i&&e.jsx("div",{className:"fixed inset-0 z-10 bg-slate-900/35 backdrop-blur-[1px] lg:hidden",onClick:()=>l(!1)}),e.jsxs("div",{className:`fixed inset-y-0 left-0 z-20 bg-[#005eb8] text-white flex flex-col shadow-xl overflow-hidden transition-all duration-300 ease-out lg:static lg:translate-x-0 ${i?"w-72 translate-x-0":"w-0 -translate-x-full lg:w-0"}`,style:{backgroundColor:I.themeColor},children:[e.jsxs("div",{className:"p-6 border-b border-blue-700",children:[e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-xl font-bold tracking-tight",children:"NHS Digital Adoption"}),e.jsxs("p",{className:"text-blue-200 text-xs mt-1 flex justify-between items-center",children:[e.jsx("span",{children:"Readiness Tracking Tool"}),e.jsx("span",{className:"opacity-80 font-medium",children:"V6.6"})]})]}),I.profileImageDataUrl?e.jsx("img",{src:I.profileImageDataUrl,alt:"Profile",className:"h-10 w-10 rounded-full border-2 border-blue-200 object-cover"}):null]}),e.jsx("button",{type:"button",onClick:()=>A("profile"),className:"mt-3 w-full rounded-md bg-blue-700 p-2 text-left text-xs hover:bg-blue-600",children:e.jsxs("div",{className:"font-semibold text-blue-100",children:["Objectives: ",wn,"/",nn.length]})})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto py-4",children:[e.jsxs("button",{type:"button","aria-expanded":oe.intro,onClick:()=>se(p=>({...p,intro:!p.intro})),className:"mb-2 flex w-full items-center justify-between px-4 text-left text-xs font-semibold uppercase tracking-wider text-blue-300 hover:text-white",children:[e.jsx("span",{children:"Intro"}),e.jsx("span",{"aria-hidden":"true",children:oe.intro?"−":"+"})]}),oe.intro?e.jsx("nav",{className:"space-y-1 mb-4",children:["introduction","engine-explained","project-details","where-am-i-now"].map(p=>e.jsx("button",{ref:N=>{ze.current[`view:${p}`]=N},onClick:()=>A(p),className:`w-full flex items-center px-4 py-2.5 text-sm transition-colors ${c===p?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:p==="introduction"?"Introduction":p==="engine-explained"?"Engine Explained":p==="project-details"?"Project Profile":"Where Am I Now?"},p))}):null,On?e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button","aria-expanded":oe.overview,onClick:()=>se(p=>({...p,overview:!p.overview})),className:"mb-2 flex w-full items-center justify-between px-4 text-left text-xs font-semibold uppercase tracking-wider text-blue-300 hover:text-white",children:[e.jsx("span",{children:"Overview"}),e.jsx("span",{"aria-hidden":"true",children:oe.overview?"−":"+"})]}),oe.overview?e.jsx("nav",{className:"space-y-1 mb-4",children:["dashboard","daily-checkin","action-plan","roadmap-view"].map(p=>e.jsx("button",{ref:N=>{ze.current[`view:${p}`]=N},onClick:()=>A(p),className:`w-full flex items-center px-4 py-2.5 text-sm transition-colors ${c===p?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:p==="dashboard"?"Metrics Dashboard":p==="daily-checkin"?"Daily Check-in":p==="action-plan"?"Action Tracker":"Component Delivery Timeline"},p))}):null,e.jsx("div",{className:"px-4 mb-2 text-xs font-semibold text-blue-300 uppercase tracking-wider",children:"Change Components"}),e.jsx("nav",{className:"space-y-2 mb-8",children:Array.from(new Set(n.map(p=>p.phase))).map(p=>{const N=n.filter(Z=>Z.phase===p),M=Ke[p]??!1;return e.jsxs("div",{className:"mx-2 overflow-hidden rounded-md",style:{backgroundColor:`${Cd[p]||"#3b82f6"}33`},children:[e.jsxs("button",{type:"button","aria-expanded":M,onClick:()=>L(Z=>({...Z,[p]:!M})),className:"flex w-full items-center justify-between px-3 pb-1.5 pt-2.5 text-left text-sm font-semibold uppercase tracking-wider text-white",children:[e.jsx("span",{children:an[p]||`Phase ${p}`}),e.jsx("span",{"aria-hidden":"true",children:M?"−":"+"})]}),M?N.map(Z=>{const V=c==="assessment"&&s===Z.id,me=Gn(Z);return e.jsxs("button",{ref:de=>{ze.current[`component:${Z.id}`]=de},onClick:()=>{H(Z.id)},className:`w-full text-left px-4 py-2 text-sm flex items-center justify-between transition-colors ${V?"bg-white font-medium text-[#005eb8]":`hover:bg-blue-800 ${me.color}`}`,children:[e.jsx("span",{className:"truncate pr-2",children:Oi(Z.label)}),e.jsx("span",{className:"text-xs flex-shrink-0",title:me.label,"aria-label":me.label,children:me.icon})]},Z.id)}):null]},p)})}),e.jsxs("button",{type:"button","aria-expanded":oe.tools,onClick:()=>se(p=>({...p,tools:!p.tools})),className:"mb-2 flex w-full items-center justify-between px-4 text-left text-xs font-semibold uppercase tracking-wider text-blue-300 hover:text-white",children:[e.jsx("span",{children:"Tools"}),e.jsx("span",{"aria-hidden":"true",children:oe.tools?"−":"+"})]}),oe.tools?e.jsx("nav",{className:"space-y-1 mb-8",children:["highlight-builder","force-field-analysis","compare","audit-log"].map(p=>e.jsx("button",{ref:N=>{ze.current[`view:${p}`]=N},onClick:()=>A(p),className:`w-full flex items-center px-4 py-1 text-sm transition-colors ${c===p?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:p==="highlight-builder"?"Highlight Builder":p==="force-field-analysis"?"Force Field Analysis":p==="compare"?"Assess & Compare":"Audit Log"},p))}):null]}):null,e.jsx("div",{className:"px-4 mb-2 text-xs font-semibold text-blue-300 uppercase tracking-wider border-t border-blue-800 pt-6",children:"Account"}),e.jsx("nav",{className:"space-y-1 mb-8",children:(On?["settings","profile"]:["profile"]).map(p=>e.jsx("button",{ref:N=>{ze.current[`view:${p}`]=N},onClick:()=>A(p),className:`w-full flex items-center px-4 py-1 text-sm transition-colors ${c===p?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:p==="settings"?"Settings":"Profile"},p))}),e.jsxs("div",{className:"mt-8 px-4 pb-4 border-t border-blue-800 pt-6",children:[e.jsx("div",{className:"text-[10px] font-semibold text-blue-300 uppercase tracking-wider mb-3",children:"Status Legend"}),e.jsxs("div",{className:"space-y-2 text-xs text-blue-200",children:[e.jsx("div",{children:"◯ Not Started"}),e.jsx("div",{children:"◐ In Progress"}),e.jsx("div",{children:"⚠ Missing Justification"}),e.jsx("div",{children:"✓ Completed"})]})]})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col h-screen overflow-hidden",children:[e.jsx("header",{className:`${I.darkMode?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} border-b px-3 py-2 sm:px-6 shrink-0 z-10 ${c==="introduction"?"":"shadow-sm"}`,style:{borderTop:`3px solid ${I.themeColor}`},children:e.jsxs("div",{className:"flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between",children:[e.jsxs("div",{className:"min-w-0 flex items-center gap-2 sm:gap-3",children:[e.jsxs("button",{onClick:()=>l(p=>!p),className:"inline-flex h-9 items-center justify-center px-3 text-white rounded-md font-semibold transition-colors shadow-sm","aria-label":i?"Collapse side navigation":"Expand side navigation",title:i?"Collapse side navigation":"Expand side navigation",style:{backgroundColor:I.themeColor},children:[e.jsx("span",{"aria-hidden":"true",className:"text-lg leading-none",children:i?"«":"»"}),e.jsx("span",{className:"sr-only",children:i?"Collapse side navigation":"Expand side navigation"})]}),e.jsx("button",{onClick:U,disabled:Ce.length===0,title:Ce.length===0?"No previous in-app page":"Back to previous page",className:`h-9 text-sm px-3 rounded-md font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${I.darkMode?"text-slate-100 hover:bg-slate-700":"text-slate-600 hover:bg-slate-100"}`,children:"← Back"}),e.jsx("div",{className:"min-w-0",children:e.jsxs("div",{className:"flex min-w-0 items-center gap-1 text-sm",children:[e.jsx("span",{className:`truncate font-semibold ${I.darkMode?"text-slate-100":"text-slate-700"}`,title:An,children:An}),e.jsx("span",{className:`${I.darkMode?"text-slate-300":"text-slate-400"}`,children:"/"}),e.jsx("span",{className:`truncate ${I.darkMode?"text-slate-100":"text-slate-600"}`,title:at,children:at})]})})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 lg:justify-end",children:[e.jsxs("span",{className:"inline-flex h-9 w-9 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-[11px] font-semibold text-emerald-800 sm:h-9 sm:w-auto sm:rounded-full",title:"Auto-save on","aria-label":"Auto-save on",children:[e.jsx("span",{className:"inline-flex h-3 w-3 items-center justify-center rounded-full bg-emerald-500 text-[9px] text-white","aria-hidden":"true",children:"✓"}),e.jsx("span",{className:"sr-only sm:not-sr-only sm:ml-1",children:"Auto-save on"})]}),e.jsx("button",{onClick:()=>A("introduction"),"aria-label":"Show introduction",title:"Show introduction",className:`text-sm w-9 h-9 flex items-center justify-center bg-white text-[#425563] border border-[#768692] hover:bg-[#f0f4f5] rounded-full font-semibold transition-colors ${Qt}`,children:"?"}),e.jsx("button",{type:"button",onClick:()=>{window.location.hash="#/"},"aria-label":"Go to home page",title:"Go to home page",className:`${Ge} h-9 w-16 px-6 py-0 inline-flex items-center justify-center`,children:"Home"}),e.jsx("button",{onClick:we,className:`${Ge} h-9 px-3 py-0`,children:"Import"}),e.jsxs("button",{onClick:ce,className:`${Ge} h-9 px-3 py-0`,children:[e.jsx("span",{className:"sm:hidden",children:"Export"}),e.jsx("span",{className:"hidden sm:inline",children:"Export"})]})]})]})}),e.jsxs("main",{ref:P,className:"flex-1 overflow-y-auto p-8",children:[c==="daily-checkin"&&G?e.jsxs("section",{className:`${I.darkMode?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mb-6 rounded-xl border p-4 shadow-sm`,children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${I.darkMode?"text-slate-300":"text-slate-500"}`,children:"Objectives"}),e.jsxs("p",{className:`text-sm mt-1 ${I.darkMode?"text-slate-100":"text-slate-700"}`,children:[wn,"/",nn.length," complete - based on phase readiness, ownership, cadence and team participation."]})]}),e.jsx("button",{type:"button",onClick:()=>Ne(!1),className:`${I.darkMode?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-2 text-sm font-medium`,"aria-label":"Dismiss objectives card",children:"Dismiss"})]}),e.jsx("div",{className:"mt-4 grid gap-3 md:grid-cols-3",children:nn.map(p=>e.jsxs("div",{className:`rounded-lg border p-3 ${p.completed?"border-green-200 bg-green-50":I.darkMode?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsx("p",{className:`text-sm font-semibold ${I.darkMode?"text-slate-100":"text-slate-800"}`,children:p.label}),e.jsx("span",{className:"text-xs font-bold",children:p.completed?"Done":"Not yet"})]}),e.jsx("p",{className:`mt-1 text-xs ${I.darkMode?"text-slate-300":"text-slate-600"}`,children:p.description})]},p.id))})]}):null,c==="dashboard"&&e.jsx("div",{ref:T,children:e.jsx(ho,{store:o,components:n,lenses:t,metrics:xe,phaseFocusMode:I.phaseFocusMode||"auto",manualPhaseFocus:I.manualPhaseFocus,onPhaseFocusModeChange:p=>q(N=>({...N,phaseFocusMode:p,manualPhaseFocus:p==="manual"?N.manualPhaseFocus||xe.currentPhase:N.manualPhaseFocus})),onManualPhaseFocusChange:p=>q(N=>({...N,phaseFocusMode:"manual",manualPhaseFocus:p})),onResetPhaseFocus:()=>q(p=>({...p,phaseFocusMode:"auto",manualPhaseFocus:xe.currentPhase})),getEntry:X,onComponentClick:H,onNavigate:A,onOpenLensInfo:m,onOpenOnboarding:()=>A("introduction"),colorAccessibilityMode:I.colorAccessibilityMode||"standard",darkMode:!!I.darkMode,componentRadarVisible:ye,onComponentRadarVisibleChange:ne,componentRadarSize:De,onComponentRadarSizeChange:$e})}),c==="where-am-i-now"&&e.jsx(Nl,{components:n,getEntry:X,effectivePhaseFocus:ke,phaseFocusMode:I.phaseFocusMode||"auto",onComponentClick:H,onSetManualPhase:p=>q(N=>({...N,phaseFocusMode:"manual",manualPhaseFocus:p})),onResetToAuto:()=>q(p=>({...p,phaseFocusMode:"auto",manualPhaseFocus:xe.currentPhase})),darkMode:!!I.darkMode}),c==="daily-checkin"&&e.jsx(Or,{store:o,components:n,metrics:xe,getEntry:X,onComponentClick:H,onActionView:Se,guidanceTarget:ja,linkOverrides:o.orgProfile.linkOverrides,showAdditionalGuidanceLinks:he,phaseFocusMode:I.phaseFocusMode||"auto",manualPhaseFocus:I.manualPhaseFocus,colorAccessibilityMode:I.colorAccessibilityMode||"standard",darkMode:!!I.darkMode}),c==="project-details"&&e.jsx(jr,{orgProfile:o.orgProfile,onProfileUpdate:Bn,components:n,lenses:t,onComponentClick:H,onGoToIntroduction:()=>A("introduction"),onContinueToVision:()=>H("vision"),onGoToWhereAmINow:()=>A("where-am-i-now"),currentUserId:b,onCurrentUserChange:y,showExternalLinksSection:!!I.showExternalLinksSection,darkMode:!!I.darkMode}),c==="assessment"&&e.jsx(fr,{store:o,components:n,activeComponentId:s,getRubricText:Rd,getEntry:X,onComponentChange:H,onEntryUpdate:Xe,onOpenLensInfo:m,onActionRemove:(p,N,M)=>{const V=X(p,N).actions.find(de=>de.id===M);if(!V)return;const me=window.prompt("Please provide a reason for removing this action. This will be included in the JSON export audit log.");if(!me||!me.trim()){window.alert("Removal cancelled. A reason is required to remove an action.");return}r(de=>{var jn;const Le=((jn=de.currentDraft[p])==null?void 0:jn[N])||At(),hn={...Le,actions:Le.actions.filter(mn=>mn.id!==M).map(Ed)},Oe={...de.suppressedAutoActions};if(M.startsWith("vision-action:")||M.startsWith("case-for-change-action:")||M.startsWith("benefits-action:")||M.startsWith("sponsorship-action:")||M.startsWith("change-impact-action:")){const mn=Id(p,N),_n=Oe[mn]||[];_n.includes(M)||(Oe[mn]=[..._n,M])}const fe={...de,currentDraft:{...de.currentDraft,[p]:{...de.currentDraft[p],[N]:hn}},suppressedAutoActions:Oe};return{...kn(fe),auditLog:ve(de,[{eventType:"action-removed",entityType:"action",entityId:M,summary:`Removed action from ${p} / ${N}`,componentId:p,lens:N,reason:me.trim(),before:{text:V.text,status:V.status,owner:V.owner,actionType:V.actionType},source:"local"}])}})},onObjectivesUpdate:v,onNavigateToTool:p=>A(p),hideGuidedWorkflow:!!I.hideGuidedWorkflow,onHideGuidedWorkflow:()=>q(p=>({...p,hideGuidedWorkflow:!0})),showAdditionalGuidanceLinks:he,showActionPriorityColours:!!I.showActionPriorityColours,currentUserId:b,currentUserProfileImageDataUrl:I.profileImageDataUrl,darkMode:!!I.darkMode,focusAction:ee,onFocusActionHandled:()=>ae(null)}),c==="action-plan"&&e.jsx(Yi,{actions:Ae,onComponentClick:H,onStatusChange:Cn,teamMembers:o.orgProfile.teamMembers||[],darkMode:!!I.darkMode}),c==="introduction"&&e.jsx(dl,{darkMode:!!I.darkMode,onGetStarted:()=>A("engine-explained")}),c==="engine-explained"&&e.jsx($r,{darkMode:!!I.darkMode,onGetStarted:()=>A("project-details"),onComponentClick:H}),c==="roadmap-view"&&e.jsx(qr,{components:n,metrics:xe,getEntry:X,onComponentClick:H,pathway:o.orgProfile.cst.pathway,pathwayChecks:o.pathwayChecks,darkMode:!!I.darkMode}),c==="highlight-builder"&&e.jsx(nl,{store:o,metrics:xe,lenses:t,components:n,getEntry:X,trustName:o.orgProfile.trustName,projectName:o.orgProfile.projectName,themeColor:I.themeColor,currentUserId:b,darkMode:!!I.darkMode}),c==="force-field-analysis"&&e.jsx(Ai,{embedded:!0,onBack:()=>A("dashboard")}),c==="compare"&&e.jsx(Ui,{embedded:!0,onBack:()=>A("dashboard")}),c==="audit-log"&&e.jsx(xr,{events:o.auditLog,darkMode:!!I.darkMode}),c==="settings"&&e.jsx(xl,{userSettings:I,onUserSettingsUpdate:Mn,onLoadExampleData:je,onResetData:en,darkMode:!!I.darkMode}),c==="profile"&&e.jsx(fl,{orgProfile:o.orgProfile,onProfileUpdate:Bn,userSettings:I,onUserSettingsUpdate:Mn,currentUserId:b,onCurrentUserChange:y,objectives:nn,darkMode:!!I.darkMode})]}),d?e.jsx(ol,{lensName:d,onClose:()=>m(""),darkMode:!!I.darkMode}):null,j?e.jsx(al,{report:j.report,myLabel:o.orgProfile.projectName||o.orgProfile.trustName||"Mine",theirLabel:((qn=j.parsed.orgProfile)==null?void 0:qn.projectName)||((it=j.parsed.orgProfile)==null?void 0:it.trustName)||j.file.name,onResolve:Fe,onCancel:Ee,darkMode:!!I.darkMode}):null,e.jsx(qi,{toolkitChoice:o.orgProfile.cst.toolkitChoice,darkMode:!!I.darkMode}),e.jsx(Wi,{open:c==="assessment"&&s==="vision"&&f.isOpen,onClose:f.close,darkMode:!!I.darkMode}),e.jsx(Pa,{open:ge!==null,onCancel:()=>be(null),onContinue:p=>{ge&&(p&&tn(Zn,!0),un(ge.componentId,ge.lens,ge.actionId,ge.status),be(null))},darkMode:!!I.darkMode})]})]})}export{Yd as AdoptionApp,Yd as default};
