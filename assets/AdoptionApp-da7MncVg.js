...
`,Ja="custom-outcome:";function Jo(n){return n.startsWith(Ja)}const Rt=ns.filter(n=>n!=="Overdue start"&&n!=="Overdue completion"),Xo=Mn.map(n=>n.score),Qo=Object.fromEntries(Mn.map(n=>[n.score,n.label])),ra={"Not Started":"bg-slate-100 text-slate-700 border-slate-200","In Progress":"bg-blue-100 text-blue-800 border-blue-200",Blocked:"bg-amber-100 text-amber-800 border-amber-200",Completed:"bg-green-100 text-green-800 border-green-200"},la=JSON.parse(zo),Xa=4;function Zo(n,t){return Jn.reduce((s,a)=>{const i=yt("Default",a.id,"inputs",void 0,n),l=yt("Default",a.id,"deliverables",void 0,n),r=new Map;return[...i,...l].forEach(o=>{var m,f;if(o.label&&o.label.trim().length>=Xa){const d=t?os(o,t).url:o.url,c=(f=(m=t==null?void 0:t.links)==null?void 0:m[o.key])==null?void 0:f.matchAliases;r.set(o.label.toLowerCase(),{...o,url:d,matchAliases:c})}}),s[a.id]=[...r.values()],s},{})}function er(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Qa(n){const t=new Set([n]);return new RegExp("(?<!s)s$","i").test(n)&&t.add(n.slice(0,-1)),[...t]}function qn(n,t,s,a){const i=n||"Untitled action";if(t.length===0)return i;const r=t.flatMap(d=>{const c=d.kind==="url"?d.matchAliases||[]:[];return[...Qa(d.label),...c].map(x=>({variant:x,link:d}))}).sort((d,c)=>c.variant.length-d.variant.length),o=r.map(d=>`\\b${er(d.variant)}\\b`).join("|"),m=i.split(new RegExp(`(${o})`,"gi")),f=`underline decoration-dotted underline-offset-2 ${s?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-blue-800"}`;return m.map((d,c)=>{const x=r.find(w=>w.variant.toLowerCase()===d.toLowerCase());if(!x)return d;const b=x.link;return b.kind==="tool"?e.jsx("button",{type:"button",onClick:w=>{w.stopPropagation(),a==null||a(b.tool)},className:f,children:d},`${b.key}-${c}`):e.jsx("a",{href:b.url,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),className:f,children:d},`${b.key}-${c}`)})}function ca(n){return n.split(`
`).map(t=>t.trim()).filter(Boolean)}const nr="Your Project";function tr(n,t){return n.replace(/\$projectName/g,t)}function sr(n,t){const s=i=>tr(i,t),a=i=>i.map(l=>({title:s(l.title),body:s(l.body)}));return{component:s(n.component),description:s(n.description),whatIsIt:s(n.whatIsIt),userInsight:s(n.userInsight),whyThisMatters:s(n.whyThisMatters),quickRealityCheck:s(n.quickRealityCheck),whatGoodLooksLike:a(n.whatGoodLooksLike),risksIfYouDont:a(n.risksIfYouDont)}}const Za={good:{border:"border-emerald-200",bg:"bg-emerald-50 hover:bg-emerald-100",text:"text-black",titleText:"text-emerald-700"},risk:{border:"border-rose-200",bg:"bg-rose-50 hover:bg-rose-100",text:"text-black",titleText:"text-rose-800"}},ei={good:{border:"border-emerald-500/40",bg:"bg-emerald-500/10 hover:bg-emerald-500/15",text:"text-emerald-200",titleText:"text-slate-100"},risk:{border:"border-rose-500/40",bg:"bg-rose-500/10 hover:bg-rose-500/15",text:"text-rose-200",titleText:"text-slate-100"}};function ar({points:n,tone:t,guidanceLinks:s,darkMode:a,onNavigateToTool:i}){const l=a?ei[t]:Za[t];return e.jsx("ul",{className:"space-y-3",children:n.map(r=>e.jsxs("li",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wide ${l.titleText}`,children:r.title}),e.jsx("p",{className:`mt-0.5 text-sm ${l.text}`,children:qn(r.body,s,a,i)})]},r.title))})}function da({title:n,points:t,tone:s,isOpen:a,onToggle:i,guidanceLinks:l,darkMode:r,onNavigateToTool:o}){const m=r?ei[s]:Za[s];return e.jsxs("div",{className:`rounded-md border ${m.border}`,children:[e.jsxs("button",{type:"button",onClick:i,className:`flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm font-semibold transition-colors ${m.bg} ${m.text}`,children:[n,e.jsx("span",{"aria-hidden":"true",children:a?"−":"+"})]}),a&&e.jsx("div",{className:`border-t px-3 py-3 ${m.border}`,children:e.jsx(ar,{points:t,tone:s,guidanceLinks:l,darkMode:r,onNavigateToTool:o})})]})}function ir({detail:n,furtherReadingUrl:t,guidanceLinks:s,darkMode:a,onNavigateToTool:i}){const[l,r]=g.useState(!0),[o,m]=g.useState(!0);return e.jsxs("div",{children:[n.description&&e.jsx("p",{className:`text-sm ${a?"text-slate-200":"text-slate-700"}`,children:n.description}),e.jsxs("div",{className:`mt-4 space-y-4 ${n.description?"border-t pt-4":""} ${a?"border-slate-700":"border-slate-200"}`,children:[t&&e.jsx("a",{href:t,target:"_blank",rel:"noopener noreferrer",className:`inline-flex items-center gap-1 rounded-md border px-3 py-1.5 text-xs font-semibold ${a?"border-slate-600 bg-slate-800 text-blue-300 hover:bg-slate-700":"border-slate-300 bg-white text-[#005eb8] hover:bg-slate-50"}`,children:"Further Reading ↗"}),n.whatIsIt&&e.jsx("p",{className:`text-sm ${a?"text-slate-300":"text-slate-600"}`,children:qn(n.whatIsIt,s,a,i)}),n.userInsight&&e.jsxs("blockquote",{className:`border-l-2 pl-3 text-sm italic ${a?"border-slate-600 text-slate-300":"border-slate-300 text-slate-600"}`,children:["“",qn(n.userInsight,s,a,i),"”"]}),n.whyThisMatters&&e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wide ${a?"text-slate-200":"text-slate-700"}`,children:"Why this matters"}),e.jsx("ul",{className:`mt-1 list-disc space-y-1 pl-5 text-sm ${a?"text-slate-300":"text-slate-600"}`,children:ca(n.whyThisMatters).map(f=>e.jsx("li",{children:qn(f,s,a,i)},f))})]}),n.quickRealityCheck&&e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wide ${a?"text-slate-200":"text-slate-700"}`,children:"Quick reality check"}),e.jsx("ul",{className:`mt-1 list-disc space-y-1 pl-5 text-sm ${a?"text-slate-300":"text-slate-600"}`,children:ca(n.quickRealityCheck).map(f=>e.jsx("li",{children:qn(f,s,a,i)},f))})]}),(n.whatGoodLooksLike.length>0||n.risksIfYouDont.length>0)&&e.jsxs("div",{className:"space-y-2",children:[n.whatGoodLooksLike.length>0&&e.jsx(da,{title:"What good looks like",points:n.whatGoodLooksLike,tone:"good",isOpen:l,onToggle:()=>r(f=>!f),guidanceLinks:s,darkMode:a,onNavigateToTool:i}),n.risksIfYouDont.length>0&&e.jsx(da,{title:"Risks if you don't",points:n.risksIfYouDont,tone:"risk",isOpen:o,onToggle:()=>m(f=>!f),guidanceLinks:s,darkMode:a,onNavigateToTool:i})]})]})]})}function or({open:n,onClose:t,detail:s,furtherReadingUrl:a,guidanceLinks:i,darkMode:l,onNavigateToTool:r}){return n?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{className:`${l?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl border p-6 shadow-2xl`,children:[e.jsxs("div",{className:"flex items-start justify-between gap-3",children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${l?"text-slate-300":"text-slate-500"}`,children:"Component overview"}),e.jsx("button",{type:"button",onClick:t,"aria-label":"Close component overview",className:`shrink-0 rounded-md border px-2 py-1 text-sm ${l?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"×"})]}),e.jsx("div",{className:"mt-2",children:e.jsx(ir,{detail:s,furtherReadingUrl:a,guidanceLinks:i,darkMode:l,onNavigateToTool:r})})]})}):null}const Xt="__evidence_json__:",rr=1024*1024;function lr(n,t,s){return(s[n]||[]).filter(a=>a.linkedActions.some(i=>i.actionId===t))}function ni(n){const t=n.trim();return t?/^https?:\/\//i.test(t)?t:/^www\./i.test(t)?`https://${t}`:t:""}function pt(n){const t=(n==null?void 0:n.trim())||"";if(!t)return[];if(t.startsWith(Xt))try{const s=JSON.parse(t.slice(Xt.length));return Array.isArray(s)?s.filter(a=>a&&(a.type==="url"||a.type==="file")).map(a=>({type:a.type,label:String(a.label||"").trim(),href:String(a.href||"").trim()})).filter(a=>a.label||a.href):[]}catch{return[]}return t.split(`
`).map(s=>s.trim()).filter(Boolean).map(s=>{const a=ni(s);return{type:"url",label:s,href:a}})}function cr(n){const t=n.map(s=>({type:s.type,label:s.label.trim(),href:s.href.trim()})).filter(s=>s.label||s.href);return t.length?`${Xt}${JSON.stringify(t)}`:""}function dr({rows:n,isOpen:t,onToggle:s,darkMode:a}){return e.jsxs("div",{className:`mb-8 rounded-lg border ${a?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("button",{type:"button",onClick:s,className:"flex w-full items-center justify-between gap-4 px-5 py-4 text-left",children:[e.jsxs("div",{children:[e.jsx("h3",{className:`text-sm font-semibold ${a?"text-slate-100":"text-slate-800"}`,children:"Evidence Links and Docs"}),e.jsx("p",{className:`mt-0.5 text-xs ${a?"text-slate-400":"text-slate-500"}`,children:n.length?`${n.length} item${n.length===1?"":"s"} attached across this component's actions.`:"Everything attached as evidence across this component's actions, in one place."})]}),e.jsx("span",{className:`shrink-0 text-xs font-semibold ${a?"text-slate-300":"text-slate-500"}`,children:t?"Hide −":"Show +"})]}),t&&e.jsx("div",{className:`border-t px-5 py-4 ${a?"border-slate-700":"border-slate-200"}`,children:n.length?e.jsx("div",{className:"overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:`min-w-full ${a?"divide-slate-700 bg-slate-800":"divide-slate-200 bg-white"} divide-y`,children:[e.jsx("thead",{className:a?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Action"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Lens"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Type"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Link / Doc"})]})}),e.jsx("tbody",{className:`${a?"divide-slate-700":"divide-slate-100"} divide-y`,children:n.map((i,l)=>e.jsxs("tr",{children:[e.jsx("td",{className:`px-3 py-2 text-sm ${a?"text-slate-100":"text-slate-800"}`,children:i.actionText}),e.jsx("td",{className:`px-3 py-2 text-sm ${a?"text-slate-300":"text-slate-600"}`,children:i.lens}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:`${i.item.type==="file"?"bg-emerald-100 text-emerald-800":"bg-blue-100 text-blue-800"} inline-flex rounded-full px-2 py-1 text-[11px] font-semibold uppercase tracking-wide`,children:i.item.type==="file"?"File":"Link"})}),e.jsx("td",{className:`px-3 py-2 text-sm ${a?"text-slate-100":"text-slate-800"}`,children:i.item.href?e.jsx("a",{href:i.item.href,target:"_blank",rel:"noopener noreferrer",className:`underline ${a?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-blue-800"}`,children:i.item.label||i.item.href}):i.item.label||"-"})]},`${i.lens}:${l}`))})]})}):e.jsx("p",{className:`text-sm ${a?"text-slate-400":"text-slate-500"}`,children:"No evidence added yet. Attach links or documents to an action to see them here."})})]})}function ur(n){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>t(String(a.result||"")),a.onerror=()=>s(new Error("Unable to read file.")),a.readAsDataURL(n)})}function mr(){return e.jsx("svg",{className:"w-4 h-4 text-blue-500 mt-0.5 mr-2 shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z"})})}function ua(){return e.jsx("svg",{className:"w-5 h-5 ml-2 text-slate-400 group-hover:text-[#005eb8] shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z"})})}function gr(){return e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M11 5h2m6.5-.5a2.121 2.121 0 013 3L8 21l-4 1 1-4L17.5 4.5z"})})}function pr(){return e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 7h12M9 7V5a1 1 0 011-1h4a1 1 0 011 1v2m3 0-.867 12.142A2 2 0 0115.138 21H8.862a2 2 0 01-1.995-1.858L6 7h12z"})})}function hr(n,t){let s=n,a=ta({actions:t},s);for(;a;)s=a.nextScore,a=ta({actions:t},s);return s}function fr(n,t,s){return{id:`${Date.now()}-${Math.random().toString(36).slice(2,8)}`,text:"",actionType:void 0,owner:"",timescale:"",status:"Planned",phase:n,startDate:"",dueDate:"",notes:"",evidence:"",linkedTargets:[{componentId:t,lens:s}]}}function In(n,t,s){const a=n.linkedTargets||[];if(!a.length)return[{componentId:t,lens:s}];const i=new Set,l=[];return a.forEach(r=>{const o=`${r.componentId}:${r.lens}`;i.has(o)||(i.add(o),l.push({componentId:r.componentId,lens:r.lens}))}),l}function br({store:n,components:t,activeComponentId:s,getRubricText:a,getEntry:i,onComponentChange:l,onEntryUpdate:r,onOpenLensInfo:o,onActionRemove:m,onObjectivesUpdate:f,onNavigateToTool:d,hideGuidedWorkflow:c=!1,showAdditionalGuidanceLinks:x=!0,showActionPriorityColours:b=!1,currentUserId:w,currentUserProfileImageDataUrl:P,onHideGuidedWorkflow:O,darkMode:p=!1,focusAction:I,onFocusActionHandled:H}){var En,gn,As,Os,_s,Rs,Ps,Ds,$s,Ts,Ls,Bs,Ms,Gs,Fs,Us;const j=t.find(u=>u.id===s)||t[0],k=(gn=(En=n.orgProfile)==null?void 0:En.cst)==null?void 0:gn.pathway,y=u=>k&&k!=="pathway-1"?`No outcomes or actions are defined for ${Da[k]} yet.`:u,Z=((Os=(As=n.orgProfile)==null?void 0:As.projectName)==null?void 0:Os.trim())||nr,L=(_s=la[j.id])!=null&&_s.whatIsIt?sr(la[j.id],Z):void 0,Y=(Rs=n.orgProfile)!=null&&Rs.coreLinks&&n.orgProfile.coreLinks.length>0?n.orgProfile.coreLinks:Va,te=g.useMemo(()=>{var u;return(((u=n.orgProfile)==null?void 0:u.toolLinks)||[]).filter(N=>N.matchText.trim()).map(N=>({key:N.key,label:N.matchText,kind:"tool",tool:N.tool}))},[(Ps=n.orgProfile)==null?void 0:Ps.toolLinks]),re=g.useMemo(()=>{var Q;const u=(Q=n.orgProfile)==null?void 0:Q.linkOverrides,N=Zo(x,u),T=x?Y:Y.filter(pe=>pe.type==="core"),z={};return Object.keys(N).forEach(pe=>{var Nn,Dn;const _e=new Map,Pe=((Dn=(Nn=n.orgProfile)==null?void 0:Nn.customComponentLinks)==null?void 0:Dn[pe])||[];[...N[pe],...T,...Pe].forEach(Ze=>{Ze.label&&Ze.label.trim().length>=Xa&&_e.set(Ze.label.toLowerCase(),{...Ze,kind:"url"})}),te.forEach(Ze=>{_e.set(Ze.label.toLowerCase(),Ze)}),z[pe]=[..._e.values()]}),z},[x,Y,(Ds=n.orgProfile)==null?void 0:Ds.linkOverrides,($s=n.orgProfile)==null?void 0:$s.customComponentLinks,te]),[_,G]=g.useState(null),[Ne,Ce]=g.useState(!1),[Te,Ke]=g.useState([]),B=g.useCallback((u,N,T)=>{const z=hr(N,T);if(z>N){const Q=`${j.label} · ${u} moved to ${On(z).label}!`;Ke(pe=>[...pe,{id:`${Date.now()}-${Math.random().toString(36).slice(2,8)}`,message:Q}])}return z},[j.label]),[le,ie]=g.useState(!1),ge=g.useRef(null),[be,ye]=g.useState(null),[se,De]=g.useState(null),[$e,ze]=g.useState(!1),[Be,Ie]=g.useState(!0),[cn,Je]=g.useState(!0),[dn,en]=g.useState(!0),[R,ae]=g.useState(!1),[X,he]=g.useState(!1),xe=pn("assessment"),[ke,Ae]=g.useState({}),[S,D]=g.useState(null),[E,A]=g.useState({}),[U,W]=g.useState({}),ne=((Ts=n.objectives)==null?void 0:Ts[j.id])||[],oe=n.orgProfile.teamMembers||[],Se=((Ls=oe.find(u=>u.id===w))==null?void 0:Ls.name)||"",ve=g.useMemo(()=>{const u={};return j.lenses.forEach(N=>{u[N]=i(j.id,N).actions||[]}),u},[j.id,j.lenses,i]),Xe=g.useMemo(()=>{const u={};return j.lenses.forEach(N=>{const T=i(j.id,N),z=ve[N]||[],Q=z.some(_e=>_e.readinessScore===0),pe=T.score===0&&!Q?1:T.score;u[N]=z.filter(_e=>(_e.readinessScore??pe)===pe)}),u},[j.id,j.lenses,i,ve]),un=g.useMemo(()=>j.lenses.reduce((u,N)=>u+(Xe[N]||[]).length,0),[j.lenses,Xe]),Cn=g.useMemo(()=>j.lenses.reduce((u,N)=>u+(Xe[N]||[]).filter(T=>We(T.status)==="Completed").length,0),[j.lenses,Xe]),v=g.useMemo(()=>j.lenses.some(u=>Number(i(j.id,u).score||0)>0),[j.id,j.lenses,i]),$=g.useMemo(()=>{const u={};return Object.keys(n.currentDraft).forEach(N=>{Object.keys(n.currentDraft[N]||{}).forEach(T=>{(n.currentDraft[N][T].actions||[]).forEach(Q=>{In(Q,N,T).forEach(_e=>{const Pe=`${_e.componentId}:${_e.lens}`;u[Pe]||(u[Pe]=[]),u[Pe].push({sourceComponentId:N,sourceLens:T,action:Q,isLinkedView:!(_e.componentId===N&&_e.lens===T)})})})})}),u},[n.currentDraft]),V=g.useMemo(()=>{const u={};return t.forEach(N=>{u[N.id]=N}),u},[t]),de=g.useMemo(()=>{const u=[];return j.lenses.forEach(N=>{($[`${j.id}:${N}`]||[]).filter(z=>!z.isLinkedView).forEach(z=>{pt(z.action.evidence||"").forEach(Q=>{u.push({actionText:z.action.text||"Untitled action",lens:N,item:Q})})})}),u},[$,j.id,j.lenses]),we=g.useMemo(()=>{const u=j.lenses[0];return u?i(j.id,u).justification:""},[j.id,j.lenses,i]),Me=g.useMemo(()=>{var u;return _?((u=t.find(N=>N.id===_.sourceComponentId))==null?void 0:u.label)||_.sourceComponentId:j.label},[_,j.label,t]),Fe=g.useMemo(()=>{var N;if(!((N=_==null?void 0:_.action.text)!=null&&N.trim()))return"New action";const u=_.action.text.trim().replace(/\s+/g," ");return u.length>70?`${u.slice(0,70)}...`:u},[_]),Ee=g.useMemo(()=>ne.find(u=>u.id===(be==null?void 0:be.objectiveId))||null,[be==null?void 0:be.objectiveId,ne]),je=g.useMemo(()=>Ee?Vt(Ee,ve):null,[Ee,ve]),nn=g.useMemo(()=>Ee?Ee.linkedActions.map(u=>{const N=(ve[u.lens]||[]).find(Q=>Q.id===u.actionId),T=N?We(N.status):null,z=N?Wt(N.status,N.startDate,N.dueDate):null;return{lens:u.lens,action:N,status:T,temporalStatus:z}}):[],[Ee,ve]);g.useCallback(u=>{l(u.target.value)},[l]);const Ue=g.useCallback((u,N)=>{const T=i(j.id,u);r(j.id,u,{...T,score:N})},[j.id,i,r]),on=g.useCallback(u=>{j.lenses.forEach(N=>{const T=i(j.id,N);r(j.id,N,{...T,justification:u})})},[j.id,j.lenses,i,r]),tn=g.useCallback((u,N)=>{const T=fr(j.phase,j.id,u);N&&(T.text=N),G({sourceComponentId:j.id,sourceLens:u,mode:"create",action:T,evidenceItems:pt(T.evidence||""),linkedObjectiveIds:[],targetPickerComponentId:j.id,targetPickerLens:u})},[j.id,j.phase]),wn=g.useCallback((u,N,T)=>{var _e;const z=In(T,u,N),Q=z[0]||{componentId:u,lens:N},pe=(((_e=n.objectives)==null?void 0:_e[u])||[]).filter(Pe=>Pe.linkedActions.some(Nn=>Nn.actionId===T.id)).map(Pe=>Pe.id);G({sourceComponentId:u,sourceLens:N,mode:"edit",actionId:T.id,action:{...T,linkedTargets:z,notes:T.notes||"",evidence:T.evidence||"",startDate:T.startDate||"",dueDate:T.dueDate||""},evidenceItems:pt(T.evidence||""),linkedObjectiveIds:pe,targetPickerComponentId:Q.componentId,targetPickerLens:Q.lens})},[n.objectives]),Gn=g.useCallback(()=>{De({mode:"create",text:"",owner:""})},[]),Fn=g.useCallback(u=>{De({mode:"edit",objectiveId:u.id,text:u.text,owner:u.owner})},[]),Un=()=>{De(null)},_n=()=>{if(se){if(!se.text.trim()){window.alert("Outcome description is required.");return}if(se.mode==="create"){const u={id:`${Ja}${Date.now()}-${Math.random().toString(36).slice(2,8)}`,text:se.text.trim(),owner:se.owner.trim(),timescale:"",linkedActions:[]};f(j.id,[...ne,u])}else f(j.id,ne.map(u=>u.id===se.objectiveId?{...u,text:se.text.trim(),owner:se.owner.trim()}:u));De(null)}},ct=u=>{f(j.id,ne.filter(N=>N.id!==u))};g.useEffect(()=>{if(!I)return;const N=i(j.id,I.lens).actions.find(T=>T.id===I.actionId);if(!N){H==null||H();return}en(!0),wn(j.id,I.lens,N),H==null||H()},[I,j.id]);const Rn=()=>{G(null)},Xn=()=>{var _e;if(!_)return;if(!_.action.text.trim()){window.alert("Action description is required.");return}const u={..._.action,evidence:cr(_.evidenceItems),status:We(_.action.status),linkedTargets:In(_.action,_.sourceComponentId,_.sourceLens),timescale:_.action.dueDate||_.action.startDate||_.action.timescale},N=i(_.sourceComponentId,_.sourceLens),T=_.mode==="create"?[...N.actions,u]:N.actions.map(Pe=>Pe.id===_.actionId?u:Pe);r(_.sourceComponentId,_.sourceLens,{...N,actions:T,score:B(_.sourceLens,N.score,T)});const z=new Set(_.linkedObjectiveIds),pe=(((_e=n.objectives)==null?void 0:_e[_.sourceComponentId])||[]).map(Pe=>{const Nn=Pe.linkedActions.filter(Dn=>!(Dn.lens===_.sourceLens&&Dn.actionId===u.id));return z.has(Pe.id)?{...Pe,linkedActions:[...Nn,{lens:_.sourceLens,actionId:u.id}]}:{...Pe,linkedActions:Nn}});f(_.sourceComponentId,pe),Rn()},dt=()=>{if(!_)return;if(We(_.action.status)==="Completed"&&_.evidenceItems.length===0&&!Sn(st)){ge.current=Xn,ie(!0);return}Xn()},h=(u,N,T)=>{const z=i(j.id,u),Q=z.actions.map(pe=>pe.id===N?{...pe,status:We(T)}:pe);r(j.id,u,{...z,actions:Q,score:B(u,z.score,Q)})},C=(u,N,T)=>{const z=i(j.id,u),Q=z.actions.map(pe=>pe.id===N?{...pe,owner:T}:pe);r(j.id,u,{...z,actions:Q})},M=(u,N,T)=>{const z=We(T);if(N.priority==="must"&&z==="Cancelled"){window.alert("You are trying to mark what we have classified as a MUST action as Cancelled, and it shouldn't be cancelled. Please re-review.");return}const Q=pt(N.evidence||"").length>0;if(z==="Completed"&&!Q&&!Sn(st)){ge.current=()=>h(u,N.id,z),ie(!0);return}h(u,N.id,z)},ee=(u,N,T)=>{if(T.priority==="must"){window.alert("You are trying to delete what we have classified as a MUST action, and it shouldn't be deleted. Please re-review.");return}m(u,N,T.id)},q=u=>{G(N=>{if(!N)return N;const T={...N,action:{...N.action,...u}};return T.action.status=We(T.action.status),T})},me=(u,N)=>{G(T=>T&&{...T,targetPickerComponentId:u,targetPickerLens:N})},ue=()=>{G(u=>{if(!u)return u;const N=V[u.targetPickerComponentId]||j,T=N.lenses.includes(u.targetPickerLens)?u.targetPickerLens:N.lenses[0];if(!T)return u;const z=In(u.action,u.sourceComponentId,u.sourceLens);return z.some(Q=>Q.componentId===N.id&&Q.lens===T)?u:{...u,action:{...u.action,linkedTargets:[...z,{componentId:N.id,lens:T}]}}})},Le=(u,N)=>{G(T=>{if(!T)return T;const Q=In(T.action,T.sourceComponentId,T.sourceLens).filter(pe=>!(pe.componentId===u&&pe.lens===N));return{...T,action:{...T.action,linkedTargets:Q}}})},hn=u=>{G(N=>{if(!N)return N;const T=new Set(N.linkedObjectiveIds);return T.has(u)?T.delete(u):T.add(u),{...N,linkedObjectiveIds:Array.from(T)}})},Oe=u=>{G(N=>N&&{...N,evidenceItems:u})},fe=()=>{if(!_)return;const u=_.evidenceItems;Oe([...u,{type:"url",label:"",href:""}])},Re=(u,N,T)=>{if(!_)return;const z=_.evidenceItems;if(!z[u])return;const Q=[...z];N==="href"?Q[u]={...Q[u],href:ni(T)}:Q[u]={...Q[u],label:T},Oe(Q)},jn=u=>{if(!_)return;const N=_.evidenceItems;Oe(N.filter((T,z)=>z!==u))},mn=async u=>{if(!_)return;const N=u.target.files;if(!(N!=null&&N.length))return;const z=[..._.evidenceItems];for(const Q of Array.from(N)){if(Q.size>rr){window.alert(`"${Q.name}" is larger than 1MB. Please attach a URL instead.`);continue}try{const pe=await ur(Q);z.push({type:"file",label:Q.name,href:pe})}catch{window.alert(`Unable to upload "${Q.name}".`)}}Oe(z),u.target.value=""},Pn=(u,N)=>{N&&(ye(null),wn(j.id,u,N))},fn=u=>{const N=document.getElementById(u);N==null||N.scrollIntoView({behavior:"smooth",block:"start"})};return e.jsxs("div",{className:"max-w-5xl mx-auto pb-20",children:[e.jsx("div",{className:"mb-8 flex items-center justify-between gap-4 flex-wrap",children:e.jsxs("div",{children:[e.jsxs("h2",{className:`text-3xl font-bold flex items-center ${p?"text-slate-100":"text-slate-800"}`,children:[j.label,e.jsx("span",{className:"bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded ml-4 border border-blue-200",children:Qe[j.phase]||`Phase ${j.phase}`}),e.jsx("span",{className:"ml-2",children:e.jsx(yn,{onClick:xe.reopen,darkMode:p})})]}),e.jsx("p",{className:`mt-2 ${p?"text-slate-300":"text-slate-500"}`,children:"Assess readiness at lens level. Change Component justification, outcomes, and actions are tracked below."}),L&&e.jsx("button",{type:"button",onClick:()=>he(!0),className:`mt-2 text-sm font-semibold underline ${p?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-blue-800"}`,children:"What is this?"})]})}),L&&e.jsx(or,{open:X,onClose:()=>he(!1),detail:L,furtherReadingUrl:(Ms=(Bs=n.orgProfile)==null?void 0:Bs.componentFurtherReading)==null?void 0:Ms[j.id],guidanceLinks:re[j.id]||[],darkMode:p,onNavigateToTool:d}),!c&&!$e&&e.jsxs("div",{className:`${p?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"} mb-6 rounded-lg border p-4`,children:[e.jsxs("div",{className:"flex items-start justify-between gap-2",children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${p?"text-slate-300":"text-slate-600"}`,children:"Guided workflow"}),e.jsx("button",{type:"button",onClick:()=>ze(!0),"aria-label":"Dismiss guided workflow",className:`text-xs font-semibold leading-none ${p?"text-slate-400 hover:text-slate-200":"text-slate-400 hover:text-slate-700"}`,children:"×"})]}),e.jsxs("div",{className:"mt-2 flex flex-wrap gap-2",children:[e.jsx("button",{type:"button",onClick:()=>fn("assessment-scoring"),className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-1.5 text-xs font-semibold`,children:"1. Where are you now?"}),e.jsx("button",{type:"button",onClick:()=>fn("assessment-objectives"),className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-1.5 text-xs font-semibold`,children:"2. Review outcomes"}),e.jsx("button",{type:"button",onClick:()=>fn("assessment-actions"),className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-1.5 text-xs font-semibold`,children:"3. Plan lens actions"})]}),O&&e.jsx("button",{type:"button",onClick:O,className:`mt-3 text-xs underline ${p?"text-slate-400 hover:text-slate-200":"text-slate-500 hover:text-slate-700"}`,children:"Don't show this again"})]}),e.jsxs("div",{id:"assessment-scoring",className:`${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mb-8 rounded-lg border p-5`,children:[e.jsxs("div",{className:"mb-3 flex flex-wrap items-center justify-between gap-2",children:[e.jsx("h3",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:v?"Step 1: Where are you now?":"Step 1: Where are you now and what is currently known?"}),e.jsx("button",{type:"button",onClick:()=>Ie(u=>!u),className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-2.5 py-1 text-xs font-semibold`,children:Be?"Hide":"Show"})]}),Be?e.jsxs(e.Fragment,{children:[e.jsx("label",{className:`block text-sm font-semibold mb-2 ${p?"text-slate-100":"text-slate-700"}`,children:"Change Component Justification"}),e.jsx("p",{className:`text-xs mb-2 ${p?"text-slate-300":"text-slate-500"}`,children:'Explain what is currently known, what evidence supports that view, and where the biggest gap sits. Example: "Sponsorship is visible only in two services; there is no monthly steering update yet; next step is to agree a trust-wide sponsor cadence."'}),e.jsx("textarea",{value:we,onChange:u=>on(u.target.value),className:`w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm h-24 p-2 border ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,placeholder:"Record what is currently known for this change component, the evidence behind it, and the key improvement needed next."})]}):null]}),e.jsxs("div",{id:"assessment-objectives",className:`${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mb-8 rounded-lg border p-5`,children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-2 mb-1",children:[e.jsx("h3",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:"Step 2: Review outcomes"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{type:"button",onClick:Gn,className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-2.5 py-1 text-xs font-semibold`,children:"Add Outcome"}),e.jsx("button",{type:"button",onClick:()=>Je(u=>!u),className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-2.5 py-1 text-xs font-semibold`,children:cn?"Hide":"Show"})]})]}),e.jsx("p",{className:`text-xs mb-3 ${p?"text-slate-300":"text-slate-500"}`,children:"Owned by this component as a whole. Status is derived automatically from the lens actions assigned to each outcome below and cannot be set manually."}),cn?ne.length?e.jsx("div",{className:"overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:`min-w-full ${p?"divide-slate-700 bg-slate-800":"divide-slate-200 bg-white"} divide-y`,children:[e.jsx("thead",{className:p?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Description"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Status"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Linked Actions"})]})}),e.jsx("tbody",{className:`${p?"divide-slate-700":"divide-slate-100"} divide-y`,children:ne.map(u=>{const N=Vt(u,ve),T=ra[N],z=()=>ye({objectiveId:u.id});return e.jsxs("tr",{onClick:z,onKeyDown:Q=>{(Q.key==="Enter"||Q.key===" ")&&(Q.preventDefault(),z())},tabIndex:0,className:`${p?"hover:bg-slate-700 focus-visible:bg-slate-700":"hover:bg-slate-50 focus-visible:bg-slate-50"} cursor-pointer focus:outline-none`,children:[e.jsx("td",{className:`px-3 py-2 text-sm ${p?"text-slate-100":"text-slate-800"}`,children:u.text||"Untitled outcome"}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:`inline-flex min-w-[7.5rem] items-center justify-center whitespace-nowrap rounded-full border px-3 py-1 text-center text-xs font-semibold ${T}`,children:N})}),e.jsx("td",{className:`px-3 py-2 text-sm ${p?"text-slate-300":"text-slate-600"}`,children:u.linkedActions.length?`${u.linkedActions.length} action(s)`:"None assigned"})]},u.id)})})]})}):e.jsx("p",{className:"text-sm text-slate-500",children:y("No outcomes yet.")}):null]}),e.jsx("div",{id:"assessment-actions",className:`${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mb-8 rounded-lg border p-5`,children:e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-2",children:[e.jsxs("div",{children:[e.jsx("h3",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:"Step 3: Plan lens actions"}),e.jsx("p",{className:`mt-1 text-xs ${p?"text-slate-300":"text-slate-600"}`,children:"Track delivery actions for each lens and link them to outcomes and affected component lenses."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("span",{className:`${p?"bg-slate-800 border-slate-600 text-slate-100":"bg-white border-slate-300 text-slate-700"} rounded-full border px-2 py-1 text-xs`,children:[Cn,"/",un," completed"]}),e.jsx("button",{type:"button",onClick:()=>en(u=>!u),className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-2.5 py-1 text-xs font-semibold`,children:dn?"Hide":"Show"})]})]})}),dn?e.jsx("div",{className:"space-y-8 mb-8",children:j.lenses.map(u=>{const N=i(j.id,u),T=`${j.id}:${u}`,z=$[T]||[],Q=z.some(K=>K.action.readinessScore===0),pe=N.score===0&&!Q?1:N.score,_e=E[T]||"all",Pe=U[T]||"all",Nn=Array.from(new Set(z.map(K=>K.action.actionType).filter(K=>K!==void 0))).sort((K,ce)=>String(K).localeCompare(String(ce))),Dn=Array.from(new Set([...oe.map(K=>K.name),...z.map(K=>K.action.owner).filter(K=>!!K)])).sort((K,ce)=>K.localeCompare(ce)),Ze=[...z].filter(K=>(K.action.readinessScore!==void 0?K.action.readinessScore:pe)!==pe||_e!=="all"&&(K.action.actionType||"")!==_e?!1:Pe==="all"||(K.action.owner||"")===Pe).sort((K,ce)=>{const Qn=We(K.action.status)==="Completed",Zn=We(ce.action.status)==="Completed";if(Qn!==Zn)return Qn?1:-1;const ut=K.action.dueDate?new Date(K.action.dueDate).getTime():Number.POSITIVE_INFINITY,It=ce.action.dueDate?new Date(ce.action.dueDate).getTime():Number.POSITIVE_INFINITY;return ut-It}),Ws=N.score>=j.target?"#22c55e":N.score>0?"#f59e0b":"#cbd5e1";return e.jsxs("div",{className:`${p?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-lg shadow-sm border overflow-hidden`,children:[e.jsxs("div",{className:`${p?"bg-slate-900 border-slate-700":"bg-slate-50 border-slate-200"} p-6 border-b flex flex-col md:flex-row justify-between items-start md:items-center gap-4`,children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-sm font-bold uppercase tracking-wider text-blue-600 block mb-1",children:"Lens"}),e.jsxs("button",{onClick:()=>o(u),className:`flex items-center text-2xl font-semibold transition-colors group text-left ${p?"text-slate-100 hover:text-[#63b3ff]":"text-slate-800 hover:text-[#005eb8]"}`,title:"View Lens Information",children:[u,e.jsx(ua,{})]})]}),e.jsxs("div",{className:"shrink-0 w-full md:w-64",children:[e.jsxs("div",{className:"flex items-center gap-1 mb-1",children:[e.jsx("label",{className:`block text-xs font-semibold ${p?"text-slate-300":"text-slate-500"}`,children:"Readiness Score"}),e.jsx("button",{type:"button",onClick:()=>Ce(!0),className:"group",title:"What do the readiness score levels mean?","aria-label":"What do the readiness score levels mean?",children:e.jsx(ua,{})})]}),e.jsx("select",{value:N.score,onChange:K=>Ue(u,Number(K.target.value)),className:`w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 text-sm font-medium border ${p?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,style:{borderLeftWidth:"4px",borderLeftColor:Ws},children:Xo.map(K=>e.jsxs("option",{value:K,children:[K," - ",Qo[K]]},K))})]})]}),e.jsx("div",{className:`${p?"bg-slate-900":"bg-blue-50/50"} px-6 py-4 border-b text-sm`,style:{borderLeftWidth:"4px",borderLeftColor:Ws},children:e.jsxs("div",{className:"flex items-start flex-1",children:[e.jsx(mr,{}),e.jsxs("p",{className:`whitespace-pre-line ${p?"text-slate-300":"text-slate-600"}`,children:[e.jsxs("strong",{className:p?"text-slate-100":"text-slate-700",children:[N.score===0?"Not Started":`Level ${N.score}`,":"]}),` ${a(j.id,u,N.score)}`]})]})}),e.jsxs("div",{className:`${p?"border-slate-700":"border-slate-100"} p-6 border-t`,children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("div",{children:[e.jsx("h4",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:"Lens Actions"}),e.jsx("p",{className:`mt-1 text-xs ${p?"text-slate-300":"text-slate-500"}`,children:"Hierarchy: Outcome - Action - Affected component lenses."})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsxs("select",{"aria-label":`Filter ${u} actions by type`,value:_e,onChange:K=>A(ce=>({...ce,[T]:K.target.value})),className:`rounded-md border px-2.5 py-1.5 text-xs font-semibold ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-700"}`,children:[e.jsx("option",{value:"all",children:"All action types"}),[...new Set([...St,...Nn])].map(K=>e.jsx("option",{value:K,children:K},K))]}),e.jsxs("select",{"aria-label":`Filter ${u} actions by owner`,value:Pe,onChange:K=>W(ce=>({...ce,[T]:K.target.value})),className:`rounded-md border px-2.5 py-1.5 text-xs font-semibold ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-700"}`,children:[e.jsx("option",{value:"all",children:"All owners"}),Dn.map(K=>e.jsx("option",{value:K,children:K},K))]}),e.jsx("button",{onClick:()=>tn(u),className:"px-3 py-1.5 rounded bg-[#005eb8] text-white text-xs font-semibold shadow-[0_2px_0_#003087] hover:bg-[#00417a] transition-colors focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2",children:"Add Action"})]})]}),Ze.length?e.jsx("div",{className:"overflow-x-auto rounded-md border border-slate-200",children:e.jsxs("table",{className:`min-w-full ${p?"divide-slate-700 bg-slate-800":"divide-slate-200 bg-white"} divide-y`,children:[e.jsx("thead",{className:p?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Description"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Current State"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Owner"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Actions"})]})}),e.jsx("tbody",{className:`${p?"divide-slate-700":"divide-slate-100"} divide-y`,children:(ke[`${j.id}:${u}`]?Ze:Ze.slice(0,5)).map(K=>{var Hs;const ce=K.action,Qn=We(ce.status),Zn=Wt(ce.status,ce.startDate,ce.dueDate),ut=Zn==="Overdue start"||Zn==="Overdue completion"?Zn:null,It=((Hs=V[K.sourceComponentId])==null?void 0:Hs.label)||K.sourceComponentId,Ai=lr(K.sourceComponentId,ce.id,n.objectives||{}),Oi=An[Qn]||An.Planned,At=`${K.sourceComponentId}:${K.sourceLens}:${ce.id}`,_i=b&&k==="pathway-1"&&ce.priority?ce.priority==="must"?p?"bg-red-950/30":"bg-red-50":p?"bg-amber-950/30":"bg-amber-50":"";return e.jsxs("tr",{className:_i,children:[e.jsxs("td",{className:`px-3 py-2 text-sm ${p?"text-slate-100":"text-slate-800"}`,children:[e.jsx("div",{children:qn(ce.text,re[K.sourceComponentId]||[],p,d)}),K.isLinkedView?e.jsxs("div",{className:`mt-1 text-xs ${p?"text-indigo-300":"text-indigo-700"}`,children:["Linked from ",It," /"," ",K.sourceLens]}):null]}),e.jsxs("td",{className:"px-3 py-2",children:[e.jsx("select",{"aria-label":`Current state for ${ce.text}`,value:Qn,onChange:rn=>M(K.sourceLens,ce,rn.target.value),className:`min-w-[7.5rem] rounded-md border px-2 py-1 text-xs font-semibold ${Oi} focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b]`,children:Rt.map(rn=>e.jsx("option",{value:rn,children:rn},rn))}),ut?e.jsx("div",{className:"mt-1 text-xs text-rose-700",children:ut}):null,!Ai.length&&e.jsx("div",{className:`mt-1 text-center text-xs ${p?"text-amber-200":"text-amber-700"}`,children:"Not yet linked"})]}),e.jsx("td",{className:"px-3 py-2",children:S===At?e.jsxs("select",{autoFocus:!0,"aria-label":`Owner for ${ce.text}`,value:ce.owner||"",onChange:rn=>{C(K.sourceLens,ce.id,rn.target.value),D(null)},onBlur:()=>D(null),className:`min-w-[9rem] rounded-md border px-2 py-1 text-xs font-semibold focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:[e.jsx("option",{value:"",children:"Unassigned"}),oe.map(rn=>e.jsx("option",{value:rn.name,children:rn.name},rn.id)),ce.owner&&!oe.some(rn=>rn.name===ce.owner)?e.jsxs("option",{value:ce.owner,children:[ce.owner," (not on roster)"]}):null]}):e.jsx("button",{type:"button",onClick:()=>D(At),"aria-label":`Change owner for ${ce.text}`,className:"rounded-full focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b]",children:e.jsx(za,{name:ce.owner||"",darkMode:p,imageDataUrl:Se&&ce.owner===Se?P:void 0})})}),e.jsx("td",{className:"px-3 py-2",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Ko,{status:ce.status,startDate:ce.startDate,dueDate:ce.dueDate}),e.jsx("button",{type:"button",onClick:()=>wn(K.sourceComponentId,K.sourceLens,ce),title:"Edit action","aria-label":`Edit ${ce.text}`,className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} inline-flex h-8 w-8 items-center justify-center rounded-md border`,children:e.jsx(gr,{})}),e.jsx("button",{type:"button",onClick:()=>ee(K.sourceComponentId,K.sourceLens,ce),title:"Remove action","aria-label":`Remove ${ce.text}`,className:`${p?"border-red-500/40 bg-red-500/15 text-red-200 hover:bg-red-500/25":"border-red-200 bg-red-50 text-red-700 hover:bg-red-100"} inline-flex h-8 w-8 items-center justify-center rounded-md border`,children:e.jsx(pr,{})})]})})]},At)})})]})}):e.jsx("p",{className:`text-sm ${p?"text-slate-300":"text-slate-500"}`,children:y("No actions yet for this lens.")}),Ze.length>5?e.jsx("button",{type:"button",onClick:()=>Ae(K=>({...K,[`${j.id}:${u}`]:!K[`${j.id}:${u}`]})),className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} mt-2 rounded-md border px-3 py-1.5 text-xs font-semibold`,children:ke[`${j.id}:${u}`]?"Show top 5 actions":`Show additional ${Ze.length>5?Ze.length-5:Ze.length} action(s)`}):""]})]},u)})}):null,e.jsx(dr,{rows:de,isOpen:R,onToggle:()=>ae(u=>!u),darkMode:p}),_?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{className:`${p?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} w-full max-w-3xl max-h-[calc(100vh-2rem)] overflow-hidden rounded-xl border p-6 shadow-2xl`,style:{borderTopWidth:"4px",borderTopColor:On(_.action.readinessScore??0).color},children:[e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsxs("div",{children:[e.jsxs("h3",{className:`text-lg font-semibold ${p?"text-slate-100":"text-slate-900"}`,children:[_.mode==="create"?"Create Action":"Edit Action"," ·"," ",Me," / ",_.sourceLens," · ",Fe]}),e.jsx("span",{className:"mt-1 inline-block rounded-full px-2 py-0.5 text-xs font-semibold text-white",style:{backgroundColor:On(_.action.readinessScore??0).color},children:On(_.action.readinessScore??0).label})]}),e.jsx("button",{type:"button",onClick:Rn,className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-1.5 text-sm`,children:"Close"})]}),e.jsxs("div",{className:"mt-4 max-h-[calc(100vh-13rem)] overflow-y-auto pr-1 grid gap-3",children:[e.jsx("div",{className:`${p?"border-slate-700 bg-slate-900":"border-blue-100 bg-white"} sticky top-0 z-10 rounded-md border px-3 py-2 shadow-sm`,children:e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"Description"}),e.jsx("textarea",{value:_.action.text,onChange:u=>q({text:u.target.value}),className:`w-full rounded-md border px-3 py-2 text-sm h-20 ${p?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`})]})}),e.jsxs("div",{className:`${p?"border-slate-700 bg-slate-900 text-slate-200":"border-blue-100 bg-blue-50 text-slate-700"} rounded-md border px-3 py-2 text-xs`,children:[e.jsx("strong",{children:"Linking order:"})," first attach this action to one or more outcomes, then add affected component lenses (component + lens) where this action should appear."]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-3",children:[e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"Action Type"}),e.jsx("select",{value:_.action.actionType||"Admin",onChange:u=>q({actionType:u.target.value}),className:`w-full rounded-md border px-3 py-2 text-sm ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:St.map(u=>e.jsx("option",{value:u,children:u},u))})]}),e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"Owner"}),e.jsxs("select",{value:_.action.owner,onChange:u=>q({owner:u.target.value}),className:`w-full rounded-md border px-3 py-2 text-sm ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:[e.jsx("option",{value:"",children:"Unassigned"}),oe.map(u=>e.jsxs("option",{value:u.name,children:[u.name,u.role?` - ${u.role}`:""]},u.id)),_.action.owner&&!oe.some(u=>u.name===_.action.owner)?e.jsxs("option",{value:_.action.owner,children:[_.action.owner," (not on roster)"]}):null]})]}),e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"Status"}),e.jsx("select",{value:_.action.status,onChange:u=>{const N=u.target.value;if(_.action.priority==="must"&&We(N)==="Cancelled"){window.alert("You are trying to mark what we have classified as a MUST action as Cancelled, and it shouldn't be cancelled. Please re-review.");return}q({status:N})},className:`w-full rounded-md border px-3 py-2 text-sm ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:Rt.map(u=>e.jsx("option",{value:u,children:u},u))})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"Start Date"}),e.jsx("input",{type:"date",value:_.action.startDate||"",onChange:u=>q({startDate:u.target.value}),className:`w-full rounded-md border px-3 py-2 text-sm ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`})]}),e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"End Date"}),e.jsx("input",{type:"date",value:_.action.dueDate||"",onChange:u=>q({dueDate:u.target.value}),className:`w-full rounded-md border px-3 py-2 text-sm ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`})]})]}),e.jsxs("label",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:[e.jsx("span",{className:"mb-1 block font-semibold",children:"Notes"}),e.jsx("textarea",{value:_.action.notes||"",onChange:u=>q({notes:u.target.value}),className:`w-full rounded-md border px-3 py-2 text-sm h-20 ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`})]}),e.jsxs("div",{className:`${p?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"} rounded-lg border p-3`,children:[e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsx("p",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:"Evidence Links / Docs"}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("button",{type:"button",onClick:fe,className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-2.5 py-1.5 text-xs font-semibold`,children:"Add web link"}),e.jsxs("label",{className:`${p?"border-slate-600 bg-slate-800 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} inline-flex cursor-pointer items-center gap-2 rounded-md border px-3 py-1.5 text-xs font-semibold`,children:["Upload file(s)",e.jsx("input",{type:"file",multiple:!0,className:"hidden",onChange:mn})]})]})]}),e.jsx("p",{className:`mt-1 text-xs ${p?"text-slate-300":"text-slate-500"}`,children:"Add evidence as either web links or uploaded files. Everything appears below in a single list."}),e.jsx("div",{className:`${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mt-2 space-y-2 rounded border p-2`,children:_.evidenceItems.length?_.evidenceItems.map((u,N)=>e.jsxs("div",{className:`${p?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"} grid grid-cols-1 gap-2 rounded border p-2 md:grid-cols-[auto,1fr,1fr,auto]`,children:[e.jsx("div",{className:"flex items-start pt-2",children:e.jsx("span",{className:`${u.type==="file"?"bg-emerald-100 text-emerald-800":"bg-blue-100 text-blue-800"} inline-flex rounded-full px-2 py-1 text-[11px] font-semibold uppercase tracking-wide`,children:u.type==="file"?"File":"Link"})}),e.jsx("input",{value:u.label,onChange:T=>Re(N,"label",T.target.value),placeholder:u.type==="file"?"Document label":"Link label",className:`rounded-md border px-2.5 py-2 text-sm ${p?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`}),e.jsx("input",{value:u.href,onChange:T=>Re(N,"href",T.target.value),placeholder:u.type==="file"?"Embedded file URL (auto generated)":"https://...",className:`rounded-md border px-2.5 py-2 text-sm ${p?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,disabled:u.type==="file"}),e.jsx("button",{type:"button",onClick:()=>jn(N),className:"rounded border border-red-200 bg-red-50 px-2 py-1 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})]},`${u.type}-${N}`)):e.jsx("p",{className:`px-2 py-1 text-sm ${p?"text-slate-300":"text-slate-500"}`,children:"No evidence links or documents added yet."})})]}),e.jsxs("div",{className:`${p?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"} rounded-lg border p-3`,children:[e.jsx("p",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:"Affected Outcomes"}),e.jsx("p",{className:`mt-1 text-xs ${p?"text-slate-300":"text-slate-500"}`,children:"Tick 1-3 outcomes directly impacted by this action. Outcome status is auto-derived from these linked actions."}),e.jsx("div",{className:`${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mt-2 space-y-2 rounded border p-2`,children:(((Gs=n.objectives)==null?void 0:Gs[_.sourceComponentId])||[]).length?(((Fs=n.objectives)==null?void 0:Fs[_.sourceComponentId])||[]).map(u=>{const N=_.linkedObjectiveIds.includes(u.id);return e.jsxs("label",{className:`${p?"hover:bg-slate-700":"hover:bg-slate-50"} flex items-start gap-2 rounded px-2 py-1.5`,children:[e.jsx("input",{type:"checkbox",checked:N,onChange:()=>hn(u.id),className:"mt-0.5"}),e.jsx("span",{className:`text-sm ${p?"text-slate-100":"text-slate-700"}`,children:u.text||"Untitled outcome"})]},u.id)}):e.jsx("p",{className:`px-2 py-1 text-sm ${p?"text-slate-300":"text-slate-500"}`,children:y("No outcomes are defined for this component yet.")})})]}),e.jsxs("div",{className:`${p?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"} rounded-lg border p-3`,children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("p",{className:`text-sm font-semibold ${p?"text-slate-100":"text-slate-800"}`,children:"Affected Component Lenses"}),e.jsx("span",{className:"inline-flex h-5 w-5 items-center justify-center rounded-full border border-slate-300 text-xs font-semibold text-slate-600",title:"Actions often contribute to other component lenses. Add those targets here so the same action is visible in each relevant lens.",children:"i"})]}),e.jsxs("div",{className:"mt-2 space-y-2",children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-[1fr,1fr,auto] gap-2",children:[e.jsx("select",{value:_.targetPickerComponentId,onChange:u=>{const N=u.target.value,T=V[N];me(N,(T==null?void 0:T.lenses[0])||"")},className:`rounded-md border px-2.5 py-2 text-sm ${p?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:t.map(u=>e.jsx("option",{value:u.id,children:u.label},u.id))}),e.jsx("select",{value:_.targetPickerLens,onChange:u=>me(_.targetPickerComponentId,u.target.value),className:`rounded-md border px-2.5 py-2 text-sm ${p?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:(((Us=V[_.targetPickerComponentId])==null?void 0:Us.lenses)||[]).map(u=>e.jsx("option",{value:u,children:u},u))}),e.jsx("button",{type:"button",onClick:ue,disabled:In(_.action,_.sourceComponentId,_.sourceLens).some(u=>u.componentId===_.targetPickerComponentId&&u.lens===_.targetPickerLens),title:In(_.action,_.sourceComponentId,_.sourceLens).some(u=>u.componentId===_.targetPickerComponentId&&u.lens===_.targetPickerLens)?"Already added":"Add selected affected lens",className:`${p?"border-cyan-500/50 bg-cyan-500/15 text-cyan-100 hover:bg-cyan-500/25":"border-cyan-300 bg-cyan-100 text-cyan-900 hover:bg-cyan-200"} rounded-md border px-3 py-2 text-xs font-semibold disabled:cursor-not-allowed disabled:opacity-60`,children:"Add Lens"})]}),e.jsx("div",{className:`${p?"border-slate-700":"border-slate-200"} overflow-hidden rounded border`,children:e.jsxs("table",{className:`min-w-full ${p?"divide-slate-700 bg-slate-800":"divide-slate-200 bg-white"} divide-y`,children:[e.jsx("thead",{className:p?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-2.5 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Component"}),e.jsx("th",{className:"px-2.5 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Lens"}),e.jsx("th",{className:"px-2.5 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Remove"})]})}),e.jsx("tbody",{className:`${p?"divide-slate-700":"divide-slate-100"} divide-y`,children:In(_.action,_.sourceComponentId,_.sourceLens).map(u=>{var N;return e.jsxs("tr",{children:[e.jsx("td",{className:`px-2.5 py-2 text-sm ${p?"text-slate-100":"text-slate-700"}`,children:((N=V[u.componentId])==null?void 0:N.label)||u.componentId}),e.jsx("td",{className:`px-2.5 py-2 text-sm ${p?"text-slate-100":"text-slate-700"}`,children:u.lens}),e.jsx("td",{className:"px-2.5 py-2",children:e.jsx("button",{type:"button",onClick:()=>Le(u.componentId,u.lens),className:"rounded border border-red-200 bg-red-50 px-2 py-1 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})})]},`${u.componentId}:${u.lens}`)})})]})})]})]})]}),e.jsxs("div",{className:"mt-4 flex items-center justify-end gap-2",children:[_.mode==="edit"&&_.actionId?e.jsx("button",{type:"button",onClick:()=>{if(_.action.priority==="must"){window.alert("You are trying to delete what we have classified as a MUST action, and it shouldn't be deleted. Please re-review.");return}m(_.sourceComponentId,_.sourceLens,_.actionId),Rn()},className:"mr-auto rounded-md border border-red-200 bg-red-50 px-4 py-2 text-sm font-semibold text-red-700 hover:bg-red-100",children:"Delete Action"}):null,e.jsx("button",{type:"button",onClick:Rn,className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-4 py-2 text-sm font-semibold`,children:"Cancel"}),e.jsx("button",{type:"button",onClick:dt,className:"rounded-md bg-[#005eb8] px-4 py-2 text-sm font-semibold text-white shadow-[0_3px_0_#003087] hover:bg-[#00417a] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2",children:"Save Action"})]})]})}):null,Ne?e.jsx(Bo,{onClose:()=>Ce(!1),darkMode:p}):null,Te.length>0?e.jsx(Ka,{message:Te[0].message,onDismiss:()=>Ke(u=>u.slice(1)),celebrate:!0},Te[0].id):null,be&&Ee&&je?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":"Outcome Details",className:`w-full max-w-3xl max-h-[calc(100vh-2rem)] overflow-y-auto rounded-xl border p-6 shadow-2xl ${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsx("h3",{className:`text-lg font-semibold ${p?"text-slate-100":"text-slate-900"}`,children:"Outcome Details"}),e.jsxs("div",{className:"flex items-center gap-2",children:[Ee&&Jo(Ee.id)?e.jsxs(e.Fragment,{children:[e.jsx("button",{type:"button",onClick:()=>{Fn(Ee),ye(null)},className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-1.5 text-sm`,children:"Edit"}),e.jsx("button",{type:"button",onClick:()=>{ct(Ee.id),ye(null)},className:"rounded-md border border-red-200 bg-red-50 px-3 py-1.5 text-sm font-semibold text-red-700 hover:bg-red-100",children:"Delete"})]}):null,e.jsx("button",{type:"button",onClick:()=>ye(null),className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-1.5 text-sm`,children:"Close"})]})]}),e.jsxs("div",{className:"mt-4 space-y-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${p?"text-slate-400":"text-slate-500"}`,children:"Outcome"}),e.jsx("p",{className:`mt-1 text-sm ${p?"text-slate-100":"text-slate-900"}`,children:Ee.text||"Untitled outcome"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${p?"text-slate-400":"text-slate-500"}`,children:"Owner"}),e.jsx("p",{className:`mt-1 text-sm ${p?"text-slate-100":"text-slate-900"}`,children:Ee.owner||"Unassigned"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${p?"text-slate-400":"text-slate-500"}`,children:"Status"}),e.jsx("span",{className:`mt-1 inline-flex min-w-[7.5rem] items-center justify-center whitespace-nowrap rounded-full border px-3 py-1 text-center text-xs font-semibold ${ra[je]}`,children:je})]}),e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${p?"text-slate-400":"text-slate-500"}`,children:"Linked Actions"}),nn.length?e.jsx("div",{className:`mt-2 overflow-x-auto rounded-md border ${p?"border-slate-700":"border-slate-200"}`,children:e.jsxs("table",{className:`min-w-full divide-y ${p?"divide-slate-700 bg-slate-800":"divide-slate-200 bg-white"}`,children:[e.jsx("thead",{className:p?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Lens"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Action"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Current State"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Navigate"})]})}),e.jsx("tbody",{className:`divide-y ${p?"divide-slate-700":"divide-slate-100"}`,children:nn.map(u=>{var T,z;const N=u.status?An[u.status]||An.Planned:An.Planned;return e.jsxs("tr",{children:[e.jsx("td",{className:`px-3 py-2 text-sm ${p?"text-slate-100":"text-slate-700"}`,children:u.lens}),e.jsx("td",{className:`px-3 py-2 text-sm ${p?"text-slate-100":"text-slate-700"}`,children:((T=u.action)==null?void 0:T.text)||"Linked action not found"}),e.jsxs("td",{className:"px-3 py-2",children:[u.action?e.jsx("select",{"aria-label":`Current state for ${u.action.text}`,value:u.status||"Planned",onChange:Q=>M(u.lens,u.action,Q.target.value),className:`min-w-[7.5rem] rounded-md border px-2 py-1 text-xs font-semibold ${N} focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b]`,children:Rt.map(Q=>e.jsx("option",{value:Q,children:Q},Q))}):e.jsx("span",{className:"text-xs text-slate-500",children:"Not linked"}),u.temporalStatus==="Overdue start"||u.temporalStatus==="Overdue completion"?e.jsx("div",{className:"mt-1 text-xs text-rose-700",children:u.temporalStatus}):null]}),e.jsx("td",{className:"px-3 py-2",children:u.action?e.jsx("button",{type:"button",onClick:()=>Pn(u.lens,u.action||void 0),className:`${p?"border-blue-500/40 bg-blue-500/15 text-blue-200 hover:bg-blue-500/25":"border-blue-200 bg-blue-50 text-blue-800 hover:bg-blue-100"} rounded-md border px-2.5 py-1.5 text-xs font-semibold`,children:"Open Action"}):e.jsx("span",{className:`text-xs ${p?"text-slate-500":"text-slate-400"}`,children:"Unavailable"})})]},`${u.lens}:${((z=u.action)==null?void 0:z.id)||"missing"}`)})})]})}):e.jsx("p",{className:`mt-1 text-sm ${p?"text-slate-300":"text-slate-500"}`,children:"No linked actions assigned."})]})]})]})}):null,se?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":se.mode==="create"?"Add Outcome":"Edit Outcome",className:`w-full max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto rounded-xl border p-6 shadow-2xl ${p?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsx("h3",{className:`text-lg font-semibold ${p?"text-slate-100":"text-slate-900"}`,children:se.mode==="create"?"Add Outcome":"Edit Outcome"}),e.jsxs("div",{className:"mt-4 space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"objective-editor-text",className:`block text-xs font-medium ${p?"text-slate-300":"text-slate-700"}`,children:"Outcome description"}),e.jsx("textarea",{id:"objective-editor-text",value:se.text,onChange:u=>De({...se,text:u.target.value}),className:`mt-1 w-full rounded-md border p-2 text-sm h-20 ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"objective-editor-owner",className:`block text-xs font-medium ${p?"text-slate-300":"text-slate-700"}`,children:"Owner"}),e.jsxs("select",{id:"objective-editor-owner",value:se.owner,onChange:u=>De({...se,owner:u.target.value}),className:`mt-1 w-full rounded-md border p-2 text-sm ${p?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:[e.jsx("option",{value:"",children:"Unassigned"}),oe.map(u=>e.jsxs("option",{value:u.name,children:[u.name||"Unnamed",u.role?` - ${u.role}`:""]},u.id)),se.owner&&!oe.some(u=>u.name===se.owner)?e.jsxs("option",{value:se.owner,children:[se.owner," (not on roster)"]}):null]})]})]}),e.jsxs("div",{className:"mt-4 flex justify-end gap-2",children:[e.jsx("button",{type:"button",onClick:Un,className:`${p?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-4 py-2 text-sm font-semibold`,children:"Cancel"}),e.jsx("button",{type:"button",onClick:_n,className:"rounded-md bg-[#005eb8] px-4 py-2 text-sm font-semibold text-white shadow-[0_3px_0_#003087] hover:bg-[#00417a] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2",children:"Save Outcome"})]})]})}):null,e.jsx(Ta,{open:le,onCancel:()=>{ge.current=null,ie(!1)},onContinue:u=>{u&&sn(st,!0);const N=ge.current;ge.current=null,ie(!1),N==null||N()},darkMode:p}),e.jsx(vn,{open:xe.isOpen,onClose:xe.close,title:"Assessing a component",darkMode:p,body:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"Each component is assessed lens by lens: justify where you are, review its outcomes, then plan and track delivery actions for each readiness level."}),e.jsx("p",{children:'Click "What is this?" at the top for what the component covers, and "Evidence Links and Docs" at the bottom rounds up everything attached as evidence across all of its actions.'})]})})]})}const ht=50;function xr(n){const t=new Date(n);return Number.isNaN(t.getTime())?n:t.toLocaleString("en-GB",{year:"numeric",month:"short",day:"2-digit",hour:"2-digit",minute:"2-digit"})}function Sr({events:n,darkMode:t=!1}){const s=pn("audit-log"),[a,i]=g.useState("all"),[l,r]=g.useState("all"),[o,m]=g.useState("all"),[f,d]=g.useState(""),[c,x]=g.useState(1),b=g.useMemo(()=>["all",...Array.from(new Set(n.map(k=>k.eventType))).sort()],[n]),w=g.useMemo(()=>["all",...Array.from(new Set(n.map(k=>k.componentId).filter(Boolean))).sort()],[n]),P=g.useMemo(()=>["all",...Array.from(new Set(n.map(k=>k.actor).filter(Boolean))).sort()],[n]),O=g.useMemo(()=>{const k=f.trim().toLowerCase();return n.filter(y=>a==="all"?!0:y.eventType===a).filter(y=>l==="all"?!0:y.componentId===l).filter(y=>o==="all"?!0:y.actor===o).filter(y=>k?[y.summary,y.reason,y.entityId,y.lens].filter(Boolean).some(Z=>String(Z).toLowerCase().includes(k)):!0).sort((y,Z)=>Date.parse(Z.timestamp)-Date.parse(y.timestamp))},[n,a,l,o,f]),p=Math.max(1,Math.ceil(O.length/ht)),I=Math.min(c,p),H=(I-1)*ht,j=O.slice(H,H+ht);return e.jsxs("section",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("h2",{className:`text-2xl font-bold ${t?"text-slate-100":"text-slate-900"}`,children:"Audit Log"}),e.jsx(yn,{onClick:s.reopen,darkMode:t})]}),e.jsx("p",{className:`text-sm mt-1 ${t?"text-slate-300":"text-slate-600"}`,children:"Timestamped history of CST changes, including who made each change."})]}),e.jsx(vn,{open:s.isOpen,onClose:s.close,title:"Audit Log",darkMode:t,body:e.jsx("p",{children:"A timestamped history of changes made to your CST, including who made each change. Filter by event type, component, or actor, and expand a row to see exactly what changed."})}),e.jsxs("div",{className:`grid gap-3 md:grid-cols-4 rounded-lg border p-4 ${t?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("label",{className:"text-sm",children:[e.jsx("span",{className:`block mb-1 font-medium ${t?"text-slate-200":"text-slate-700"}`,children:"Event type"}),e.jsx("select",{value:a,onChange:k=>{i(k.target.value),x(1)},className:`w-full rounded-md border px-2 py-1.5 ${t?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:b.map(k=>e.jsx("option",{value:k,children:k==="all"?"All":k},k))})]}),e.jsxs("label",{className:"text-sm",children:[e.jsx("span",{className:`block mb-1 font-medium ${t?"text-slate-200":"text-slate-700"}`,children:"Component"}),e.jsx("select",{value:l,onChange:k=>{r(k.target.value),x(1)},className:`w-full rounded-md border px-2 py-1.5 ${t?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:w.map(k=>e.jsx("option",{value:k,children:k==="all"?"All":k},k))})]}),e.jsxs("label",{className:"text-sm",children:[e.jsx("span",{className:`block mb-1 font-medium ${t?"text-slate-200":"text-slate-700"}`,children:"Actor"}),e.jsx("select",{value:o,onChange:k=>{m(k.target.value),x(1)},className:`w-full rounded-md border px-2 py-1.5 ${t?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:P.map(k=>e.jsx("option",{value:k,children:k==="all"?"All":k},k))})]}),e.jsxs("label",{className:"text-sm",children:[e.jsx("span",{className:`block mb-1 font-medium ${t?"text-slate-200":"text-slate-700"}`,children:"Search"}),e.jsx("input",{value:f,onChange:k=>{d(k.target.value),x(1)},placeholder:"summary, reason, id",className:`w-full rounded-md border px-2 py-1.5 ${t?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-900"}`})]})]}),e.jsx("div",{className:`rounded-lg border overflow-hidden ${t?"border-slate-700":"border-slate-200"}`,children:e.jsxs("table",{className:"min-w-full text-sm",children:[e.jsx("thead",{className:t?"bg-slate-900 text-slate-200":"bg-slate-50 text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left",children:"When"}),e.jsx("th",{className:"px-3 py-2 text-left",children:"Who"}),e.jsx("th",{className:"px-3 py-2 text-left",children:"What"}),e.jsx("th",{className:"px-3 py-2 text-left",children:"Context"}),e.jsx("th",{className:"px-3 py-2 text-left",children:"Details"})]})}),e.jsx("tbody",{className:t?"bg-slate-800 text-slate-100":"bg-white text-slate-800",children:j.length?j.map(k=>e.jsxs("tr",{className:t?"border-t border-slate-700":"border-t border-slate-100",children:[e.jsx("td",{className:"px-3 py-2 align-top whitespace-nowrap",children:xr(k.timestamp)}),e.jsx("td",{className:"px-3 py-2 align-top whitespace-nowrap",children:k.actor||"Unknown user"}),e.jsxs("td",{className:"px-3 py-2 align-top",children:[e.jsx("div",{className:"font-medium",children:k.summary}),e.jsx("div",{className:`text-xs mt-1 ${t?"text-slate-300":"text-slate-600"}`,children:k.eventType})]}),e.jsxs("td",{className:"px-3 py-2 align-top",children:[e.jsx("div",{children:k.componentId||"-"}),e.jsx("div",{className:`text-xs ${t?"text-slate-300":"text-slate-600"}`,children:k.lens||"-"})]}),e.jsxs("td",{className:"px-3 py-2 align-top",children:[k.reason?e.jsxs("div",{children:["Reason: ",k.reason]}):null,k.before||k.after?e.jsxs("details",{className:"mt-1",children:[e.jsx("summary",{className:"cursor-pointer text-xs underline",children:"Before/After"}),e.jsx("pre",{className:`mt-1 text-xs whitespace-pre-wrap ${t?"text-slate-300":"text-slate-600"}`,children:JSON.stringify({before:k.before,after:k.after},null,2)})]}):null]})]},k.id)):e.jsx("tr",{children:e.jsx("td",{className:"px-3 py-6 text-center",colSpan:5,children:"No audit events found for the selected filters."})})})]})}),e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsxs("span",{className:t?"text-slate-300":"text-slate-600",children:["Showing ",j.length?H+1:0,"-",Math.min(H+ht,O.length)," of"," ",O.length]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{type:"button",onClick:()=>x(k=>Math.max(1,k-1)),disabled:I<=1,className:`rounded-md border px-2 py-1 disabled:opacity-50 ${t?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-700"}`,children:"Previous"}),e.jsxs("span",{className:t?"text-slate-200":"text-slate-700",children:["Page ",I," / ",p]}),e.jsx("button",{type:"button",onClick:()=>x(k=>Math.min(p,k+1)),disabled:I>=p,className:`rounded-md border px-2 py-1 disabled:opacity-50 ${t?"border-slate-600 bg-slate-900 text-slate-100":"border-slate-300 bg-white text-slate-700"}`,children:"Next"})]})]})]})}function vr(n){if(!n)return!1;const t=new Date(n);return!isNaN(t.getTime())}function Pt(n){return!n||!vr(n)?null:new Date(n)}function ti(n){const t=[],s=n.cst;if(!s.goLiveDate||!s.goLiveDate.trim())return t.push({field:"cst.goLiveDate",message:"Go live date is required."}),{isValid:!1,errors:t};const a=Pt(s.goLiveDate);if(!a)return t.push({field:"cst.goLiveDate",message:"Go live date must be a valid date."}),{isValid:!1,errors:t};const i=Pt(s.fullAdoptionDate);s.fullAdoptionDate&&!i&&t.push({field:"cst.fullAdoptionDate",message:"Full adoption date must be a valid date when provided."});const l=Pt(s.benefitRealizationDate);return s.benefitRealizationDate&&!l&&t.push({field:"cst.benefitRealizationDate",message:"Benefit realization date must be a valid date when provided."}),i&&i<a&&t.push({field:"cst.fullAdoptionDate",message:"Full adoption date cannot be earlier than go live date."}),l&&l<(i||a)&&t.push({field:"cst.benefitRealizationDate",message:"Benefit realization date cannot be earlier than full adoption date (or go live when full adoption is empty)."}),{isValid:t.length===0,errors:t}}function yr(n){const t=g.useMemo(()=>n.errors.reduce((s,a)=>(s[a.field]||(s[a.field]=[]),s[a.field].push(a.message),s),{}),[n.errors]);return s=>{var a;return(a=t[s])==null?void 0:a[0]}}function ma(n){const t=[];(!n.trustName||n.trustName.trim()==="")&&t.push({field:"trustName",message:"Trust name is required"}),n.trustName&&n.trustName.length>255&&t.push({field:"trustName",message:"Trust name cannot exceed 255 characters"}),n.region&&n.region.length>100&&t.push({field:"region",message:"Region cannot exceed 100 characters"});const s=ti(n);return t.push(...s.errors),{isValid:t.length===0,errors:t}}function wr({pathway:n,darkMode:t=!1}){return n==="pathway-1"?null:e.jsxs("div",{className:`mt-3 rounded-md border p-3 text-xs ${t?"border-amber-500/40 bg-amber-500/10 text-amber-100":"border-amber-300 bg-amber-50 text-amber-900"}`,children:[e.jsx("p",{className:"font-semibold",children:"Objectives and actions are currently Pathway 1 only"}),e.jsx("p",{className:"mt-1",children:"Every outcome and action in this tool right now is written for Pathway 1 (starting from scratch). Pathway 2 and Pathway 3 will need their own objectives and actions - those haven't been written yet, so components on this pathway show no outcomes or actions until pathway-specific content is added."})]})}function Nr(n){return n.trim().toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,"")||"export"}function si(n){var t;return(t=n==null?void 0:n.url)!=null&&t.trim()?"custom":((n==null?void 0:n.fallback)??"default")==="base"?"base":"default"}function ai({aliases:n,onChange:t,darkMode:s}){const[a,i]=g.useState(""),l=()=>{const r=a.trim();if(!r||n.some(o=>o.toLowerCase()===r.toLowerCase())){i("");return}t([...n,r]),i("")};return e.jsxs("div",{children:[e.jsxs("div",{className:"flex flex-wrap gap-1.5",children:[n.map(r=>e.jsxs("span",{className:`inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-xs ${s?"border-slate-600 bg-slate-800 text-slate-200":"border-slate-300 bg-slate-100 text-slate-700"}`,children:[r,e.jsx("button",{type:"button",onClick:()=>t(n.filter(o=>o!==r)),"aria-label":`Remove "${r}"`,className:s?"text-slate-400 hover:text-slate-100":"text-slate-500 hover:text-slate-800",children:"×"})]},r)),!n.length&&e.jsx("span",{className:`text-xs ${s?"text-slate-500":"text-slate-400"}`,children:"No extra matching text added yet."})]}),e.jsxs("div",{className:"mt-2 flex gap-2",children:[e.jsx("input",{type:"text",value:a,onChange:r=>i(r.target.value),onKeyDown:r=>{r.key==="Enter"&&(r.preventDefault(),l())},placeholder:"Add text this link should also match...",className:`flex-1 min-w-0 rounded border px-2 py-1.5 text-xs ${s?"border-slate-600 bg-slate-900 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),e.jsx("button",{type:"button",onClick:l,className:Ge,children:"Add"})]})]})}function kr({link:n,perLink:t,baseOverrideUrl:s,onSave:a,onClose:i,darkMode:l}){const[r,o]=g.useState(si(t)),[m,f]=g.useState((t==null?void 0:t.url)??""),[d,c]=g.useState((t==null?void 0:t.matchAliases)??[]),x=(s==null?void 0:s.trim())||Tn.url,b=Qa(n.label).find(O=>O!==n.label),w=[{value:"default",label:"Default Toolkit Link",url:n.url},{value:"base",label:"Project Specific Homepage",url:x},{value:"custom",label:"Custom URL",url:m}],P=()=>{if(r==="custom"&&!m.trim()){window.alert("Enter a custom URL, or choose Default or Base instead.");return}const O={fallback:r==="base"?"base":"default",url:r==="custom"?m.trim():void 0,matchAliases:d.length?d:void 0};a(r==="default"&&!d.length?void 0:O)};return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":`Edit ${n.label} link`,className:`w-full max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto rounded-xl border p-6 shadow-2xl ${l?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("div",{className:"flex items-start justify-between gap-3",children:[e.jsx("h3",{className:`text-lg font-semibold ${l?"text-slate-100":"text-slate-900"}`,children:n.label}),e.jsx("button",{type:"button",onClick:i,"aria-label":"Close",className:`shrink-0 rounded-md border px-2 py-1 text-sm ${l?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"×"})]}),e.jsx("div",{className:"mt-4 space-y-2",children:w.map(O=>e.jsxs("label",{className:`flex items-start gap-2 rounded-md border p-2.5 text-sm ${r===O.value?l?"border-blue-400 bg-blue-500/10":"border-blue-400 bg-blue-50":l?"border-slate-700":"border-slate-200"}`,children:[e.jsx("input",{type:"radio",name:`link-source-${n.key}`,checked:r===O.value,onChange:()=>o(O.value),className:"mt-1"}),e.jsxs("span",{className:"flex-1",children:[e.jsx("span",{className:`block font-medium ${l?"text-slate-100":"text-slate-800"}`,children:O.label}),O.value==="custom"&&r==="custom"?e.jsx("input",{type:"url",value:m,onChange:p=>f(p.target.value),placeholder:"https://...",className:`mt-1 w-full rounded border px-2 py-1.5 text-xs ${l?"border-slate-600 bg-slate-900 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}):O.url?e.jsx("a",{href:O.url,target:"_blank",rel:"noopener noreferrer",onClick:p=>p.stopPropagation(),className:`block truncate text-xs underline ${l?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-[#00417a]"}`,children:O.url}):e.jsx("span",{className:`block truncate text-xs ${l?"text-slate-400":"text-slate-500"}`,children:"No URL set yet."})]})]},O.value))}),e.jsxs("div",{className:"mt-4",children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${l?"text-slate-400":"text-slate-500"}`,children:"Match text"}),e.jsx("p",{className:`mt-1 text-xs ${l?"text-slate-300":"text-slate-500"}`,children:"This link is automatically matched in action/summary text. Add extra text below if it should match on other words too."}),e.jsxs("div",{className:"mt-2 flex flex-wrap gap-1.5",children:[e.jsxs("span",{className:`rounded-full border px-2 py-0.5 text-xs ${l?"border-slate-600 bg-slate-800 text-slate-200":"border-slate-300 bg-slate-100 text-slate-700"}`,children:[n.label," ",e.jsx("span",{className:"opacity-60",children:"(label)"})]}),b&&e.jsxs("span",{className:`rounded-full border px-2 py-0.5 text-xs ${l?"border-slate-600 bg-slate-800 text-slate-200":"border-slate-300 bg-slate-100 text-slate-700"}`,children:[b," ",e.jsx("span",{className:"opacity-60",children:"(auto-detected)"})]})]}),e.jsx("div",{className:"mt-2",children:e.jsx(ai,{aliases:d,onChange:c,darkMode:l})})]}),e.jsxs("div",{className:"mt-6 flex justify-end gap-2",children:[e.jsx("button",{type:"button",onClick:i,className:Ge,children:"Cancel"}),e.jsx("button",{type:"button",onClick:P,className:Bn,children:"Save"})]})]})})}function Cr({title:n,aliases:t,onSave:s,onClose:a,darkMode:i}){const[l,r]=g.useState(t);return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":`Match text for ${n}`,className:`w-full max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto rounded-xl border p-6 shadow-2xl ${i?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("div",{className:"flex items-start justify-between gap-3",children:[e.jsxs("h3",{className:`text-lg font-semibold ${i?"text-slate-100":"text-slate-900"}`,children:[n," - match text"]}),e.jsx("button",{type:"button",onClick:a,"aria-label":"Close",className:`shrink-0 rounded-md border px-2 py-1 text-sm ${i?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"×"})]}),e.jsx("p",{className:`mt-2 text-xs ${i?"text-slate-300":"text-slate-500"}`,children:"This link is automatically matched by its name. Add extra text below if it should match on other words too."}),e.jsx("div",{className:"mt-3",children:e.jsx(ai,{aliases:l,onChange:r,darkMode:i})}),e.jsxs("div",{className:"mt-6 flex justify-end gap-2",children:[e.jsx("button",{type:"button",onClick:a,className:Ge,children:"Cancel"}),e.jsx("button",{type:"button",onClick:()=>s(l),className:Bn,children:"Save"})]})]})})}function jr(n){const t=Ha[n]||[],s=new Map,a=new Map;return t.forEach(i=>{const l=Yn[i];((l==null?void 0:l.inputs)??[]).forEach(r=>s.set(r.key,r)),((l==null?void 0:l.deliverables)??[]).forEach(r=>a.set(r.key,r))}),{inputs:[...s.values()],deliverables:[...a.values()]}}function Er({orgProfile:n,onProfileUpdate:t,components:s,onComponentClick:a,onGoToIntroduction:i,onContinueToVision:l,onGoToWhereAmINow:r,darkMode:o=!1,currentUserId:m,onCurrentUserChange:f,showExternalLinksSection:d=!1}){var xe,ke,Ae,S,D,E,A,U,W,ne,oe,Se,ve,Xe,un,Cn;const[c,x]=g.useState(n),[b,w]=g.useState(null),[P,O]=g.useState(null),p=g.useRef(null),I=pn("cst-personalisation"),H=ma(c),j=yr(H);c.trustName.trim()&&(c.projectName||"").trim()&&(c.leadName||"").trim(),g.useEffect(()=>{x(n)},[n]);const k=g.useCallback(v=>{const $={...c,trustName:v};x($),t($)},[c,t]),y=g.useCallback(v=>{const $={...c,projectName:v};x($),t($)},[c,t]),Z=g.useCallback(v=>{const $={...c,leadName:v};x($),t($)},[c,t]),[L,Y]=g.useState(null),te=g.useCallback(v=>{v!==c.cst.pathway&&Y(v)},[c.cst.pathway]),re=g.useCallback(()=>{if(!L)return;const v={...c,cst:{...c.cst,pathway:L}};x(v),t(v),Y(null)},[L,c,t]),_=g.useCallback(()=>{Y(null)},[]),G=g.useCallback((v,$)=>{const V={...c,cst:{...c.cst,[v]:$}};x(V),t(V)},[c,t]),Ne=g.useCallback(v=>{const $={...c,cst:{...c.cst,toolkitChoice:v}};x($),t($)},[c,t]),Ce=g.useCallback(v=>{const $={...c,linkOverrides:v};x($),t($)},[c,t]),Te=g.useCallback((v,$)=>{const V={...c.componentFurtherReading};$.trim()?V[v]=$.trim():delete V[v];const de={...c,componentFurtherReading:V};x(de),t(de)},[c,t]),Ke=g.useCallback(v=>{var we;const $={key:`custom-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,label:"",url:"",type:"additional"},V={...c.customComponentLinks,[v]:[...((we=c.customComponentLinks)==null?void 0:we[v])||[],$]},de={...c,customComponentLinks:V};x(de),t(de)},[c,t]),B=g.useCallback((v,$,V,de)=>{var Ee;const we=((Ee=c.customComponentLinks)==null?void 0:Ee[v])||[],Me={...c.customComponentLinks,[v]:we.map(je=>je.key===$?{...je,[V]:de}:je)},Fe={...c,customComponentLinks:Me};x(Fe),t(Fe)},[c,t]),le=g.useCallback((v,$,V)=>{var Fe;const de=((Fe=c.customComponentLinks)==null?void 0:Fe[v])||[],we={...c.customComponentLinks,[v]:de.map(Ee=>Ee.key===$?{...Ee,matchAliases:V.length?V:void 0}:Ee)},Me={...c,customComponentLinks:we};x(Me),t(Me)},[c,t]),ie=g.useCallback((v,$)=>{var Me;const V=((Me=c.customComponentLinks)==null?void 0:Me[v])||[],de={...c.customComponentLinks,[v]:V.filter(Fe=>Fe.key!==$)},we={...c,customComponentLinks:de};x(we),t(we)},[c,t]),ge=g.useCallback(()=>{const v={id:`${Date.now()}-${Math.random().toString(36).slice(2,8)}`,name:"",role:""},$={...c,teamMembers:[...c.teamMembers||[],v]};x($),t($)},[c,t]),be=g.useCallback((v,$,V)=>{const de={...c,teamMembers:(c.teamMembers||[]).map(we=>we.id===v?{...we,[$]:V}:we)};x(de),t(de)},[c,t]),ye=g.useCallback(v=>{const $={...c,teamMembers:(c.teamMembers||[]).filter(V=>V.id!==v)};x($),t($),m===v&&f("")},[c,t,m,f]),se=c.coreLinks&&c.coreLinks.length>0?c.coreLinks:Va,De=g.useCallback(()=>{const v={key:`core-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,label:"",url:"",type:"core"},$={...c,coreLinks:[...se,v]};x($),t($)},[c,se,t]),$e=g.useCallback((v,$,V)=>{const de={...c,coreLinks:se.map(we=>we.key===v?{...we,[$]:V}:we)};x(de),t(de)},[c,se,t]),ze=g.useCallback((v,$)=>{const V={...c,coreLinks:se.map(de=>de.key===v?{...de,matchAliases:$.length?$:void 0}:de)};x(V),t(V)},[c,se,t]),Be=g.useCallback(v=>{const $={...c,coreLinks:se.filter(V=>V.key!==v)};x($),t($)},[c,se,t]),Ie=c.toolLinks||[],cn=g.useCallback(()=>{const v="highlight-builder",$={key:`tool-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,tool:v,matchText:bt[v].matchText},V={...c,toolLinks:[...Ie,$]};x(V),t(V)},[c,Ie,t]),Je=g.useCallback((v,$)=>{const V={...c,toolLinks:Ie.map(de=>de.key===v?{...de,tool:$,matchText:bt[$].matchText}:de)};x(V),t(V)},[c,Ie,t]),dn=g.useCallback((v,$)=>{const V={...c,toolLinks:Ie.map(de=>de.key===v?{...de,matchText:$}:de)};x(V),t(V)},[c,Ie,t]),en=g.useCallback(v=>{const $={...c,toolLinks:Ie.filter(V=>V.key!==v)};x($),t($)},[c,Ie,t]),R=g.useCallback(v=>{const $={...c,externalLinksInitiated:v};x($),t($)},[c,t]),ae=g.useCallback(()=>{const v={schemaVersion:"cst-v1",exportedAt:new Date().toISOString(),orgProfile:c},$=`cst-personalisation-${c.trustName?Nr(c.trustName):"export"}.json`;tt($,JSON.stringify(v,null,2),"application/json")},[c]),X=g.useCallback(()=>{var v;(v=p.current)==null||v.click()},[]),he=g.useCallback(async v=>{var V;const $=(V=v.target.files)==null?void 0:V[0];if(v.target.value="",!!$)try{const de=await $.text(),we=JSON.parse(de);if(!we.orgProfile||typeof we.orgProfile!="object"){window.alert("This file does not contain Project Profile data.");return}const Me=Ct(we.orgProfile),Fe=ma(Me);if(!window.confirm("Import this Project Profile file? This replaces your current organisation profile, pathway/timeline, toolkit links, further reading, core links and team members."+(Fe.errors.length?`

Note: the imported data has ${Fe.errors.length} validation warning(s) you can fix after importing.`:"")))return;x(Me),t(Me)}catch{window.alert("Unable to read this file. Please choose a valid Project Profile export.")}},[t]);return e.jsxs("div",{className:"max-w-4xl mx-auto space-y-6",children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("h2",{className:`text-2xl font-bold ${o?"text-slate-100":"text-slate-800"}`,children:"Project Profile"}),e.jsx(yn,{onClick:I.reopen,darkMode:o})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("button",{type:"button",onClick:X,className:Ge,children:"Import Setup"}),e.jsx("input",{ref:p,type:"file",accept:"application/json",className:"hidden",onChange:he}),e.jsx("button",{type:"button",onClick:ae,className:Ge,children:"Export Setup"}),e.jsx("button",{type:"button",onClick:i,className:Ge,"data-testid":"cst-show-intro-button",children:"Go to Introduction"}),e.jsx("button",{type:"button",onClick:l,disabled:!c.trustName.trim(),title:c.trustName.trim()?void 0:"Add a trust name below first so the rest of the tool unlocks",className:`${Bn} disabled:cursor-not-allowed disabled:opacity-50`,"data-testid":"cst-continue-to-vision-button",children:"Continue to Vision →"})]})]}),e.jsx("p",{className:`text-sm -mt-4 ${o?"text-slate-300":"text-slate-600"}`,children:"This is the Context Specific Template (CST) for your programme: who it belongs to, which of the three pathways it follows, and how it's tracking against its readiness phases."}),e.jsxs("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-lg shadow-sm border p-6 space-y-6`,children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx("h3",{className:`text-lg font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Step 1: Organisation profile"}),e.jsx("p",{className:`text-sm ${o?"text-slate-300":"text-slate-600"}`,children:"Provide some initial details to the project name, and change manager"})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"org-trust-name",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Organisation Name"}),e.jsx("input",{id:"org-trust-name",type:"text","data-testid":"cst-trust-name-input",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 ${o?"border-slate-600 bg-slate-900 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.trustName,onChange:v=>k(v.target.value),"aria-invalid":!!j("trustName"),"aria-describedby":j("trustName")?"org-trust-name-error":void 0}),j("trustName")?e.jsx("p",{id:"org-trust-name-error",className:`mt-1 text-xs ${o?"text-amber-300":"text-red-700"}`,children:j("trustName")}):null]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"org-project-name",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Programme / Project Name"}),e.jsx("input",{id:"org-project-name",type:"text",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 ${o?"border-slate-600 bg-slate-900 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.projectName||"",onChange:v=>y(v.target.value)})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"org-lead-name",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Lead Submitter (Change Lead)"}),e.jsx("input",{id:"org-lead-name",type:"text",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 ${o?"border-slate-600 bg-slate-900 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.leadName||"",onChange:v=>Z(v.target.value)})]})]}),e.jsxs("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-lg shadow-sm border p-6 space-y-6`,children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx("h3",{className:`text-lg font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Step 2: Pathway and timeline"}),e.jsx("p",{className:`text-sm ${o?"text-slate-300":"text-slate-600"}`,children:"Choose the full pathway title for your programme, then set key timeline dates."})]}),e.jsx("div",{className:"mt-3",children:e.jsxs("div",{children:[e.jsx("label",{htmlFor:"cst-pathway",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Pathway"}),e.jsx("select",{id:"cst-pathway",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 pr-10 ${o?"border-slate-600 bg-slate-800 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.cst.pathway,onChange:v=>te(v.target.value),"aria-invalid":!!j("cst.pathway"),"aria-describedby":j("cst.pathway")?"cst-pathway-error":void 0,children:Vn.map(v=>e.jsx("option",{value:v.value,children:v.label},v.value))}),j("cst.pathway")?e.jsx("p",{id:"cst-pathway-error",className:`mt-1 text-xs ${o?"text-amber-300":"text-red-700"}`,children:j("cst.pathway")}):null]})}),e.jsx(wr,{pathway:c.cst.pathway,darkMode:o}),e.jsxs("div",{className:"mt-3 grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"cst-go-live",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Go Live Date (required)"}),e.jsx("input",{id:"cst-go-live",type:"date",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 ${o?"border-slate-600 bg-slate-800 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.cst.goLiveDate,onChange:v=>G("goLiveDate",v.target.value),"aria-invalid":!!j("cst.goLiveDate"),"aria-describedby":j("cst.goLiveDate")?"cst-go-live-error":void 0}),j("cst.goLiveDate")?e.jsx("p",{id:"cst-go-live-error",className:`mt-1 text-xs ${o?"text-amber-300":"text-red-700"}`,children:j("cst.goLiveDate")}):null]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"cst-full-adoption",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Full Adoption Date (optional)"}),e.jsx("input",{id:"cst-full-adoption",type:"date",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 ${o?"border-slate-600 bg-slate-800 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.cst.fullAdoptionDate,onChange:v=>G("fullAdoptionDate",v.target.value),"aria-invalid":!!j("cst.fullAdoptionDate"),"aria-describedby":j("cst.fullAdoptionDate")?"cst-full-adoption-error":void 0}),j("cst.fullAdoptionDate")?e.jsx("p",{id:"cst-full-adoption-error",className:`mt-1 text-xs ${o?"text-amber-300":"text-red-700"}`,children:j("cst.fullAdoptionDate")}):null]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"cst-benefit",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Benefit Realisation Date (optional)"}),e.jsx("input",{id:"cst-benefit",type:"date",className:`w-full rounded-md border shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2 focus-visible:border-[#005eb8] sm:text-sm p-2 ${o?"border-slate-600 bg-slate-800 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,value:c.cst.benefitRealizationDate,onChange:v=>G("benefitRealizationDate",v.target.value),"aria-invalid":!!j("cst.benefitRealizationDate"),"aria-describedby":j("cst.benefitRealizationDate")?"cst-benefit-error":void 0}),j("cst.benefitRealizationDate")?e.jsx("p",{id:"cst-benefit-error",className:`mt-1 text-xs ${o?"text-amber-300":"text-red-700"}`,children:j("cst.benefitRealizationDate")}):null]})]}),H.errors.filter(v=>v.field.startsWith("cst.")).length>0?e.jsxs("div",{className:`mt-4 rounded-md border p-3 ${o?"border-amber-500/40 bg-amber-500/10":"border-amber-300 bg-amber-50"}`,children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${o?"text-amber-200":"text-amber-800"}`,children:"CST validation warnings"}),e.jsx("ul",{className:`mt-2 space-y-1 text-sm ${o?"text-amber-100":"text-amber-900"}`,children:H.errors.filter(v=>v.field.startsWith("cst.")).map(v=>e.jsxs("li",{children:["- ",v.message]},v.field+v.message))})]}):null]}),e.jsxs("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-lg shadow-sm border p-6 space-y-4`,children:[e.jsxs("div",{children:[e.jsx("h3",{className:`text-lg font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Step 3: Team Members"}),e.jsx("p",{className:`text-sm mt-1 ${o?"text-slate-300":"text-slate-600"}`,children:"Add the people working on this programme so actions and readiness slides can be assigned to a named owner. This roster is saved with the CST; who you're signed in as is remembered on this device only."})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"cst-current-user",className:`block text-sm font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"You are signed in as"}),e.jsxs("select",{id:"cst-current-user",value:m||"",onChange:v=>f(v.target.value),className:`w-full rounded-md border shadow-sm sm:text-sm p-2 pr-10 md:w-1/2 ${o?"border-slate-600 bg-slate-900 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,children:[e.jsx("option",{value:"",children:"Not selected"}),(c.teamMembers||[]).map(v=>e.jsxs("option",{value:v.id,children:[v.name||"Unnamed",v.role?` - ${v.role}`:""]},v.id))]})]}),e.jsxs("div",{className:"space-y-2",children:[(c.teamMembers||[]).map(v=>e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-[1fr,1fr,auto] gap-2 items-center",children:[e.jsx("input",{value:v.name,onChange:$=>be(v.id,"name",$.target.value),placeholder:"Name",className:`rounded-md border shadow-sm sm:text-sm p-2 ${o?"border-slate-600 bg-slate-900 text-slate-100":"border-[#768692] bg-white text-slate-900"}`}),e.jsx("input",{value:v.role,onChange:$=>be(v.id,"role",$.target.value),placeholder:"Role (e.g. Change Lead)",className:`rounded-md border shadow-sm sm:text-sm p-2 ${o?"border-slate-600 bg-slate-900 text-slate-100":"border-[#768692] bg-white text-slate-900"}`}),e.jsx("button",{type:"button",onClick:()=>ye(v.id),className:"shrink-0 rounded-md border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-700 hover:bg-red-100",children:"Remove"})]},v.id)),(c.teamMembers||[]).length?null:e.jsx("p",{className:`text-sm ${o?"text-slate-400":"text-slate-500"}`,children:"No team members added yet."})]}),e.jsx("button",{type:"button",onClick:ge,className:Ge,children:"+ Add Team Member"})]}),e.jsxs("div",{className:`flex flex-wrap items-center justify-between gap-3 rounded-lg border p-5 ${o?"border-blue-500/30 bg-blue-500/10":"border-blue-200 bg-blue-50"}`,children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-sm font-semibold ${o?"text-blue-100":"text-blue-900"}`,children:"What phase are you currently in?"}),e.jsx("p",{className:`mt-1 text-xs ${o?"text-blue-200":"text-blue-800"}`,children:"Answer a few quick questions and see your readiness by component to figure out where you really are in the change journey."})]}),e.jsx("button",{type:"button",onClick:r,className:Bn,children:"Where am I now?"})]}),e.jsx("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-lg shadow-sm border p-6 space-y-4`,children:e.jsxs("div",{children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsx("h3",{className:`text-lg font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Step 4: External links"}),e.jsxs("label",{className:`flex items-center gap-2 text-xs font-medium ${o?"text-slate-300":"text-slate-600"}`,children:[e.jsx("input",{type:"checkbox",checked:!!c.externalLinksInitiated,onChange:v=>R(v.target.checked)}),"Links initiated"]})]}),e.jsx("p",{className:`mt-2 text-sm ${o?"text-slate-300":"text-slate-600"}`,children:`This is normally only set up once at the start of a project. Once you're done, tick "Links initiated" to hide this section - re-enable "Show external links section" in Settings if you need to come back to it.`}),!c.externalLinksInitiated||d?e.jsxs(e.Fragment,{children:[e.jsx("p",{className:`mt-2 text-sm ${o?"text-slate-300":"text-slate-600"}`,children:"All toolkit links across the tool point to the NHS Future platform by default. You can override the base toolkit destination for your organisation, or change individual links independently."}),e.jsxs("div",{className:`mt-3 rounded-md border p-3 text-xs ${o?"border-blue-500/30 bg-blue-500/10 text-blue-100":"border-blue-200 bg-blue-50 text-blue-900"}`,children:[e.jsx("p",{className:"font-semibold",children:"Fallback reference"}),e.jsxs("p",{className:"mt-1",children:["Project Specific Homepage:"," ",e.jsx("span",{className:"font-medium",children:Tn.label})," (",Tn.url,")"]}),e.jsx("p",{className:"mt-1",children:"Default Toolkit Link: the original NHS Future link defined per guidance item."})]}),e.jsxs("div",{className:`mt-4 rounded-md border p-4 ${o?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsx("label",{htmlFor:"cst-toolkit-choice",className:`block text-xs font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Default toolkit for assistant preview"}),e.jsx("select",{id:"cst-toolkit-choice",value:c.cst.toolkitChoice,onChange:v=>Ne(v.target.value),className:`w-full rounded-md border shadow-sm sm:text-sm p-2 pr-10 ${o?"border-slate-600 bg-slate-800 text-slate-100":"border-[#768692] bg-white text-slate-900"}`,children:Gi.map(v=>e.jsx("option",{value:v.key,children:v.label},v.key))}),e.jsx("p",{className:`mt-2 text-xs ${o?"text-slate-300":"text-slate-500"}`,children:"This controls which toolkit the chatbot-style assistant opens by default across the tool."})]}),e.jsxs("div",{className:`mt-4 rounded-md border p-4 space-y-3 ${o?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-sm font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Project Specific Homepage"}),e.jsx("p",{className:`text-xs mt-0.5 ${o?"text-slate-300":"text-slate-500"}`,children:"Replaces the Change Management Toolkit destination for all links that fall back to it."}),e.jsxs("p",{className:"mt-1 text-xs",children:["Currently:"," ",e.jsx("a",{href:((Ae=(ke=(xe=c.linkOverrides)==null?void 0:xe.base)==null?void 0:ke.url)==null?void 0:Ae.trim())||Tn.url,target:"_blank",rel:"noopener noreferrer",className:`underline ${o?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-[#00417a]"}`,children:((E=(D=(S=c.linkOverrides)==null?void 0:S.base)==null?void 0:D.url)==null?void 0:E.trim())||Tn.url})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:`block text-xs font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Toolkit name"}),e.jsx("input",{type:"text",placeholder:Tn.label,value:((U=(A=c.linkOverrides)==null?void 0:A.base)==null?void 0:U.label)??"",onChange:v=>{var $;return Ce({...c.linkOverrides,base:{...($=c.linkOverrides)==null?void 0:$.base,label:v.target.value||void 0}})},className:`w-full rounded-md border shadow-sm sm:text-sm p-2 ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`})]}),e.jsxs("div",{children:[e.jsx("label",{className:`block text-xs font-medium mb-1 ${o?"text-slate-200":"text-slate-700"}`,children:"Toolkit URL"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"url",placeholder:Tn.url,value:((ne=(W=c.linkOverrides)==null?void 0:W.base)==null?void 0:ne.url)??"",onChange:v=>{var $;return Ce({...c.linkOverrides,base:{...($=c.linkOverrides)==null?void 0:$.base,url:v.target.value||void 0}})},className:`flex-1 min-w-0 rounded-md border shadow-sm sm:text-sm p-2 ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),((Se=(oe=c.linkOverrides)==null?void 0:oe.base)==null?void 0:Se.url)&&e.jsx("button",{type:"button",onClick:()=>{var v;return Ce({...c.linkOverrides,base:{...(v=c.linkOverrides)==null?void 0:v.base,url:void 0}})},className:`shrink-0 rounded-md border px-3 py-2 text-xs font-medium ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"Reset"})]})]})]})]}),e.jsxs("div",{className:`mt-4 rounded-md border p-4 space-y-3 ${o?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-sm font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Additional Links"}),e.jsx("p",{className:`text-xs mt-0.5 ${o?"text-slate-300":"text-slate-500"}`,children:"General reference links that aren't tied to a single component - shown here and matched into action/summary text across every component."})]}),e.jsx("div",{className:"space-y-2",children:se.map(v=>e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-[1fr,2fr,auto,auto] gap-2 items-center",children:[e.jsx("input",{type:"text",placeholder:"Link name",value:v.label,onChange:$=>$e(v.key,"label",$.target.value),className:`rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),e.jsx("input",{type:"url",placeholder:"https://...",value:v.url,onChange:$=>$e(v.key,"url",$.target.value),className:`rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),e.jsx("button",{type:"button",onClick:()=>O({link:v}),"aria-label":`Edit match text for ${v.label||"this core link"}`,className:`shrink-0 rounded border px-1.5 py-1.5 text-xs ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-100"}`,children:"✎"}),e.jsx("button",{type:"button",onClick:()=>Be(v.key),className:`shrink-0 rounded border px-2 py-1.5 text-xs font-medium ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"Remove"})]},v.key))}),e.jsx("button",{type:"button",onClick:De,className:Ge,children:"+ Add Core Link"})]}),e.jsxs("div",{className:`mt-4 rounded-md border p-4 space-y-3 ${o?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-sm font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Tool linking"}),e.jsx("p",{className:`text-xs mt-0.5 ${o?"text-slate-300":"text-slate-500"}`,children:"Matches text in action/summary bodies and turns it into a button that opens an in-app tool, instead of a link to a URL."})]}),e.jsx("div",{className:"space-y-2",children:Ie.map(v=>e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-[1fr,2fr,auto] gap-2 items-center",children:[e.jsx("select",{value:v.tool,onChange:$=>Je(v.key,$.target.value),className:`rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-800 text-slate-100":"border-slate-300 bg-white text-slate-900"}`,children:Ba.map($=>e.jsx("option",{value:$,children:bt[$].label},$))}),e.jsx("input",{type:"text",placeholder:"Matched text",value:v.matchText,onChange:$=>dn(v.key,$.target.value),className:`rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),e.jsx("button",{type:"button",onClick:()=>en(v.key),className:`shrink-0 rounded border px-2 py-1.5 text-xs font-medium ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"Remove"})]},v.key))}),e.jsx("button",{type:"button",onClick:cn,className:Ge,children:"+ Add Tool Link"})]}),e.jsxs("div",{className:"mt-4 space-y-3",children:[e.jsx("p",{className:`text-sm font-semibold ${o?"text-slate-100":"text-slate-800"}`,children:"Component links"}),e.jsxs("p",{className:`text-xs ${o?"text-slate-300":"text-slate-500"}`,children:[`Set the "Further Reading" link shown on each component's overview panel, and override any of its individual guidance links. Each link shows whether it currently points at the `,e.jsx("strong",{children:"Default Toolkit Link"})," (the original NHS Future link), ",e.jsx("strong",{children:"Project Specific Homepage"})," (your organisation's override above), or a ",e.jsx("strong",{children:"Custom"})," URL you've set - click the pencil to change it. Additional links can be hidden from Settings if you only want the essentials."]}),s.map(v=>{var Me,Fe,Ee;const $=jr(v.id),V=[...$.inputs,...$.deliverables],de=V.filter(je=>{var nn,Ue,on,tn;return(tn=(on=(Ue=(nn=c.linkOverrides)==null?void 0:nn.links)==null?void 0:Ue[je.key])==null?void 0:on.url)==null?void 0:tn.trim()}).length,we=!!((Me=c.componentFurtherReading)!=null&&Me[v.id]);return e.jsxs("details",{className:`group overflow-hidden rounded-md border ${o?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("summary",{className:`flex cursor-pointer list-none items-center justify-between gap-3 p-3 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-[#ffeb3b] ${o?"bg-slate-800 text-slate-200 hover:bg-slate-700":"bg-slate-50 text-slate-700 hover:bg-blue-50"} [&::-webkit-details-marker]:hidden`,children:[e.jsxs("span",{className:"flex min-w-0 items-center gap-2",children:[e.jsx("span",{"aria-hidden":"true",className:`shrink-0 text-lg font-bold leading-none transition-transform group-open:rotate-45 ${o?"text-blue-300":"text-[#005eb8]"}`,children:"+"}),e.jsx("span",{className:"truncate",children:v.label})]}),e.jsxs("span",{className:"flex items-center gap-2",children:[we&&e.jsx("span",{className:`rounded-full px-2 py-0.5 text-xs font-semibold ${o?"bg-emerald-500/20 text-emerald-300":"bg-emerald-100 text-emerald-700"}`,children:"Further reading set"}),de>0&&e.jsxs("span",{className:`rounded-full px-2 py-0.5 text-xs font-semibold ${o?"bg-blue-500/20 text-blue-300":"bg-blue-100 text-blue-700"}`,children:[de," override",de!==1?"s":""]})]})]}),e.jsxs("div",{className:`border-t divide-y ${o?"border-slate-700 divide-slate-700":"border-slate-200 divide-slate-100"}`,children:[e.jsxs("div",{className:"p-3 space-y-1.5",children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${o?"text-slate-400":"text-slate-500"}`,children:"Further reading"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"url",placeholder:"https://...",value:((Fe=c.componentFurtherReading)==null?void 0:Fe[v.id])??"",onChange:je=>Te(v.id,je.target.value),className:`flex-1 min-w-0 rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-900 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),we&&e.jsx("button",{type:"button",onClick:()=>Te(v.id,""),className:`shrink-0 rounded border px-2 py-1.5 text-xs font-medium ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"Clear"})]})]}),!V.length&&e.jsx("p",{className:`p-3 text-xs ${o?"text-slate-500":"text-slate-400"}`,children:"No default guidance links for this component - add one below."}),["inputs","deliverables"].map(je=>{const nn=$[je]??[];return nn.length?e.jsxs("div",{className:"p-3 space-y-2",children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${o?"text-slate-400":"text-slate-500"}`,children:je}),nn.map(Ue=>{var Un,_n;const on=(_n=(Un=c.linkOverrides)==null?void 0:Un.links)==null?void 0:_n[Ue.key],tn=os(Ue,c.linkOverrides),wn=si(on),Gn={default:o?"border-amber-500/40 bg-amber-500/15 text-amber-200":"bg-amber-50 border-amber-200 text-amber-800",custom:o?"border-green-500/40 bg-green-500/15 text-green-200":"bg-green-50 border-green-200 text-green-800",base:o?"border-red-500/30 bg-red-500/10 text-red-200":"bg-red-50 border-red-100 text-red-700"},Fn={default:"Default Toolkit Link",custom:"Custom",base:"Project Specific Homepage"};return e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsxs("span",{className:`text-xs font-medium ${o?"text-slate-300":"text-slate-700"}`,children:[Ue.type!=="core"?"(Optional) ":"",Ue.label]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("a",{href:tn.url,target:"_blank",rel:"noopener noreferrer",title:tn.url,className:`rounded-full border px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide ${Gn[wn]}`,children:Fn[wn]}),e.jsx("button",{type:"button",onClick:()=>w(Ue),"aria-label":`Edit ${Ue.label} link`,className:`shrink-0 rounded-md border px-1.5 py-0.5 text-xs ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-100"}`,children:"✎"})]})]},Ue.key)})]},je):null}),e.jsxs("div",{className:"p-3 space-y-2",children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${o?"text-slate-400":"text-slate-500"}`,children:"Custom links"}),(((Ee=c.customComponentLinks)==null?void 0:Ee[v.id])||[]).map(je=>e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-[1fr,2fr,auto,auto] gap-2 items-center",children:[e.jsx("input",{type:"text",placeholder:"Link name",value:je.label,onChange:nn=>B(v.id,je.key,"label",nn.target.value),className:`rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),e.jsx("input",{type:"url",placeholder:"https://...",value:je.url,onChange:nn=>B(v.id,je.key,"url",nn.target.value),className:`rounded border px-2 py-1.5 text-xs ${o?"border-slate-600 bg-slate-800 text-slate-100 placeholder-slate-500":"border-slate-300 bg-white text-slate-900 placeholder-slate-400"}`}),e.jsx("button",{type:"button",onClick:()=>O({link:je,componentId:v.id}),"aria-label":`Edit match text for ${je.label||"this link"}`,className:`shrink-0 rounded border px-1.5 py-1.5 text-xs ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-100"}`,children:"✎"}),e.jsx("button",{type:"button",onClick:()=>ie(v.id,je.key),className:`shrink-0 rounded border px-2 py-1.5 text-xs font-medium ${o?"border-slate-600 text-slate-300 hover:bg-slate-700":"border-slate-300 text-slate-600 hover:bg-slate-50"}`,children:"Remove"})]},je.key)),e.jsx("button",{type:"button",onClick:()=>Ke(v.id),className:Ge,children:"+ Add Link"})]})]})]},v.id)})]})]}):e.jsx("p",{className:`mt-2 text-sm ${o?"text-slate-300":"text-slate-600"}`,children:'External links were set up at project start. Turn on "Show external links section" in Settings if you need to come back and edit them.'})]})}),b&&e.jsx(kr,{link:b,perLink:(Xe=(ve=c.linkOverrides)==null?void 0:ve.links)==null?void 0:Xe[b.key],baseOverrideUrl:(Cn=(un=c.linkOverrides)==null?void 0:un.base)==null?void 0:Cn.url,onSave:v=>{var V;const $={...(V=c.linkOverrides)==null?void 0:V.links};v?$[b.key]=v:delete $[b.key],Ce({...c.linkOverrides,links:$}),w(null)},onClose:()=>w(null),darkMode:o}),P&&e.jsx(Cr,{title:P.link.label||"Link",aliases:P.link.matchAliases||[],onSave:v=>{P.componentId?le(P.componentId,P.link.key,v):ze(P.link.key,v),O(null)},onClose:()=>O(null),darkMode:o}),L&&e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/45 p-4",children:e.jsxs("div",{className:`${o?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} w-full max-w-lg rounded-xl border p-6 shadow-2xl`,children:[e.jsxs("h3",{className:`text-lg font-semibold ${o?"text-slate-100":"text-slate-900"}`,children:["Change pathway to ",Da[L],"?"]}),e.jsx("div",{className:`mt-3 space-y-2 text-sm ${o?"text-slate-300":"text-slate-600"}`,children:L==="pathway-1"?e.jsx("p",{children:"This will regenerate every component's outcomes and actions for Pathway 1. Any items you've added yourself are kept."}):e.jsx("p",{children:"Pathway 2 and Pathway 3 don't have their own outcomes and actions written yet, so this will clear the Pathway 1 stand-in content instead of leaving it in place - components will show an honest empty state until pathway-specific content is added. Any items you've added yourself are kept."})}),e.jsxs("div",{className:"mt-5 flex justify-end gap-2",children:[e.jsx("button",{type:"button",onClick:_,className:Ge,children:"Cancel"}),e.jsx("button",{type:"button",onClick:re,className:"inline-flex items-center justify-center rounded-md bg-[#005eb8] px-4 py-2 text-sm font-semibold text-white shadow-[0_3px_0_#003087] hover:bg-[#00417a] transition-colors focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b] focus-visible:ring-offset-2",children:"Confirm change"})]})]})}),e.jsx(vn,{open:I.isOpen,onClose:I.close,title:"Project Profile",darkMode:o,body:e.jsx("p",{children:"This is the Context Specific Template (CST) for your programme: who it belongs to, which of the three pathways it follows, and how it's tracking against its readiness phases. You can export or import just this page's data, and manage the external links shown throughout the tool."})})]})}function Ir({steps:n,onComponentClick:t,onActionView:s,colorAccessibilityMode:a="standard",darkMode:i=!1}){const[l,r]=g.useState({}),o=a==="color-blind-friendly"?so:Fa;return e.jsxs("div",{className:`${i?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} rounded-lg shadow-sm p-6 border`,children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:`text-lg font-semibold ${i?"text-slate-100":"text-slate-800"}`,children:"What To Do Next"}),e.jsx("span",{className:`text-xs ${i?"text-slate-400":"text-slate-500"}`,children:"Your current phase"})]}),e.jsx("p",{className:`text-sm mb-4 ${i?"text-slate-300":"text-slate-500"}`,children:"Every component in your current phase that still has pending actions, ranked by timeline risk - overdue first."}),n.length>0?e.jsx("div",{className:"space-y-3",children:n.map(m=>{var c;const f=!!l[m.componentId],d=m.outstandingActions.length;return e.jsxs("div",{className:`rounded-md border p-3 ${i?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsxs("button",{type:"button",onClick:()=>t(m.componentId),className:"flex w-full items-center justify-between gap-3 text-left",children:[e.jsx("span",{className:`text-sm font-semibold hover:underline ${i?"text-slate-100":"text-slate-800"}`,children:m.componentLabel}),e.jsx("span",{title:m.bragReason,className:`text-xs font-semibold rounded px-2.5 py-0.5 ${o[m.bragStatus]}`,children:m.bragStatus})]}),e.jsx("p",{className:`text-sm mt-1 ${i?"text-slate-300":"text-slate-600"}`,children:m.summary}),(c=m.toolkitLinks)!=null&&c.length?e.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:m.toolkitLinks.map(x=>e.jsx("a",{href:x.url,target:"_blank",rel:"noopener noreferrer",className:"text-xs font-medium text-[#005eb8] underline",children:x.label},`${m.componentId}-${x.url}`))}):null,d>0&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("button",{type:"button",onClick:()=>r(x=>({...x,[m.componentId]:!x[m.componentId]})),className:`text-xs font-semibold underline ${i?"text-slate-300 hover:text-slate-100":"text-slate-600 hover:text-slate-900"}`,children:[f?"Hide":"Show"," outstanding action",d===1?"":"s"," (",d,")"]}),f&&e.jsx("div",{className:`mt-2 overflow-x-auto rounded-md border ${i?"border-slate-700":"border-slate-200"}`,children:e.jsxs("table",{className:"min-w-full divide-y text-xs",children:[e.jsx("thead",{className:i?"bg-slate-800":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:`px-2 py-1.5 text-left font-semibold uppercase tracking-wide ${i?"text-slate-400":"text-slate-500"}`,children:"Lens"}),e.jsx("th",{className:`px-2 py-1.5 text-left font-semibold uppercase tracking-wide ${i?"text-slate-400":"text-slate-500"}`,children:"Action"}),e.jsx("th",{className:`px-2 py-1.5 text-left font-semibold uppercase tracking-wide ${i?"text-slate-400":"text-slate-500"}`,children:"Owner"}),e.jsx("th",{className:`px-2 py-1.5 text-left font-semibold uppercase tracking-wide ${i?"text-slate-400":"text-slate-500"}`,children:"Status"}),e.jsx("th",{className:`px-2 py-1.5 text-left font-semibold uppercase tracking-wide ${i?"text-slate-400":"text-slate-500"}`,children:"View"})]})}),e.jsx("tbody",{className:`divide-y ${i?"divide-slate-700":"divide-slate-100"}`,children:m.outstandingActions.map(x=>e.jsxs("tr",{children:[e.jsx("td",{className:`px-2 py-1.5 font-medium ${i?"text-slate-200":"text-slate-700"}`,children:x.lens}),e.jsx("td",{className:`px-2 py-1.5 ${i?"text-slate-300":"text-slate-600"}`,children:x.text}),e.jsx("td",{className:`px-2 py-1.5 ${i?"text-slate-300":"text-slate-600"}`,children:x.owner||"Unassigned"}),e.jsx("td",{className:`px-2 py-1.5 ${i?"text-slate-300":"text-slate-600"}`,children:x.status||"-"}),e.jsx("td",{className:"px-2 py-1.5",children:e.jsx("button",{type:"button",onClick:()=>s(m.componentId,x.lens,x.id),className:`font-semibold underline ${i?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-blue-800"}`,children:"View"})})]},x.id))})]})})]})]},m.componentId)})}):e.jsx("p",{className:`text-sm ${i?"text-slate-400":"text-slate-500"}`,children:"Nothing pending for your current phase. Continue tracking actions and maintain evidence quality."})]})}function Ar({components:n,store:t,getEntry:s,onComponentClick:a,darkMode:i=!1}){const[l,r]=g.useState(null),o=n.reduce((f,d)=>(f[d.phase]=f[d.phase]||[],f[d.phase].push(d),f),{}),m=(f,d)=>{const c=`${f}:${d}`;r(x=>x===c?null:c)};return e.jsxs("details",{className:`${i?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} group overflow-hidden rounded-lg border shadow-sm`,children:[e.jsxs("summary",{className:`flex cursor-pointer list-none items-center justify-between gap-4 p-5 text-lg font-semibold focus:outline-none focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-[#ffeb3b] [&::-webkit-details-marker]:hidden ${i?"text-slate-100 hover:bg-slate-700":"text-slate-800 hover:bg-slate-50"}`,children:[e.jsx("span",{children:"Programme Change Hierarchy"}),e.jsx("span",{className:"text-2xl font-normal transition-transform group-open:rotate-45",children:"+"})]}),e.jsxs("div",{className:"border-t border-slate-200 p-6 dark:border-slate-700",children:[e.jsxs("p",{className:`mt-1 mb-4 text-sm ${i?"text-slate-300":"text-slate-500"}`,children:["Your programme has ",n.length," components, each viewed through one or more lenses. A component is a change topic you assess and track. A lens is the perspective used to assess it (e.g. leadership, risk, capability). Click a lens to see its actions, or open the full assessment."]}),e.jsx("div",{className:"space-y-5",children:$a.filter(f=>{var d;return(d=o[f])==null?void 0:d.length}).map(f=>e.jsxs("div",{className:"space-y-3",children:[e.jsxs("h4",{className:`text-sm font-semibold ${i?"text-slate-100":"text-slate-700"}`,children:["Phase ",f,": ",Qe[f]]}),e.jsx("div",{className:"space-y-2",children:o[f].map(d=>{const c=d.lenses.reduce((b,w)=>{const P=s(d.id,w);return{total:b.total+P.actions.length,completed:b.completed+P.actions.filter(O=>O.status==="Completed").length}},{total:0,completed:0}),x=mo(t,d.id,s);return e.jsxs("div",{"data-testid":`cst-component-card-${d.id}`,className:`w-full rounded-md border p-3 ${i?"border-slate-700 bg-slate-900":"border-slate-200"}`,children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-2",children:[e.jsx("span",{className:`font-semibold ${i?"text-slate-100":"text-slate-800"}`,children:d.label}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("span",{className:`text-xs ${i?"text-slate-300":"text-slate-500"}`,children:["Target readiness: ",Jt(d.target)]}),e.jsx("button",{type:"button",onClick:()=>a(d.id),className:`text-xs font-semibold underline ${i?"text-blue-300 hover:text-blue-200":"text-[#005eb8] hover:text-[#00417a]"}`,children:"Open full assessment"})]})]}),e.jsx("div",{className:"mt-2 flex flex-wrap gap-1.5",children:d.lenses.map(b=>{const w=s(d.id,b),P=l===`${d.id}:${b}`;return e.jsxs("button",{type:"button",onClick:()=>m(d.id,b),"aria-expanded":P,className:`text-xs px-2 py-1 rounded-full border transition-colors ${P?i?"border-blue-400 bg-blue-500/25 text-blue-100":"border-blue-400 bg-blue-100 text-blue-900":w.score>=d.target?i?"border-green-500/40 bg-green-500/15 text-green-200 hover:bg-green-500/25":"bg-green-50 border-green-200 text-green-800 hover:bg-green-100":w.score>0?i?"border-amber-500/40 bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-amber-50 border-amber-200 text-amber-800 hover:bg-amber-100":i?"border-slate-600 bg-slate-800 text-slate-300 hover:bg-slate-700":"bg-slate-100 border-slate-200 text-slate-600 hover:bg-slate-200"}`,children:[b,": ",w.score,"/",d.target]},b)})}),e.jsxs("p",{className:`mt-2 text-xs ${i?"text-slate-300":"text-slate-500"}`,children:["Lens actions: ",c.completed,"/",c.total," complete · Outcomes: ",x.completed,"/",x.total," complete"]}),d.lenses.map(b=>{if(!(l===`${d.id}:${b}`))return null;const P=s(d.id,b);return e.jsx("div",{className:`mt-3 overflow-x-auto rounded-md border ${i?"border-slate-700":"border-slate-200"}`,children:P.actions.length?e.jsxs("table",{className:`min-w-full divide-y ${i?"divide-slate-700 bg-slate-800":"divide-slate-200 bg-white"}`,children:[e.jsx("thead",{className:i?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Action"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Status"}),e.jsx("th",{className:"px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider text-slate-500",children:"Owner"})]})}),e.jsx("tbody",{className:`divide-y ${i?"divide-slate-700":"divide-slate-100"}`,children:P.actions.map(O=>e.jsxs("tr",{children:[e.jsx("td",{className:`px-3 py-2 text-sm ${i?"text-slate-100":"text-slate-800"}`,children:O.text||"Untitled action"}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:`inline-flex whitespace-nowrap rounded-full border px-2 py-1 text-xs font-semibold ${An[O.status]}`,children:O.status})}),e.jsx("td",{className:`px-3 py-2 text-sm ${i?"text-slate-300":"text-slate-600"}`,children:O.owner||"Unassigned"})]},O.id))})]}):e.jsx("p",{className:`p-3 text-sm ${i?"text-slate-300":"text-slate-500"}`,children:"No actions yet for this lens."})},`${b}-table`)})]},d.id)})})]},`phase-group-${f}`))})]})]})}const Or=[{phase:1,label:"Pre-Discovery",programmeStage:"Concept",tagline:"Define the change",color:"bg-blue-50",darkColor:"bg-blue-950/45",textColor:"text-blue-700",darkTextColor:"text-blue-100",borderColor:"border-blue-300",darkBorderColor:"border-blue-700",deliverables:[{text:"Change Vision defined and communicated",componentIds:["vision"]},{text:"Compelling case for change developed",componentIds:["case_for_change"],showExternalGuidance:!1}]},{phase:2,label:"Solution Design",programmeStage:"Definition",tagline:"Prepare the change",color:"bg-violet-50",darkColor:"bg-violet-950/45",textColor:"text-violet-700",darkTextColor:"text-violet-100",borderColor:"border-violet-300",darkBorderColor:"border-violet-700",deliverables:[{text:"Change Impact analysed",componentIds:["change_impact"]},{text:"Change Management inputted to Business Case",componentIds:["case_for_change"],showExternalGuidance:!1},{text:"Engagement and Comms Strategy developed",componentIds:["change_network","stakeholder"]}]},{phase:3,label:"Development",programmeStage:"Design & Develop",tagline:"Plan the change",color:"bg-amber-50",darkColor:"bg-amber-950/45",textColor:"text-amber-700",darkTextColor:"text-amber-100",borderColor:"border-amber-300",darkBorderColor:"border-amber-700",deliverables:[{text:"Engagement and Comms Plan developed",componentIds:["stakeholder"]},{text:"Change Management Plan developed",componentIds:["cm_readiness"]}]},{phase:4,label:"Deployment / Go Live",programmeStage:"Implementation",tagline:"Manage implementation of the change",color:"bg-orange-50",darkColor:"bg-orange-950/45",textColor:"text-orange-700",darkTextColor:"text-orange-100",borderColor:"border-orange-300",darkBorderColor:"border-orange-700",deliverables:[{text:"Change Management Plan executed",componentIds:["cm_readiness"]},{text:"Communications delivered and Stakeholders engaged",componentIds:["stakeholder"]},{text:"Future State Processes validated",componentIds:["process_change"]},{text:"Skills gaps addressed",componentIds:["skills_learning"]},{text:"Future State Processes trialled and in use",componentIds:["process_change"]}]},{phase:5,label:"Post-Deployment",programmeStage:"Transition / Close",tagline:"Reinforce and sustain the change",color:"bg-green-50",darkColor:"bg-green-950/45",textColor:"text-green-700",darkTextColor:"text-green-100",borderColor:"border-green-300",darkBorderColor:"border-green-700",deliverables:[{text:"Change adoption evaluated",componentIds:["change_adoption"]},{text:"Business Change refinements actioned",componentIds:["reinforcement"]},{text:"Change sustained",componentIds:["transfer_bau"]}]}];function ii({currentPhase:n,onComponentClick:t,headingsOnly:s=!1,guidanceTarget:a="Default",linkOverrides:i,showAdditionalGuidanceLinks:l=!0,darkMode:r=!1}){const[o,m]=g.useState(n);return g.useEffect(()=>{m(n)},[n]),e.jsxs("section",{className:`rounded-lg border shadow-sm ${r?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:[e.jsxs("div",{className:`border-b px-5 py-4 ${r?"border-slate-700":"border-slate-200"}`,children:[e.jsx("h3",{className:`text-lg font-semibold ${r?"text-slate-100":"text-slate-800"}`,children:"The Five Change Phases"}),e.jsx("p",{className:`mt-1 text-sm ${r?"text-slate-300":"text-slate-500"}`,children:"Select a phase to see the key deliverables expected at that stage."})]}),e.jsx("div",{className:"space-y-3 p-4",children:Or.map(f=>s?e.jsxs("div",{className:`rounded-md border px-4 py-3 ${r?`${f.darkBorderColor} ${f.darkColor}`:`${f.borderColor} ${f.color}`}`,children:[e.jsxs("span",{className:`block text-sm font-semibold ${r?f.darkTextColor:f.textColor}`,children:["Phase ",f.phase,": ",f.label]}),e.jsxs("span",{className:`mt-0.5 block text-xs ${r?"text-slate-300":"text-slate-500"}`,children:[f.tagline," · ",f.programmeStage]})]},f.phase):e.jsxs("details",{open:o===f.phase,onToggle:d=>{d.currentTarget.open?m(f.phase):o===f.phase&&m(0)},className:`group overflow-hidden rounded-md border ${r?f.darkBorderColor:f.borderColor}`,children:[e.jsxs("summary",{className:`flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3 text-left focus:outline-none focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-[#ffeb3b] [&::-webkit-details-marker]:hidden ${r?`${f.darkColor} ${f.darkTextColor} hover:brightness-110`:`${f.color} ${f.textColor} hover:brightness-95`}`,children:[e.jsxs("span",{children:[e.jsxs("span",{className:"block text-sm font-semibold",children:["Phase ",f.phase,": ",f.label]}),e.jsxs("span",{className:`mt-0.5 block text-xs ${r?"text-slate-300":"text-slate-500"}`,children:[f.tagline," · ",f.programmeStage]})]}),e.jsx("span",{className:"text-xl font-bold transition-transform group-open:rotate-45","aria-hidden":"true",children:"+"})]}),e.jsx("div",{className:`border-t p-4 ${r?`${f.darkBorderColor} bg-slate-900`:`${f.borderColor} bg-white`}`,children:e.jsx("ul",{className:"space-y-3",children:f.deliverables.map(d=>{const c=d.componentIds.map(P=>Ht(P)).filter(P=>!!P),x=c.flatMap(P=>yt(a,P.id,"deliverables",i,l).slice(0,1)),b=c.length===1&&x.length===1,w=d.showExternalGuidance!==!1&&b&&x[0].label.trim().toLowerCase()!==c[0].label.trim().toLowerCase();return e.jsxs("li",{className:"flex items-start gap-2 text-sm",children:[e.jsx("span",{className:`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-bold ${r?`${f.darkColor} ${f.darkTextColor}`:`${f.color} ${f.textColor}`}`,children:"✓"}),e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsx("span",{className:r?"text-slate-200":"text-slate-700",children:d.text}),b?e.jsxs("span",{className:"ml-2 inline-flex flex-wrap items-center gap-2 text-xs",children:[e.jsx("button",{type:"button",onClick:()=>t(c[0].id),className:"font-semibold text-[#005eb8] underline underline-offset-2 hover:text-[#003087]",children:c[0].label}),w?e.jsx("a",{href:x[0].url,target:"_blank",rel:"noopener noreferrer",className:"font-medium text-slate-500 underline underline-offset-2 hover:text-[#005eb8]",children:"External guidance ↗"}):null]}):null,b?null:e.jsxs("span",{className:"mt-1 flex flex-wrap gap-x-3 gap-y-1",children:[c.map(P=>e.jsx("span",{className:"inline-flex flex-wrap items-center gap-2 text-xs",children:e.jsx("button",{type:"button",onClick:()=>t(P.id),className:"font-semibold text-[#005eb8] underline underline-offset-2 hover:text-[#003087]",children:P.label})},P.id)),x.map(P=>e.jsx("a",{href:P.url,target:"_blank",rel:"noopener noreferrer",className:"text-xs font-medium text-slate-500 underline underline-offset-2 hover:text-[#005eb8]",children:"External guidance ↗"},P.url))]})]})]},d.text)})})})]},f.phase))})]})}function _r({store:n,components:t,metrics:s,getEntry:a,onComponentClick:i,onActionView:l,guidanceTarget:r="Default",linkOverrides:o,showAdditionalGuidanceLinks:m=!0,phaseFocusMode:f="auto",manualPhaseFocus:d,colorAccessibilityMode:c="standard",darkMode:x=!1}){const b=pn("daily-checkin"),w=f==="manual"&&d?d:s.currentPhase,P=g.useMemo(()=>Ua(t,a,w),[t,a,w]);return e.jsxs("div",{className:"max-w-5xl mx-auto pb-20",children:[e.jsxs("div",{className:"mb-6 flex items-center gap-2",children:[e.jsx("h2",{className:`text-3xl font-bold ${x?"text-slate-100":"text-slate-800"}`,children:"Daily Check-in"}),e.jsx(yn,{onClick:b.reopen,darkMode:x})]}),e.jsx("p",{className:`mb-6 -mt-4 text-sm ${x?"text-slate-300":"text-slate-500"}`,children:"Your daily triage: what's outstanding right now, and where it sits in the wider programme."}),e.jsxs("div",{className:"space-y-8",children:[e.jsx(Ir,{steps:P,onComponentClick:i,onActionView:l,colorAccessibilityMode:c,darkMode:x}),e.jsx(ii,{currentPhase:w,onComponentClick:i,guidanceTarget:r,linkOverrides:o,showAdditionalGuidanceLinks:m,darkMode:x}),e.jsx(Ar,{components:t,store:n,getEntry:a,onComponentClick:i,darkMode:x})]}),e.jsx(vn,{open:b.isOpen,onClose:b.close,title:"Daily Check-in",darkMode:x,body:e.jsx("p",{children:'This is your daily triage page - "What To Do Next" lists every component in your current phase with outstanding actions, ranked by timeline risk, and the Programme Change Hierarchy below gives you the full picture across every phase.'})})]})}function ga(n){if(!n)return[];const t=n.split(/\s+/).filter(Boolean);if(t.length<2)return t;const s=t.slice(0,Math.ceil(t.length/2)).join(" "),a=t.slice(Math.ceil(t.length/2)).join(" ");return[s,a].filter(Boolean)}function oi(n){return n.getContext?n:n.canvas}function rt(){return typeof document>"u"?!1:document.documentElement.dataset.nhsThemeMode==="dark"}function cs(n,t,s,a={}){var o,m;const i=oi(t),l=(m=(o=ln).getChart)==null?void 0:m.call(o,i);l&&l.destroy();const r={type:n,data:s,options:a};return new ln(i,r)}const pa=new WeakMap,ha=new WeakMap;function fa(n,t,s){return(n.$pointLabelHitboxes||[]).find(a=>Math.abs(t-a.x)<=a.halfWidth&&Math.abs(s-a.y)<=a.halfHeight)}function Rr(n,t,s){const a=pa.get(n);a&&n.removeEventListener("click",a);const i=ha.get(n);i&&n.removeEventListener("mousemove",i);const l=o=>{const m=n.getBoundingClientRect(),f=fa(t,o.clientX-m.left,o.clientY-m.top);f&&s(f.index)},r=o=>{const m=n.getBoundingClientRect(),f=fa(t,o.clientX-m.left,o.clientY-m.top);n.style.cursor=f?"pointer":""};n.addEventListener("click",l),n.addEventListener("mousemove",r),pa.set(n,l),ha.set(n,r)}function zn(n,t,s={},a){var w,P,O,p,I,H;ln.defaults.font.family="Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial",ln.defaults.font.size=12,ln.defaults.elements.line.tension=.2,ln.defaults.elements.point.radius=4,ln.defaults.elements.point.hoverRadius=6;const i=rt(),c={maintainAspectRatio:!0,responsive:!0,layout:{padding:56},plugins:{legend:{display:!0,position:"chartArea",align:"start",labels:{padding:5,boxWidth:30,font:{size:13}}},tooltip:{enabled:!0,backgroundColor:i?"rgba(15,23,42,0.98)":"rgba(11,18,32,0.95)",titleColor:"#fff",bodyColor:"#fff"},centerText:""},elements:{line:{borderWidth:3,tension:.2,borderColor:i?"#63b3ff":"#005EB8",backgroundColor:i?"rgba(99,179,255,0.12)":"rgba(0,94,184,0.06)"},point:{radius:4,hoverRadius:6,backgroundColor:i?"rgba(144,205,244,0.95)":"rgba(11,122,184,0.95)"}},scales:{r:{beginAtZero:!0,grid:{color:i?"rgba(226,232,240,0.12)":"rgba(11,18,32,0.06)",lineWidth:1},angleLines:{color:i?"rgba(226,232,240,0.18)":"rgba(11,18,32,0.10)",lineWidth:1},ticks:{display:!1},pointLabels:{display:!1,color:i?"#e2e8f0":"#0b1220",font:{size:12,family:ln.defaults.font.family},padding:10,callback:j=>ga(j).join(`
`)}}}},x={...c,...s,layout:{padding:56,...s.layout||{}},scales:{...c.scales||{},...s.scales||{},r:{...((w=c.scales)==null?void 0:w.r)||{},...((P=s.scales)==null?void 0:P.r)||{},pointLabels:{...((p=(O=c.scales)==null?void 0:O.r)==null?void 0:p.pointLabels)||{},...((H=(I=s.scales)==null?void 0:I.r)==null?void 0:H.pointLabels)||{},display:!1,callback:j=>ga(j).join(`
`)}}}},b=cs("radar",n,t,x);if(a){const j=oi(n);Rr(j,b,a)}return b}function ri(n,t,s={}){const a=rt(),i=a?"#e2e8f0":"#0b1220",l=a?"rgba(226,232,240,0.08)":"rgba(11,18,32,0.04)",r=a?"rgba(226,232,240,0.10)":"rgba(11,18,32,0.06)",o=a?"#63b3ff":"#005EB8";return cs("line",n,t,{...{elements:{line:{borderWidth:2,tension:.2,borderColor:o,backgroundColor:a?"rgba(99,179,255,0.14)":"rgba(0,94,184,0.06)"},point:{radius:3,hoverRadius:5,backgroundColor:o}},scales:{x:{display:!0,grid:{color:l},ticks:{color:i,font:{size:11}}},y:{beginAtZero:!0,grid:{color:r},ticks:{color:i,font:{size:11}}}}},...s})}function Pr(n,t,s={}){const a=rt(),i=a?"#e2e8f0":"#0b1220";return cs("bar",n,t,{...{scales:{x:{display:!0,grid:{color:a?"rgba(226,232,240,0.08)":"rgba(11,18,32,0.04)"},ticks:{color:i,font:{size:11}}},y:{beginAtZero:!0,min:0,max:5,grid:{color:a?"rgba(226,232,240,0.10)":"rgba(11,18,32,0.06)"},ticks:{color:i,font:{size:11},stepSize:1}}}},...s})}function Dr(n){return typeof n.toBase64Image=="function"?n.toBase64Image():""}const $r={id:"radarCenterText",beforeDraw:n=>{var t;try{const s=n.ctx,i=(t=(n.options||{}).plugins)==null?void 0:t.centerText,l=(i==null?void 0:i.text)||i||"";if(!l)return;const r=String(n.config.type||"");if(r!=="radar"&&r!=="doughnut")return;s.save(),s.textAlign="center",s.textBaseline="middle";const o=n.width/2,m=n.height/2;if(r==="doughnut")s.font=(i==null?void 0:i.font)||"bold 20px Inter",s.fillStyle=(i==null?void 0:i.color)||"#005EB8",s.fillText(String(l),o,m-10),i!=null&&i.subText&&(s.font=(i==null?void 0:i.subFont)||"12px Inter",s.fillStyle=(i==null?void 0:i.subColor)||"#6b7280",s.fillText(String(i.subText),o,m+10));else{const f=Math.max(12,Math.round(Math.min(n.width,n.height)*.065)),d=`${f}px ${ln.defaults.font.family}`;s.font=d,s.fillStyle=(i==null?void 0:i.color)||(rt()?"#e2e8f0":"#0b1220");const c=String(l).split(`
`),x=f*1.05,b=(c.length-1)*-x/2;c.forEach((w,P)=>{s.fillText(w,o,m+b+P*x)})}s.restore()}catch{}}},Tr={id:"radarPointLabelText",afterDraw:n=>{var t,s,a,i;try{const l=(t=n.scales)==null?void 0:t.r,r=(s=l==null?void 0:l.options)==null?void 0:s.pointLabels;if(!l||!r||n.config.type!=="radar")return;const o=n.ctx,m=Number(((a=r.font)==null?void 0:a.size)||ln.defaults.font.size||12),f=((i=r.font)==null?void 0:i.family)||ln.defaults.font.family||"Inter, sans-serif",d=r.color||(rt()?"#e2e8f0":"#0b1220"),c=Number(r.padding??14),x=Array.isArray(l._pointLabels)?l._pointLabels:[],b=[];o.save(),o.textAlign="center",o.textBaseline="middle",o.fillStyle=d,o.font=`${m}px ${f}`,x.forEach((w,P)=>{const p=String(w??"").split(`
`).filter(Boolean);if(!p.length)return;const I=l.getPointPosition(P,l.drawingArea+c,0),H=m*1.15,j=(p.length-1)*-H/2,k=Math.max(m,p.length*H),y=m*6,Z=y/2+4,L=n.width-y/2-4,Y=k/2+4,te=n.height-k/2-4,re=Math.min(Math.max(I.x,Z),L),_=Math.min(Math.max(I.y,Y),te);p.forEach((G,Ne)=>{const Ce=_+j+Ne*H;o.fillText(G,re,Ce)}),b.push({index:P,x:re,y:_,halfWidth:y/2,halfHeight:k/2})}),n.$pointLabelHitboxes=b,o.restore()}catch{}}};ln.register($r,Tr);typeof window<"u"&&(window.NHSDigitalAdoption=window.NHSDigitalAdoption||{},window.NHSDigitalAdoption.Charts={createRadarChart:zn,createLineChart:ri,toBase64Image:Dr});const ft=["Pathways","Phases","Components","Vision","Lens","Strat Direct","Readiness","Actions","Overview"],Lr={"pathway-1":"For teams starting from scratch. Nothing has been built yet, so every component starts at Not Started and the guidance walks you through building the foundations - defining a vision, securing sponsorship, and putting the basics of a change plan in place - one readiness level at a time.","pathway-2":"For teams who've already run a successful pilot and now need to scale it up. The guidance and actions are framed around taking what worked in the pilot - the vision, the sponsorship, the early lessons - and rolling it out consistently to new sites and teams, rather than starting from nothing.","pathway-3":"For teams who've already gone live but adoption is patchy or inconsistent across the organisation. The guidance and actions focus on diagnosing where and why adoption is lagging, then delivering targeted fixes to bring lagging areas up to the same standard as the rest."},bn=kt(1)[0]||Jn[0],Ln=bn.lenses,li=kt(2),Br=li.map(n=>Kn(n.id,2,n.target)),Mr=[1,0,1,1],Gr=[4,3,5,4];function Fr(n){const t=n.map(s=>On(s).color);return{labels:li.map(s=>s.label),datasets:[{label:"Notional current",data:n,borderColor:"#005EB8",backgroundColor:"rgba(0, 94, 184, 0.12)",borderWidth:2,pointRadius:4,pointHoverRadius:6,pointBackgroundColor:t,pointBorderColor:t},{label:"Phase 2 expected",data:Br,borderColor:"#94a3b8",backgroundColor:"rgba(148, 163, 184, 0.06)",borderWidth:2,borderDash:[5,5],pointRadius:2,pointHoverRadius:4}]}}function ba({scores:n,darkMode:t}){const s=g.useRef(null);return g.useEffect(()=>{s.current&&zn(s.current,Fr(n),{maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"chartArea",align:"start",labels:{padding:5,boxWidth:30,font:{size:13}}},tooltip:{callbacks:{label:a=>{const i=Number(a.parsed.r??0);return`${a.dataset.label}: ${On(i).label}`}}}},scales:{r:{min:0,max:5,ticks:{display:!1},pointLabels:{display:!0,font:{size:9},padding:18}}}})},[t]),e.jsx("div",{children:e.jsx("div",{style:{height:400},children:e.jsx("canvas",{ref:s,className:"block h-full w-full"})})})}function Ur({activeStep:n,darkMode:t}){const s=["Pathway","Phases","Components",bn.label,"Lens",Ln[0],"Readiness","Actions","Overview"];return e.jsx("div",{className:"flex flex-wrap items-center gap-1.5 text-xs",children:s.map((a,i)=>e.jsxs("span",{className:"flex items-center gap-1.5",children:[e.jsx("span",{className:`rounded-full px-2.5 py-1 font-semibold transition-colors ${i===n?"bg-[#005eb8] text-white":i<n?t?"bg-slate-700 text-slate-200":"bg-blue-50 text-blue-800":t?"bg-slate-900 text-slate-600":"bg-slate-100 text-slate-400"}`,children:a}),i<s.length-1?e.jsx("span",{"aria-hidden":"true",className:t?"text-slate-600":"text-slate-300",children:"→"}):null]},a))})}function Wr({darkMode:n}){const t=[1,2,3,4,5],s=[{border:"border-blue-300",heading:"bg-blue-50 text-blue-700",body:"bg-blue-50/40"},{border:"border-violet-300",heading:"bg-violet-50 text-violet-700",body:"bg-violet-50/40"},{border:"border-amber-300",heading:"bg-amber-50 text-amber-700",body:"bg-amber-50/40"},{border:"border-orange-300",heading:"bg-orange-50 text-orange-700",body:"bg-orange-50/40"},{border:"border-green-300",heading:"bg-green-50 text-green-700",body:"bg-green-50/40"}];return e.jsxs("div",{className:`overflow-hidden rounded-md border ${n?"border-slate-700":"border-slate-200"}`,children:[e.jsxs("div",{className:`grid grid-cols-[minmax(150px,0.7fr),minmax(0,2fr)] text-xs font-bold uppercase tracking-wider ${n?"bg-slate-900 text-slate-300":"bg-slate-100 text-slate-600"}`,children:[e.jsx("div",{className:"border-r px-4 py-3",children:"Phase"}),e.jsx("div",{className:"px-4 py-3",children:"Components"})]}),t.map((a,i)=>{const l=kt(a),r=s[i];return e.jsxs("div",{className:`grid grid-cols-[minmax(150px,0.7fr),minmax(0,2fr)] border-t ${n?"border-slate-700":"border-slate-200"}`,children:[e.jsxs("div",{className:`border-r px-4 py-4 text-sm font-semibold ${n?"bg-slate-900 text-slate-100":`${r.heading} ${r.border}`}`,children:["Phase ",a,": ",Qe[a]||""]}),e.jsx("div",{className:`flex flex-wrap gap-2 px-4 py-4 ${n?"bg-slate-800":r.body}`,children:l.map(o=>e.jsx("span",{className:`rounded-full px-3 py-1 text-xs font-semibold ${n?"bg-slate-900 text-slate-200":"bg-white text-slate-700 shadow-sm"}`,children:o.label},o.id))})]},a)})]})}const Hr=["Assign owner","Set due date","Mark complete"];function Vr({darkMode:n}){const t=`rounded-lg border border-dashed p-4 ${n?"border-slate-700":"border-slate-300"}`,s=`mb-3 text-center text-xs font-bold uppercase tracking-wider ${n?"text-slate-400":"text-slate-500"}`,a="flex flex-wrap items-center justify-center gap-2",i=e.jsx("div",{className:"flex justify-center py-1","aria-hidden":"true",children:e.jsx("span",{className:n?"text-slate-600":"text-slate-300",children:"↓"})}),l=e.jsx("div",{className:"flex justify-center py-1","aria-hidden":"true",children:e.jsx("span",{className:n?"text-slate-600":"text-slate-300",children:"↕"})}),r=`rounded-full border px-3 py-1 text-xs font-semibold ${n?"border-violet-700 bg-violet-950/40 text-violet-100":"border-violet-200 bg-violet-50 text-violet-700"}`,o=`rounded-full border px-3 py-1 text-xs font-semibold ${n?"border-blue-700 bg-blue-950/40 text-blue-100":"border-blue-200 bg-blue-50 text-blue-700"}`,m=`rounded-full border px-3 py-1 text-xs font-semibold ${n?"border-orange-700 bg-orange-950/40 text-orange-100":"border-orange-200 bg-orange-50 text-orange-700"}`,f=`rounded-full border px-3 py-1 text-xs font-semibold ${n?"border-rose-700 bg-rose-950/40 text-rose-100":"border-rose-200 bg-rose-50 text-rose-700"}`,d=`rounded-full border px-3 py-1 text-xs font-semibold ${n?"border-green-700 bg-green-950/40 text-green-100":"border-green-200 bg-green-50 text-green-700"}`;return e.jsxs("div",{className:"space-y-1",children:[e.jsxs("div",{className:t,children:[e.jsx("p",{className:s,children:"Pathways"}),e.jsx("div",{className:a,children:Vn.map(c=>e.jsx("span",{className:r,children:c.simplifiedLabel},c.value))})]}),i,e.jsxs("div",{className:t,children:[e.jsx("p",{className:s,children:"Phases"}),e.jsx("div",{className:a,children:[1,2,3,4,5].map(c=>e.jsx("span",{className:o,children:Qe[c]},c))})]}),i,e.jsxs("div",{className:t,children:[e.jsx("p",{className:s,children:"Components"}),e.jsx("div",{className:a,children:Jn.map(c=>e.jsx("span",{className:m,children:c.label},c.id))})]}),l,e.jsxs("div",{className:t,children:[e.jsx("p",{className:s,children:"Lenses"}),e.jsx("div",{className:a,children:ot.map(c=>e.jsx("span",{className:f,children:c},c))})]}),i,e.jsxs("div",{className:t,children:[e.jsx("p",{className:s,children:"Readiness score"}),e.jsx("div",{className:"flex overflow-hidden rounded-md",children:Mn.map(c=>e.jsx("div",{className:"flex-1 py-2 text-center",style:{backgroundColor:c.color},children:e.jsx("span",{className:`text-[10px] font-semibold ${c.score===2?"text-slate-900":"text-white"}`,children:c.label})},c.score))})]}),i,e.jsxs("div",{className:t,children:[e.jsx("p",{className:s,children:"Actions"}),e.jsx("div",{className:a,children:Hr.map(c=>e.jsx("span",{className:d,children:c},c))})]})]})}function qr({children:n,darkMode:t}){return e.jsx("div",{className:`w-full rounded-xl border shadow-sm ${t?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"}`,children:e.jsx("div",{className:"p-6 sm:p-10",children:n})})}const Yr=["Alex Morgan","Sam Patel"],Kr=[{id:"notional-1",text:`Agree the ${Ln[0]} approach with the SRO`,status:"Planned",owner:""},{id:"notional-2",text:"Document the agreed approach for the team",status:"Planned",owner:""},{id:"notional-3",text:"Share the approach with key stakeholders",status:"Planned",owner:""}];function zr({darkMode:n=!1,onGetStarted:t,onComponentClick:s}){var j;const[a,i]=g.useState("pathway-1"),[l,r]=g.useState(0),[o,m]=g.useState(Kr),[f,d]=g.useState(null),[c,x]=g.useState([]),[b,w]=g.useState(!1),P=(k,y)=>{m(Z=>{const L=Z.map(te=>te.id===k?{...te,...y}:te);return L.every(te=>te.status==="Completed"&&te.owner.trim()!=="")&&!b&&(w(!0),x(te=>[...te,{id:`${Date.now()}-${Math.random().toString(36).slice(2,8)}`,message:`${bn.label} · ${Ln[0]} moved to the next readiness level!`}])),L})};Vn.find(k=>k.value===a)||Vn[0];const O=l===ft.length-1,p=n?"text-slate-300":"text-slate-700",I=()=>r(k=>Math.min(ft.length-1,k+1)),H=()=>r(k=>Math.max(0,k-1));return e.jsxs("div",{className:"w-full space-y-6",children:[e.jsxs("div",{children:[e.jsx("h2",{className:`text-2xl font-bold ${n?"text-slate-100":"text-slate-800"}`,children:"Engine Explained"}),e.jsx("p",{className:`mt-2 max-w-3xl text-sm ${n?"text-slate-300":"text-slate-600"}`,children:"A quick worked example showing how everything fits together, step by step."})]}),l>0?e.jsx(Ur,{activeStep:l,darkMode:n}):null,e.jsxs(qr,{darkMode:n,children:[e.jsxs("p",{className:`text-xs font-semibold uppercase tracking-wider ${n?"text-blue-300":"text-blue-700"}`,children:["Step ",l+1," of ",ft.length," · ",ft[l]]}),l===0?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"Every programme starts with a pathway"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"A pathway describes the current status of your project and will determine the change journey required for successful adoption."}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"The Pathway will tailor the  guidance, actions and resources you will see everywhere else in the tool."}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"In this example walkthrough of the Adoption Engine we'll use pathway 1 - Starting for the First time. You will be able to select the correct pathway when you set up your project later on."}),e.jsx("div",{className:"mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3",children:Vn.map(k=>{const y=k.value===a;return e.jsx("button",{type:"button",onClick:()=>i(k.value),"aria-pressed":y,className:`rounded-lg border p-4 text-left transition-colors ${y?"border-[#005eb8] bg-blue-50 ring-2 ring-[#005eb8]":n?"border-slate-600 bg-slate-900 hover:bg-slate-700":"border-slate-200 bg-white hover:bg-slate-50"}`,children:e.jsx("p",{className:`text-sm font-semibold ${y?"text-[#005eb8]":n?"text-slate-100":"text-slate-900"}`,children:k.simplifiedLabel})},k.value)})}),e.jsxs("div",{className:`mt-4 rounded-md border p-4 text-sm ${n?"border-blue-500/30 bg-blue-500/10 text-blue-100":"border-blue-200 bg-blue-50 text-blue-900"}`,children:[e.jsx("p",{className:"font-semibold",children:(j=Vn.find(k=>k.value===a))==null?void 0:j.simplifiedLabel}),e.jsx("p",{className:"mt-1",children:Lr[a]})]})]}):null,l===1?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"Each pathway is broken into the 5 change phases"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Every Pathway runs through 5 phases which are aligned to a project lifecycle. It starts from the earliest thinking about a change through to it being fully embedded as business as usual."}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"See the 5 Change phases below."}),e.jsx("div",{className:"mt-6",children:e.jsx(ii,{currentPhase:bn.phase,onComponentClick:s,headingsOnly:!0,darkMode:n})}),e.jsx("p",{className:`mt-4 text-sm ${p}`,children:"At each phase there are 'Change Components' that need to be focused on at that particular phase of a project."})]}):null,l===2?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"Change components"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Change Components are the focused topics and change activities that are relevant to each phase."}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"The table below shows which components are included in each phase (these will be clickable when using the adoption engine.)"}),e.jsx("div",{className:"mt-6",children:e.jsx(Wr,{darkMode:n})}),e.jsxs("p",{className:`mt-4 text-sm ${p}`,children:["To continue with the example lets zoom into one of the specific Change Component. Phase ",bn.phase,":"," ",bn.label,"."]})]}):null,l===3?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"A component is a specific area of change to get right"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Each phase is made up of several components - focused topics like Vision, Sponsorship, Capability or Benefits. Each one has its own readiness to build up, and its own actions to get there. Here's the example we're following:"}),e.jsxs("div",{className:`mt-6 rounded-lg border p-5 ${n?"border-slate-700 bg-slate-900":"border-slate-200 bg-white"}`,children:[e.jsx("p",{className:`text-lg font-semibold ${n?"text-slate-100":"text-slate-900"}`,children:bn.label}),e.jsx("p",{className:`mt-2 text-sm ${p}`,children:Wa(bn.id)})]}),e.jsx("p",{className:`mt-4 text-sm ${p}`,children:`But you don't assess a component all at once - you look at it through several different "lenses". Let's see what that means.`})]}):null,l===4?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"A Lens is a different perspective of the same Change Component"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Each Change Component can be looked at through different lenses that show different perspectives. Here are all of the lenses used across the Adoption Engine: not all of them will relate to every Change Component."}),e.jsx("div",{className:"mt-6 grid grid-cols-1 gap-3",children:ot.map(k=>e.jsxs("div",{className:`rounded-lg border p-5 ${n?"border-slate-700 bg-slate-900":"border-slate-200 bg-white"}`,children:[e.jsx("p",{className:`text-lg font-semibold ${n?"text-slate-100":"text-slate-900"}`,children:k}),e.jsx("p",{className:`mt-2 text-sm ${p}`,children:Kt(k)})]},k))}),e.jsx("p",{className:`mt-4 text-sm ${p}`,children:"Let's follow one lens through in detail."})]}):null,l===5?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"An example lens on our example component"}),e.jsxs("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:[bn.label,", can be seen through the ",Ln[0]," lens. As well as the ",Ln[1]," lens."]}),e.jsxs("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:["Both lenses, give a different perspective on the same component. In this example, we will follow the ",Ln[0]," lens through to a readiness score. we're going to score. That's exactly what a readiness score measures - not a whole component at once, but one lens on it."]}),Ln.map((k,y)=>e.jsxs("div",{className:`mt-6 rounded-lg border p-5 ${n?"border-[#005eb8] bg-slate-900":y===0?"border-[#005eb8] bg-blue-50":"border-slate-200 bg-white"}`,children:[e.jsxs("p",{className:`text-lg font-semibold ${n?"text-slate-100":"text-[#005eb8]"}`,children:[bn.label," · ",k]}),e.jsx("p",{className:`mt-2 text-sm ${n?"text-slate-300":"text-blue-900"}`,children:Kt(k)})]})),e.jsx("p",{className:`mt-4 text-sm ${p}`,children:"Now we need to look at scoring each Change Component in Terms of Readiness for Change through each of the relevant lenses."})]}):null,l===6?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"Readiness is scored on a scale from 'Not Started', to 'Thriving' for every lens"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Every lens on every component is scored on the same 0-5 scale, so progress is always comparable. Here's what each level means, and what that looks like on the readiness radar you'll see elsewhere in the tool:"}),e.jsxs("div",{className:"mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3",children:[e.jsx("div",{className:"grid grid-cols-1 gap-2",children:Mn.map(k=>{const[,y]=(wt[k.score]||"").split(/:\s(.+)/);return e.jsxs("div",{className:`rounded-md border p-2.5 ${n?"border-slate-700":""}`,style:{borderLeftWidth:"4px",borderLeftColor:k.color},children:[e.jsx("p",{className:`text-xs font-bold ${n?"text-slate-100":"text-slate-800"}`,children:k.label}),e.jsx("p",{className:`mt-0.5 text-xs ${n?"text-slate-300":"text-slate-600"}`,children:y})]},k.score)})}),e.jsxs("div",{className:`rounded-lg border p-4 ${n?"border-red-500/30 bg-red-500/5":"border-red-200 bg-red-50"}`,children:[e.jsx("p",{className:`text-sm font-bold ${n?"text-red-200":"text-red-800"}`,children:"At risk example"}),e.jsx("p",{className:`mt-1 text-xs ${n?"text-slate-300":"text-slate-600"}`,children:"Notional scores trailing behind where Phase 2 expects these components to be."}),e.jsx("div",{className:"mt-3",children:e.jsx(ba,{scores:Mr,darkMode:n})})]}),e.jsxs("div",{className:`rounded-lg border p-4 ${n?"border-emerald-500/30 bg-emerald-500/5":"border-emerald-200 bg-emerald-50"}`,children:[e.jsx("p",{className:`text-sm font-bold ${n?"text-emerald-200":"text-emerald-800"}`,children:"Excelling example"}),e.jsx("p",{className:`mt-1 text-xs ${n?"text-slate-300":"text-slate-600"}`,children:"Notional scores ahead of where Phase 2 expects these components to be."}),e.jsx("div",{className:"mt-3",children:e.jsx(ba,{scores:Gr,darkMode:n})})]})]})]}):null,l===7?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"Actions"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"To improve readiness for each component through each lens there are a set of suggested actions to be completed. These Actions can be edited or removed or you can add your own actions."}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Actions can be assigned to team members and have completion dates assigned if required. Once the Actions at each readiness level is Completed or Cancelled, that lens automatically moves up to the next readiness level."}),e.jsx("p",{className:`mt-4 text-sm font-semibold ${p}`,children:"Try assigning these actions and then marking them as complete."}),e.jsx("div",{className:`mt-3 overflow-x-auto rounded-md border ${n?"border-slate-700":"border-slate-200"}`,children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200",children:[e.jsx("thead",{className:n?"bg-slate-900":"bg-slate-50",children:e.jsxs("tr",{children:[e.jsx("th",{className:`px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider ${n?"text-slate-400":"text-slate-500"}`,children:"Action"}),e.jsx("th",{className:`px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider ${n?"text-slate-400":"text-slate-500"}`,children:"Owner"}),e.jsx("th",{className:`px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider ${n?"text-slate-400":"text-slate-500"}`,children:"Status"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100",children:o.map(k=>e.jsxs("tr",{children:[e.jsx("td",{className:`px-3 py-2 align-top text-sm ${p}`,children:k.text}),e.jsx("td",{className:"px-3 py-2 align-top",children:f===k.id?e.jsxs("select",{autoFocus:!0,"aria-label":`Owner for ${k.text}`,value:k.owner,onChange:y=>{P(k.id,{owner:y.target.value}),d(null)},onBlur:()=>d(null),className:"rounded-md border border-slate-300 px-2 py-1 text-xs font-semibold",children:[e.jsx("option",{value:"",children:"Unassigned"}),Yr.map(y=>e.jsx("option",{value:y,children:y},y))]}):e.jsx("button",{type:"button",onClick:()=>d(k.id),"aria-label":`Change owner for ${k.text}`,className:"rounded-full focus:outline-none focus-visible:ring-4 focus-visible:ring-[#ffeb3b]",children:e.jsx(za,{name:k.owner,darkMode:n})})}),e.jsx("td",{className:"px-3 py-2 align-top",children:e.jsx("select",{"aria-label":`Status for ${k.text}`,value:k.status,onChange:y=>P(k.id,{status:y.target.value}),className:`rounded-md border px-2 py-1 text-xs font-semibold ${An[k.status]}`,children:ns.map(y=>e.jsx("option",{value:y,children:y},y))})})]},k.id))})]})}),e.jsx("p",{className:`mt-6 text-sm font-semibold ${n?"text-slate-100":"text-slate-900"}`,children:"That's Adoption Engine explained: Pathway → Phase → Component → Lens → Readiness → Actions. Let's see the whole picture before you set up your real project."})]}):null,l===8?e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:`mt-1 text-2xl font-bold ${n?"text-slate-100":"text-slate-900"}`,children:"The whole engine, one page"}),e.jsx("p",{className:`mt-3 max-w-2xl text-sm ${p}`,children:"Every pathway, phase, component, lens and readiness level really used in this tool, laid out top to bottom. Components and lenses connect both ways, since every component is viewed through several lenses."}),e.jsx("div",{className:"mt-6",children:e.jsx(Vr,{darkMode:n})})]}):null,e.jsxs("div",{className:"mt-8 flex items-center justify-between gap-2",children:[e.jsx("button",{type:"button",onClick:H,disabled:l===0,className:`rounded-md border px-4 py-2 text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed ${n?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"}`,children:"Back"}),O?e.jsx("button",{type:"button",onClick:t,disabled:!b,title:b?void 0:"Mark every notional action Completed with an owner assigned to continue",className:"rounded-md bg-[#005eb8] px-5 py-2 text-sm font-semibold text-white shadow-[0_3px_0_#003087] hover:bg-[#00417a] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#005eb8]",children:"Get started"}):e.jsx("button",{type:"button",onClick:I,disabled:l===7&&!b,title:l===7&&!b?"Mark every notional action Completed with an owner assigned to continue":void 0,className:"rounded-md bg-[#005eb8] px-5 py-2 text-sm font-semibold text-white shadow-[0_3px_0_#003087] hover:bg-[#00417a] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#005eb8]",children:"Next"})]})]}),c.length>0?e.jsx(Ka,{message:c[0].message,onDismiss:()=>x(k=>k.slice(1)),celebrate:!0},c[0].id):null]})}const Jr=`Pathway 1 - We are starting $projectName for the first time
Vision
Are you on track?
...
`,Ss={componentId:"org_maturity",actionPrefix:"org-change-readiness-action",outcomePrefix:"org-change-readiness:outcome",fallbackOutcomes:[{id:"org-change-readiness:outcome:o1",text:"Organisational readiness has been assessed and understood"},{id:"org-change-readiness:outcome:o2",text:"Readiness gaps are being actively addressed"},{id:"org-change-readiness:outcome:o3",text:"The organisation is prepared to successfully absorb and sustain the change"}],lensAliases:{"Strategic Direction and Leadership":"Strategic Direction and Leadership","People Experience and Culture":"Skills and Behaviour","Planning and Measurement":"Skills and Behaviour",Design:"Skills and Behaviour",Governance:"Skills and Behaviour","Measurement and Evaluation":"Skills and Behaviour",Reinforcement:"Skills and Behaviour"}},Mc=Ve(Bc,Ss);function Gc(n){return qe(n,Ss,Mc)}function Fc(n){return Ye(n,Ss)}const Uc="pathway-auto-action:",Wc="pathway:auto-objective:",Hc="vision:auto-objective:";function Vc(n){return n.startsWith(Wc)||n.startsWith(Hc)}function qc(n){const t=n.orgProfile.cst.pathway,s={...n.objectives||{}},a=Object.keys(n.currentDraft||{}).reduce((i,l)=>{const r=n.currentDraft[l]||{};return i[l]=Object.keys(r).reduce((o,m)=>{const f=r[m];return o[m]={...f,actions:(f.actions||[]).filter(d=>!d.id.startsWith(Uc))},o},{}),i},{});return Jn.forEach(i=>{ci(i.id,t)&&(s[i.id]=(s[i.id]||[]).filter(r=>!Vc(r.id)))}),{...n,currentDraft:a,objectives:s}}const Yc=`{
  "component": {
    "id": "PROCESS_CHANGE",
    "name": "Process Change"
  },
...
`,vs={componentId:"process_change",actionPrefix:"process-change-action",outcomePrefix:"process-change:outcome",fallbackOutcomes:[{id:"process-change:outcome:o1",text:"Current and future processes have been defined"},{id:"process-change:outcome:o2",text:"Process changes have been implemented and adopted"},{id:"process-change:outcome:o3",text:"Processes are optimised and continuously improved"}],lensAliases:{"Process and Sustainment":"Process and Sustainment","People Experience and Culture":"Skills and Behaviour","Planning and Risk":"Process and Sustainment","Analysis and Insight":"Process and Sustainment",Communication:"Skills and Behaviour","Dependency Management":"Process and Sustainment",Design:"Process and Sustainment",Governance:"Process and Sustainment",Implementation:"Process and Sustainment","Measurement and Evaluation":"Process and Sustainment",Reinforcement:"Skills and Behaviour","Testing and Validation":"Process and Sustainment"}},Kc=Ve(Yc,vs);function zc(n){return qe(n,vs,Kc)}function Jc(n){return Ye(n,vs)}const Xc=`{
  "component": {
    "id": "REINFORCEMENT",
    "name": "Reinforcement"
  },
...
`,Is={componentId:"vision",actionPrefix:"vision-action",outcomePrefix:"vision:outcome",fallbackOutcomes:[{id:"vision:outcome:o1",text:"A compelling future state has been defined"},{id:"vision:outcome:o2",text:"The vision is shared and understood"},{id:"vision:outcome:o3",text:"The vision is visible and guides the change"}]},jd=Ve(Cd,Is);function Ed(n){return qe(n,Is,jd)}function Id(n){return Ye(n,Is)}function kn(n){return qc(Nd(Gc(Zc(zc(fc(kc(ud(sd(Sd(Tc(rd(Rc(Ic(mc(hd(vc(Ed(n))))))))))))))))))}function Ad(n){return kd(Fc(ed(Jc(bc(Cc(md(ad(vd(Lc(ld(Pc(Ac(gc(fd(yc(Id(n)))))))))))))))))}function Od(n,t){return t==="pathway-1"?kn(n):Ad(n)}const Mt="nhs-digital-adoption-user-settings",Gt="nhs-digital-adoption-report-reminder-dismissed",_d="nhs-digital-adoption-engagement",Ft="nhs-digital-adoption-current-user-id",_a="Default",Rd=5*1024*1024,Pd=new Set(["application/json","text/json"]),Dd="Unknown user",$d=["introduction","engine-explained","project-details","profile"],Td={1:"#3b82f6",2:"#8b5cf6",3:"#f59e0b",4:"#f97316",5:"#22c55e"},Ld={red:"test-data/adoption-phase1-red.json",amber:"test-data/adoption-phase2-amber.json",green:"test-data/adoption-phase3-green.json"},Ut={name:"",themeColor:"#005eb8",profileImageDataUrl:"",darkMode:!1,colorAccessibilityMode:"standard",phaseFocusMode:"auto",manualPhaseFocus:1,hideGuidedWorkflow:!1,showAdditionalGuidanceLinks:!0,showExternalLinksSection:!1,showActionPriorityColours:!1};function Bd(n){return{...n,linkedTargets:(n.linkedTargets||[]).map(t=>({componentId:t.componentId,lens:t.lens}))}}function Md(n,t){return`${n}:${t}`}function Ra(n){return n.orgProfile.trustName||n.orgProfile.projectName?!1:!Object.values(n.currentDraft).some(t=>Object.values(t).some(s=>s.score>0))}function Pa(n){return!n.trustName.trim()}function Gd(n){var t;if(!((t=n.evidence)!=null&&t.trim()))return!1;try{const s=JSON.parse(n.evidence);return Array.isArray(s)?s.length>0:!!n.evidence.trim()}catch{return!!n.evidence.trim()}}function Fd(n){return n.trim()||Dd}function Ud(n,t,s){const a=(n.teamMembers||[]).find(i=>i.id===t);return Fd((a==null?void 0:a.name)||s)}function Wd(n,t,s){var i;const a=Xi[n];return((i=a==null?void 0:a[t])==null?void 0:i[s])||wt[s]||wt[0]}function Hd(n=new Date){const t=String(n.getMonth()+1).padStart(2,"0");return`${n.getFullYear()}-${t}`}function Vd(n=new Date){return new Date(n.getFullYear(),n.getMonth()-1,1).toLocaleString("en-GB",{month:"short",year:"numeric"})}function qd(n){const t=new TextEncoder().encode(n);let s="";return t.forEach(a=>{s+=String.fromCharCode(a)}),window.btoa(s)}function Yd(n,t=76){const s=[];for(let a=0;a<n.length;a+=t)s.push(n.slice(a,a+t));return s.join(`\r
`)}function Kd(n=new Date){return n.toLocaleString("en-GB",{month:"short",year:"numeric"})}function au(){var Xn,dt;const n=Jn,t=g.useMemo(()=>[...ot],[]),[s,a]=g.useState(n[0].id),[i,l]=g.useState(!1),[r,o]=g.useState(()=>{let h={};try{const M=Sn(ka);h=us(xt(M))}catch(M){console.warn("Ignoring invalid persisted adoption data.",M)}const C=vt({view:"dashboard",orgProfile:h==null?void 0:h.orgProfile,currentDraft:h==null?void 0:h.currentDraft,objectives:h==null?void 0:h.objectives,suppressedAutoActions:h==null?void 0:h.suppressedAutoActions,auditLog:h==null?void 0:h.auditLog,history:h==null?void 0:h.history,phaseOverrides:h==null?void 0:h.phaseOverrides,pathwayChecks:h==null?void 0:h.pathwayChecks});return C.orgProfile.cstId||(C.orgProfile={...C.orgProfile,cstId:qs()}),kn(C)}),[m,f]=g.useState(()=>Ra(r)?"introduction":"dashboard"),[d,c]=g.useState(""),x=pn("vision-get-started"),[b,w]=g.useState(()=>Sn(Ft)||""),P=$n.useRef(b);g.useEffect(()=>{P.current=b},[b]);const[O,p]=g.useState(null),[I,H]=g.useState(()=>{const h=Sn(Mt);return{...Ut,...h}}),j=$n.useRef(I.name);g.useEffect(()=>{j.current=I.name},[I.name]);const k=$n.useRef(null),y=$n.useRef(null),[Z,L]=g.useState(""),Y=$n.useRef(null),te=g.useMemo(()=>Hd(),[]),[re,_]=g.useState(()=>Sn(Gt)||{}),[G,Ne]=g.useState(!0),[Ce,Te]=g.useState([]),[Ke,B]=g.useState({1:!0}),[le,ie]=g.useState({intro:!0,overview:!0,tools:!0}),[ge,be]=g.useState(null),[ye,se]=g.useState(!0),[De,$e]=g.useState("medium"),ze=$n.useRef({}),Be=g.useMemo(()=>{const h=new Date,C=Vd(h),M=h.getDate()===1;return{previousMonthLabel:C,isFirstDayOfMonth:M,shouldNotify:M}},[r.history]),[Ie,cn]=g.useState("test@test.com"),[Je,dn]=g.useState(""),[en,R]=g.useState(""),ae=Kd(),X=g.useCallback((h,C)=>(r.currentDraft[h]||(r.currentDraft[h]={}),r.currentDraft[h][C]||(r.currentDraft[h][C]=_t()),r.currentDraft[h][C]),[r]),he=I.showAdditionalGuidanceLinks!==!1,xe=g.useMemo(()=>{const h=oo(r,n);return{...h,nextSteps:h.nextSteps.map(C=>({...C,toolkitLinks:yt(_a,C.componentId,"inputs",void 0,he).slice(0,3)}))}},[r,he]),ke=I.phaseFocusMode==="manual"&&I.manualPhaseFocus?I.manualPhaseFocus:xe.currentPhase;g.useEffect(()=>{var C;if(m!=="assessment")return;const h=(C=n.find(M=>M.id===s))==null?void 0:C.phase;h&&B(M=>({...M,[h]:!0}))},[s,m]),g.useEffect(()=>{m==="where-am-i-now"&&l(!0)},[m]),g.useEffect(()=>{const C={introduction:"intro","engine-explained":"intro","project-details":"intro","where-am-i-now":"intro",dashboard:"overview","daily-checkin":"overview","action-plan":"overview","roadmap-view":"overview","highlight-builder":"tools","force-field-analysis":"tools",compare:"tools","audit-log":"tools"}[m];C&&ie(M=>({...M,[C]:!0}))},[m]);const Ae=uo(r,h=>Ht(h)||n[0],X).sort((h,C)=>{const M=h.action.owner.localeCompare(C.action.owner);return M!==0?M:h.component.localeCompare(C.component)});g.useEffect(()=>{sn(ka,r)},[r]),g.useEffect(()=>{sn(Mt,I)},[I]),g.useEffect(()=>{sn(Ft,b)},[b]),g.useEffect(()=>{sn(Gt,re)},[re]),g.useEffect(()=>{Pa(r.orgProfile)&&!$d.includes(m)&&f("introduction")},[r.orgProfile,m]),g.useEffect(()=>{m==="dashboard"&&k.current&&setTimeout(()=>{var M,ee,q;const h=(M=k.current)==null?void 0:M.querySelector("#adoption-radar-chart");if(h){const me=co(r,t,n,X);zn(h,me)}const C=(ee=k.current)==null?void 0:ee.querySelector("#adoption-component-radar-chart");if(C){const me=Yt(n,X,ke);zn(C,me,{maintainAspectRatio:!1,scales:{r:{min:-1,max:5,ticks:{display:!0,stepSize:1,backdropColor:"transparent",callback:ue=>Number(ue)<0?"":ue}}}},ue=>{const Le=n[ue];Le&&W(Le.id)})}if(r.history.length>0){const me=(q=k.current)==null?void 0:q.querySelector("#adoption-line-chart");if(me){const ue={labels:r.history.map(Le=>Le.monthLabel),datasets:[{label:"Adoption Score",data:r.history.map(Le=>Le.overallPercentage||0),borderColor:"#005EB8",backgroundColor:"rgba(0, 94, 184, 0.1)",fill:!0,tension:.4}]};ri(me,ue)}}},100)},[m,r,X,t,n,ke,ye,De]),g.useEffect(()=>{typeof document<"u"&&(document.documentElement.dataset.nhsThemeMode=I.darkMode?"dark":"light")},[I.darkMode]),g.useEffect(()=>{var C;const h=m==="assessment"?`component:${s}`:`view:${m}`;(C=ze.current[h])==null||C.scrollIntoView({block:"nearest",behavior:"smooth"})},[s,m]);const S=()=>typeof window>"u"?!1:window.innerWidth<1024,D=g.useCallback(()=>{var h;(h=y.current)==null||h.scrollTo({top:0,behavior:"auto"})},[]),E=g.useCallback(h=>{f(C=>C===h?C:(Te(M=>[C,...M].slice(0,20)),h)),S()&&l(!1)},[]),A=h=>{E(h)},U=g.useCallback(()=>{Te(h=>{const[C,...M]=h;return C?(f(C),window.innerWidth<1024&&l(!1),M):(window.location.hash="#/",h)})},[]),W=g.useCallback(h=>{Ht(h)&&(a(h),E("assessment"),D())},[E,D]),[ne,oe]=g.useState(null),Se=g.useCallback((h,C,M)=>{oe({lens:C,actionId:M}),W(h)},[W]);g.useEffect(()=>{D()},[D,m]);function ve(h,C){if(!C.length)return h.auditLog;const M=Ud(h.orgProfile,P.current,j.current||""),ee=C.map(q=>$l({actor:M,eventType:q.eventType,entityType:q.entityType,entityId:q.entityId,summary:q.summary,trustName:q.trustName??h.orgProfile.trustName,projectName:q.projectName??h.orgProfile.projectName,componentId:q.componentId,lens:q.lens,reason:q.reason,before:q.before,after:q.after,source:q.source,importedAt:q.importedAt}));return jt([...h.auditLog||[],...ee])}const Xe=g.useCallback((h,C,M)=>{o(ee=>{var Oe;const q=((Oe=ee.currentDraft[h])==null?void 0:Oe[C])||_t(),me={...ee,currentDraft:{...ee.currentDraft,[h]:{...ee.currentDraft[h],[C]:Ma(M)}}},ue=[];q.score!==M.score&&ue.push({eventType:"entry-score-updated",entityType:"entry",entityId:`${h}:${C}`,summary:`Updated readiness score for ${h} / ${C}: ${q.score} -> ${M.score}`,componentId:h,lens:C,before:{score:q.score},after:{score:M.score},source:"local"}),(q.justification||"")!==(M.justification||"")&&ue.push({eventType:"entry-justification-updated",entityType:"entry",entityId:`${h}:${C}`,summary:`Updated justification for ${h} / ${C}`,componentId:h,lens:C,before:{justification:q.justification||""},after:{justification:M.justification||""},source:"local"}),(q.evidence||"")!==(M.evidence||"")&&ue.push({eventType:"entry-evidence-updated",entityType:"entry",entityId:`${h}:${C}`,summary:`Updated evidence for ${h} / ${C}`,componentId:h,lens:C,before:{evidence:q.evidence||""},after:{evidence:M.evidence||""},source:"local"});const Le=new Map(q.actions.map(fe=>[fe.id,fe]));return M.actions.forEach(fe=>{const Re=Le.get(fe.id);if(!Re){ue.push({eventType:"action-created",entityType:"action",entityId:fe.id,summary:`Created action in ${h} / ${C}`,componentId:h,lens:C,after:{text:fe.text,status:fe.status,owner:fe.owner,actionType:fe.actionType},source:"local"});return}const jn=JSON.stringify({text:Re.text,status:Re.status,owner:Re.owner,actionType:Re.actionType,notes:Re.notes,dueDate:Re.dueDate,startDate:Re.startDate,evidence:Re.evidence}),mn=JSON.stringify({text:fe.text,status:fe.status,owner:fe.owner,actionType:fe.actionType,notes:fe.notes,dueDate:fe.dueDate,startDate:fe.startDate,evidence:fe.evidence});jn!==mn&&ue.push({eventType:"action-updated",entityType:"action",entityId:fe.id,summary:`Updated action in ${h} / ${C}`,componentId:h,lens:C,before:{text:Re.text,status:Re.status,owner:Re.owner,actionType:Re.actionType},after:{text:fe.text,status:fe.status,owner:fe.owner,actionType:fe.actionType},source:"local"})}),{...kn(me),auditLog:ve(ee,ue)}})},[ve]),un=g.useCallback((h,C,M,ee)=>{const q=X(h,C);Xe(h,C,{...q,actions:q.actions.map(me=>me.id===M?{...me,status:We(ee)}:me)})},[X,Xe]),Cn=g.useCallback((h,C,M,ee)=>{const q=X(h,C).actions.find(ue=>ue.id===M);if(We(ee)==="Completed"&&q!==void 0&&!Gd(q)&&!Sn(st)){be({componentId:h,lens:C,actionId:M,status:ee});return}un(h,C,M,ee)},[un,X]),v=g.useCallback((h,C)=>{o(M=>{const ee=M.objectives[h]||[],q={...M,objectives:{...M.objectives,[h]:C}};return JSON.stringify(ee)!==JSON.stringify(C)?{...q,auditLog:ve(M,[{eventType:"objectives-updated",entityType:"objective",entityId:h,summary:`Updated component outcomes for ${h}`,componentId:h,before:{objectiveCount:ee.length},after:{objectiveCount:C.length},source:"local"}])}:q})},[ve]),$=g.useCallback(h=>{const C=ti(r.orgProfile);if(C.isValid)return!0;const M=C.errors.map(ee=>`- ${ee.message}`).join(`
`);return window.confirm(`${h} has CST warnings:

${M}

Continue anyway?`)},[r.orgProfile]),V=g.useCallback(h=>{L(h)},[]),de=g.useCallback(()=>{if(!$("Export"))return;const C=Ca(r);tt(`adoption-assessment-${(r.orgProfile.trustName||"export").replace(/\s+/g,"_")}.json`,JSON.stringify(C,null,2),"application/json"),V("Assessment export downloaded.")},[V,$,r]),we=g.useCallback(()=>{var h;(h=Y.current)==null||h.click()},[]),Me=g.useCallback(async h=>{var q,me,ue,Le;const C=(q=h.target.files)==null?void 0:q[0];if(!C)return;const M=C.name.toLowerCase().endsWith(".json"),ee=!C.type||Pd.has(C.type);if(!M||!ee){V("Import failed. Please choose a valid JSON file."),window.alert("Import failed. Please choose a valid JSON file."),h.target.value="";return}if(C.size>Rd){V("Import failed. The selected file is larger than 5 MB."),window.alert("Import failed. The selected file is larger than 5 MB."),h.target.value="";return}try{const hn=await C.text(),Oe=xt(JSON.parse(hn)),fe=()=>{o(En=>{const gn=kn(ja(Oe,En));return gn.orgProfile.cstId||(gn.orgProfile={...gn.orgProfile,cstId:qs()}),{...gn,auditLog:ve(gn,[{eventType:"data-imported",entityType:"system",summary:`Imported assessment data from ${C.name}`,after:{fileName:C.name},source:"local"}])}}),f("dashboard"),V("Assessment import complete. Dashboard updated.")};if(Ra(r)){fe();return}const Re=(me=Oe.orgProfile)==null?void 0:me.cstId,jn=r.orgProfile.cstId,mn=r.orgProfile.projectName||r.orgProfile.trustName||"your currently loaded programme",Pn=((ue=Oe.orgProfile)==null?void 0:ue.projectName)||((Le=Oe.orgProfile)==null?void 0:Le.trustName)||C.name;if(Re&&Re!==jn){if(!window.confirm(`"${Pn}" looks like a different programme than "${mn}".
...
Click OK to compare it against "${mn}" and merge item by item, or Cancel to load it as a different programme (replace everything).`)){fe();return}const fn=cc(r,Oe);if(!fn.hasConflicts){o(En=>{const gn=kn(Oa(En,Oe,{}));return{...gn,auditLog:ve(gn,[{eventType:"data-imported",entityType:"system",summary:fn.autoMergeSummary.length?`Merged import from ${C.name} (${fn.autoMergeSummary.join(", ")})`:`Imported ${C.name} - no changes (already up to date)`,after:{fileName:C.name},source:"local"}])}}),f("dashboard"),V(fn.autoMergeSummary.length?`Merged automatically: ${fn.autoMergeSummary.join(", ")}.`:"Already up to date - nothing to import.");return}p({file:C,parsed:Oe,report:fn})}catch{V("Import failed. Please verify the file contents."),window.alert("Unable to import adoption assessment. Please verify the file contents.")}finally{h.target.value=""}},[V,ve,r]),Fe=g.useCallback(h=>{if(!O)return;const{file:C,parsed:M}=O,ee=Object.keys(h).length;o(q=>{const me=kn(Oa(q,M,h));return{...me,auditLog:ve(me,[{eventType:"data-imported",entityType:"system",summary:`Merged import from ${C.name} (${ee} item(s) resolved)`,after:{fileName:C.name},source:"local"}])}}),p(null),f("dashboard"),V("Import merged into current programme.")},[V,ve,O]),Ee=g.useCallback(()=>{p(null),V("Import cancelled.")},[V]),je=g.useCallback(async h=>{try{const C=await fetch(Ld[h]);if(!C.ok)throw new Error(`Failed to load sample data: ${C.status}`);const M=xt(await C.json());o(ee=>{const q=kn(ja(M,ee));return{...q,auditLog:ve(q,[{eventType:"example-data-loaded",entityType:"system",summary:"Loaded example assessment data",source:"local"}])}}),f("dashboard"),V("Example assessment data loaded."),S()&&l(!1)}catch(C){console.error(C),V("Unable to load example data right now."),window.alert("Unable to load example data right now. Please try again.")}},[V,ve]),nn=g.useCallback(()=>{if(!window.confirm("Warning: this will reset all assessment data (organisation profile, scores, actions, and history) and sign you out. If you are worried, please export your data first. Continue?"))return;const C=kn(vt());o(C),f("introduction"),H(Ut),sn(Mt,Ut),localStorage.removeItem(_d),_({}),sn(Gt,{}),sn(Zt,!1),w(""),sn(Ft,""),Object.keys(localStorage).filter(M=>M.startsWith("nhs-digital-adoption-page-intro-seen:")).forEach(M=>localStorage.removeItem(M)),V("Assessment data has been reset and you have been signed out."),S()&&l(!1)},[V]),Ue=g.useCallback(()=>({generatedAt:new Date().toISOString(),targetMonth:Be.previousMonthLabel,report:Ca(r)}),[Be.previousMonthLabel,r]),on=g.useCallback(()=>`adoption-point-in-time-${Be.previousMonthLabel.toLowerCase().replace(/\s+/g,"-")}.json`,[Be.previousMonthLabel]);g.useCallback(()=>{const h=on();tt(h,JSON.stringify(Ue(),null,2),"application/json")},[on,Ue]),g.useCallback(()=>{const h=Ie.trim()||"test@test.com",C=on(),M=`${en}

Attachment: ${C}`,ee=`mailto:${h}?subject=${encodeURIComponent(Je)}&body=${encodeURIComponent(M)}`;window.location.href=ee},[on,en,Je,Ie]),g.useCallback(()=>{const h=Ie.trim()||"test@test.com",C=on(),M=JSON.stringify(Ue(),null,2),ee=Yd(qd(M)),q=`----nhs-adoption-reminder-${Date.now()}`,me=[`To: ${h}`,`Subject: ${Je}`,"MIME-Version: 1.0",`Content-Type: multipart/mixed; boundary="${q}"`,"",`--${q}`,'Content-Type: text/plain; charset="UTF-8"',"Content-Transfer-Encoding: 8bit","",en,"",`--${q}`,`Content-Type: application/json; name="${C}"`,"Content-Transfer-Encoding: base64",`Content-Disposition: attachment; filename="${C}"`,"",ee,`--${q}--`,""].join(`\r
`),ue=Be.previousMonthLabel.toLowerCase().replace(/\s+/g,"-");tt(`adoption-reminder-${ue}.eml`,me,"message/rfc822")},[on,Ue,en,Je,Ie,Be.previousMonthLabel]),g.useCallback(()=>{_(h=>({...h,[te]:!0}))},[te]),Be.shouldNotify&&re[te];const tn=g.useMemo(()=>po(r,xe,ae),[r,xe,ae]),wn=g.useMemo(()=>tn.filter(h=>h.completed).length,[tn]),Gn=g.useCallback(h=>{H(h)},[]),Fn=g.useCallback(h=>{o(C=>{const M=C.orgProfile.cst.pathway!==h.cst.pathway,ee={...C,orgProfile:h},q=M?Od(ee,h.cst.pathway):ee;return JSON.stringify(C.orgProfile)!==JSON.stringify(h)?{...q,auditLog:ve(C,[{eventType:"profile-updated",entityType:"profile",summary:"Updated CST profile details",before:{trustName:C.orgProfile.trustName,projectName:C.orgProfile.projectName,cst:C.orgProfile.cst},after:{trustName:h.trustName,projectName:h.projectName,cst:h.cst},source:"local"},...M?[{eventType:"pathway-changed",entityType:"profile",summary:`Changed pathway from ${C.orgProfile.cst.pathway} to ${h.cst.pathway}`,before:{pathway:C.orgProfile.cst.pathway},after:{pathway:h.cst.pathway},source:"local"}]:[]])}:q})},[]),Un=h=>{let C=0,M=0,ee=0,q=0;return h.lenses.forEach(me=>{var hn,Oe;const ue=(hn=r.currentDraft[h.id])==null?void 0:hn[me];ue&&ue.score>0&&(C++,(Oe=ue.justification)!=null&&Oe.trim()&&M++);const Le=(ue==null?void 0:ue.actions)||[];ee+=Le.length,q+=Le.filter(fe=>ts(fe.status)).length}),C===0?{icon:"◯",color:"text-blue-100",label:"Not Started"}:C>M?{icon:"⚠",color:"text-red-300",label:"Missing Justification"}:C<h.lenses.length?{icon:"◐",color:"text-amber-300",label:"In Progress"}:ee<=0||q<ee?{icon:"◐",color:"text-amber-300",label:"In Progress"}:{icon:"✓",color:"text-green-300",label:"Completed"}},_n=r.orgProfile.trustName||"Unconfigured Trust",ct=r.orgProfile.projectName||"Unnamed Project",Rn=!Pa(r.orgProfile);return e.jsxs("div",{className:`flex h-screen overflow-hidden ${I.darkMode?"bg-slate-900 text-slate-100":"bg-slate-50 text-slate-800"}`,children:[e.jsx("div",{role:"status","aria-live":"polite",className:"sr-only",children:Z}),e.jsx("input",{ref:Y,type:"file",accept:"application/json",className:"hidden",onChange:Me}),i&&e.jsx("div",{className:"fixed inset-0 z-10 bg-slate-900/35 backdrop-blur-[1px] lg:hidden",onClick:()=>l(!1)}),e.jsxs("div",{className:`fixed inset-y-0 left-0 z-20 bg-[#005eb8] text-white flex flex-col shadow-xl overflow-hidden transition-all duration-300 ease-out lg:static lg:translate-x-0 ${i?"w-72 translate-x-0":"w-0 -translate-x-full lg:w-0"}`,style:{backgroundColor:I.themeColor},children:[e.jsxs("div",{className:"p-6 border-b border-blue-700",children:[e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-xl font-bold tracking-tight",children:"NHS Digital Adoption"}),e.jsxs("p",{className:"text-blue-200 text-xs mt-1 flex justify-between items-center",children:[e.jsx("span",{children:"Readiness Tracking Tool"}),e.jsx("span",{className:"opacity-80 font-medium",children:"V6.6"})]})]}),I.profileImageDataUrl?e.jsx("img",{src:I.profileImageDataUrl,alt:"Profile",className:"h-10 w-10 rounded-full border-2 border-blue-200 object-cover"}):null]}),e.jsx("button",{type:"button",onClick:()=>A("profile"),className:"mt-3 w-full rounded-md bg-blue-700 p-2 text-left text-xs hover:bg-blue-600",children:e.jsxs("div",{className:"font-semibold text-blue-100",children:["Objectives: ",wn,"/",tn.length]})})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto py-4",children:[e.jsxs("button",{type:"button","aria-expanded":le.intro,onClick:()=>ie(h=>({...h,intro:!h.intro})),className:"mb-2 flex w-full items-center justify-between px-4 text-left text-xs font-semibold uppercase tracking-wider text-blue-300 hover:text-white",children:[e.jsx("span",{children:"Intro"}),e.jsx("span",{"aria-hidden":"true",children:le.intro?"−":"+"})]}),le.intro?e.jsx("nav",{className:"space-y-1 mb-4",children:["introduction","engine-explained","project-details","where-am-i-now"].map(h=>e.jsx("button",{ref:C=>{ze.current[`view:${h}`]=C},onClick:()=>A(h),className:`w-full flex items-center px-4 py-2.5 text-sm transition-colors ${m===h?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:h==="introduction"?"Introduction":h==="engine-explained"?"Engine Explained":h==="project-details"?"Project Profile":"Where Am I Now?"},h))}):null,Rn?e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button","aria-expanded":le.overview,onClick:()=>ie(h=>({...h,overview:!h.overview})),className:"mb-2 flex w-full items-center justify-between px-4 text-left text-xs font-semibold uppercase tracking-wider text-blue-300 hover:text-white",children:[e.jsx("span",{children:"Overview"}),e.jsx("span",{"aria-hidden":"true",children:le.overview?"−":"+"})]}),le.overview?e.jsx("nav",{className:"space-y-1 mb-4",children:["dashboard","daily-checkin","action-plan","roadmap-view"].map(h=>e.jsx("button",{ref:C=>{ze.current[`view:${h}`]=C},onClick:()=>A(h),className:`w-full flex items-center px-4 py-2.5 text-sm transition-colors ${m===h?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:h==="dashboard"?"Metrics Dashboard":h==="daily-checkin"?"Daily Check-in":h==="action-plan"?"Action Tracker":"Component Delivery Timeline"},h))}):null,e.jsx("div",{className:"px-4 mb-2 text-xs font-semibold text-blue-300 uppercase tracking-wider",children:"Change Components"}),e.jsx("nav",{className:"space-y-2 mb-8",children:Array.from(new Set(n.map(h=>h.phase))).map(h=>{const C=n.filter(ee=>ee.phase===h),M=Ke[h]??!1;return e.jsxs("div",{className:"mx-2 overflow-hidden rounded-md",style:{backgroundColor:`${Td[h]||"#3b82f6"}33`},children:[e.jsxs("button",{type:"button","aria-expanded":M,onClick:()=>B(ee=>({...ee,[h]:!M})),className:"flex w-full items-center justify-between px-3 pb-1.5 pt-2.5 text-left text-sm font-semibold uppercase tracking-wider text-white",children:[e.jsx("span",{children:Qe[h]||`Phase ${h}`}),e.jsx("span",{"aria-hidden":"true",children:M?"−":"+"})]}),M?C.map(ee=>{const q=m==="assessment"&&s===ee.id,me=Un(ee);return e.jsxs("button",{ref:ue=>{ze.current[`component:${ee.id}`]=ue},onClick:()=>{W(ee.id)},className:`w-full text-left px-4 py-2 text-sm flex items-center justify-between transition-colors ${q?"bg-white font-medium text-[#005eb8]":`hover:bg-blue-800 ${me.color}`}`,children:[e.jsx("span",{className:"truncate pr-2",children:Pi(ee.label)}),e.jsx("span",{className:"text-xs flex-shrink-0",title:me.label,"aria-label":me.label,children:me.icon})]},ee.id)}):null]},h)})}),e.jsxs("button",{type:"button","aria-expanded":le.tools,onClick:()=>ie(h=>({...h,tools:!h.tools})),className:"mb-2 flex w-full items-center justify-between px-4 text-left text-xs font-semibold uppercase tracking-wider text-blue-300 hover:text-white",children:[e.jsx("span",{children:"Tools"}),e.jsx("span",{"aria-hidden":"true",children:le.tools?"−":"+"})]}),le.tools?e.jsx("nav",{className:"space-y-1 mb-8",children:["highlight-builder","force-field-analysis","compare","audit-log"].map(h=>e.jsx("button",{ref:C=>{ze.current[`view:${h}`]=C},onClick:()=>A(h),className:`w-full flex items-center px-4 py-1 text-sm transition-colors ${m===h?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:h==="highlight-builder"?"Highlight Builder":h==="force-field-analysis"?"Force Field Analysis":h==="compare"?"Assess & Compare":"Audit Log"},h))}):null]}):null,e.jsx("div",{className:"px-4 mb-2 text-xs font-semibold text-blue-300 uppercase tracking-wider border-t border-blue-800 pt-6",children:"Account"}),e.jsx("nav",{className:"space-y-1 mb-8",children:(Rn?["settings","profile"]:["profile"]).map(h=>e.jsx("button",{ref:C=>{ze.current[`view:${h}`]=C},onClick:()=>A(h),className:`w-full flex items-center px-4 py-1 text-sm transition-colors ${m===h?"bg-blue-800 text-white font-medium border-l-4 border-white":"text-blue-100 hover:bg-blue-800 border-l-4 border-transparent"}`,children:h==="settings"?"Settings":"Profile"},h))}),e.jsxs("div",{className:"mt-8 px-4 pb-4 border-t border-blue-800 pt-6",children:[e.jsx("div",{className:"text-[10px] font-semibold text-blue-300 uppercase tracking-wider mb-3",children:"Status Legend"}),e.jsxs("div",{className:"space-y-2 text-xs text-blue-200",children:[e.jsx("div",{children:"◯ Not Started"}),e.jsx("div",{children:"◐ In Progress"}),e.jsx("div",{children:"⚠ Missing Justification"}),e.jsx("div",{children:"✓ Completed"})]})]})]})]}),e.jsxs("div",{className:"flex-1 flex flex-col h-screen overflow-hidden",children:[e.jsx("header",{className:`${I.darkMode?"bg-slate-800 border-slate-700":"bg-white border-slate-200"} border-b px-3 py-2 sm:px-6 shrink-0 z-10 ${m==="introduction"?"":"shadow-sm"}`,style:{borderTop:`3px solid ${I.themeColor}`},children:e.jsxs("div",{className:"flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between",children:[e.jsxs("div",{className:"min-w-0 flex items-center gap-2 sm:gap-3",children:[e.jsxs("button",{onClick:()=>l(h=>!h),className:"inline-flex h-9 items-center justify-center px-3 text-white rounded-md font-semibold transition-colors shadow-sm","aria-label":i?"Collapse side navigation":"Expand side navigation",title:i?"Collapse side navigation":"Expand side navigation",style:{backgroundColor:I.themeColor},children:[e.jsx("span",{"aria-hidden":"true",className:"text-lg leading-none",children:i?"«":"»"}),e.jsx("span",{className:"sr-only",children:i?"Collapse side navigation":"Expand side navigation"})]}),e.jsx("button",{onClick:U,disabled:Ce.length===0,title:Ce.length===0?"No previous in-app page":"Back to previous page",className:`h-9 text-sm px-3 rounded-md font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${I.darkMode?"text-slate-100 hover:bg-slate-700":"text-slate-600 hover:bg-slate-100"}`,children:"← Back"}),e.jsx("div",{className:"min-w-0",children:e.jsxs("div",{className:"flex min-w-0 items-center gap-1 text-sm",children:[e.jsx("span",{className:`truncate font-semibold ${I.darkMode?"text-slate-100":"text-slate-700"}`,title:_n,children:_n}),e.jsx("span",{className:`${I.darkMode?"text-slate-300":"text-slate-400"}`,children:"/"}),e.jsx("span",{className:`truncate ${I.darkMode?"text-slate-100":"text-slate-600"}`,title:ct,children:ct})]})})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 lg:justify-end",children:[e.jsxs("span",{className:"inline-flex h-9 w-9 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-[11px] font-semibold text-emerald-800 sm:h-9 sm:w-auto sm:rounded-full",title:"Auto-save on","aria-label":"Auto-save on",children:[e.jsx("span",{className:"inline-flex h-3 w-3 items-center justify-center rounded-full bg-emerald-500 text-[9px] text-white","aria-hidden":"true",children:"✓"}),e.jsx("span",{className:"sr-only sm:not-sr-only sm:ml-1",children:"Auto-save on"})]}),e.jsx("button",{onClick:()=>A("introduction"),"aria-label":"Show introduction",title:"Show introduction",className:`text-sm w-9 h-9 flex items-center justify-center bg-white text-[#425563] border border-[#768692] hover:bg-[#f0f4f5] rounded-full font-semibold transition-colors ${es}`,children:"?"}),e.jsx("button",{type:"button",onClick:()=>{window.location.hash="#/"},"aria-label":"Go to home page",title:"Go to home page",className:`${Ge} h-9 w-16 px-6 py-0 inline-flex items-center justify-center`,children:"Home"}),e.jsx("button",{onClick:we,className:`${Ge} h-9 px-3 py-0`,children:"Import"}),e.jsxs("button",{onClick:de,className:`${Ge} h-9 px-3 py-0`,children:[e.jsx("span",{className:"sm:hidden",children:"Export"}),e.jsx("span",{className:"hidden sm:inline",children:"Export"})]})]})]})}),e.jsxs("main",{ref:y,className:"flex-1 overflow-y-auto p-8",children:[m==="daily-checkin"&&G?e.jsxs("section",{className:`${I.darkMode?"border-slate-700 bg-slate-800":"border-slate-200 bg-white"} mb-6 rounded-xl border p-4 shadow-sm`,children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-xs font-semibold uppercase tracking-wider ${I.darkMode?"text-slate-300":"text-slate-500"}`,children:"Objectives"}),e.jsxs("p",{className:`text-sm mt-1 ${I.darkMode?"text-slate-100":"text-slate-700"}`,children:[wn,"/",tn.length," complete - based on phase readiness, ownership, cadence and team participation."]})]}),e.jsx("button",{type:"button",onClick:()=>Ne(!1),className:`${I.darkMode?"border-slate-600 bg-slate-900 text-slate-100 hover:bg-slate-700":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"} rounded-md border px-3 py-2 text-sm font-medium`,"aria-label":"Dismiss objectives card",children:"Dismiss"})]}),e.jsx("div",{className:"mt-4 grid gap-3 md:grid-cols-3",children:tn.map(h=>e.jsxs("div",{className:`rounded-lg border p-3 ${h.completed?"border-green-200 bg-green-50":I.darkMode?"border-slate-700 bg-slate-900":"border-slate-200 bg-slate-50"}`,children:[e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsx("p",{className:`text-sm font-semibold ${I.darkMode?"text-slate-100":"text-slate-800"}`,children:h.label}),e.jsx("span",{className:"text-xs font-bold",children:h.completed?"Done":"Not yet"})]}),e.jsx("p",{className:`mt-1 text-xs ${I.darkMode?"text-slate-300":"text-slate-600"}`,children:h.description})]},h.id))})]}):null,m==="dashboard"&&e.jsx("div",{ref:k,children:e.jsx(xo,{store:r,components:n,lenses:t,metrics:xe,phaseFocusMode:I.phaseFocusMode||"auto",manualPhaseFocus:I.manualPhaseFocus,onPhaseFocusModeChange:h=>H(C=>({...C,phaseFocusMode:h,manualPhaseFocus:h==="manual"?C.manualPhaseFocus||xe.currentPhase:C.manualPhaseFocus})),onManualPhaseFocusChange:h=>H(C=>({...C,phaseFocusMode:"manual",manualPhaseFocus:h})),onResetPhaseFocus:()=>H(h=>({...h,phaseFocusMode:"auto",manualPhaseFocus:xe.currentPhase})),getEntry:X,onComponentClick:W,onNavigate:A,onOpenLensInfo:c,onOpenOnboarding:()=>A("introduction"),colorAccessibilityMode:I.colorAccessibilityMode||"standard",darkMode:!!I.darkMode,componentRadarVisible:ye,onComponentRadarVisibleChange:se,componentRadarSize:De,onComponentRadarSizeChange:$e})}),m==="where-am-i-now"&&e.jsx(Dl,{components:n,getEntry:X,effectivePhaseFocus:ke,phaseFocusMode:I.phaseFocusMode||"auto",onComponentClick:W,onSetManualPhase:h=>H(C=>({...C,phaseFocusMode:"manual",manualPhaseFocus:h})),onResetToAuto:()=>H(h=>({...h,phaseFocusMode:"auto",manualPhaseFocus:xe.currentPhase})),darkMode:!!I.darkMode}),m==="daily-checkin"&&e.jsx(_r,{store:r,components:n,metrics:xe,getEntry:X,onComponentClick:W,onActionView:Se,guidanceTarget:_a,linkOverrides:r.orgProfile.linkOverrides,showAdditionalGuidanceLinks:he,phaseFocusMode:I.phaseFocusMode||"auto",manualPhaseFocus:I.manualPhaseFocus,colorAccessibilityMode:I.colorAccessibilityMode||"standard",darkMode:!!I.darkMode}),m==="project-details"&&e.jsx(Er,{orgProfile:r.orgProfile,onProfileUpdate:Fn,components:n,lenses:t,onComponentClick:W,onGoToIntroduction:()=>A("introduction"),onContinueToVision:()=>W("vision"),onGoToWhereAmINow:()=>A("where-am-i-now"),currentUserId:b,onCurrentUserChange:w,showExternalLinksSection:!!I.showExternalLinksSection,darkMode:!!I.darkMode}),m==="assessment"&&e.jsx(br,{store:r,components:n,activeComponentId:s,getRubricText:Wd,getEntry:X,onComponentChange:W,onEntryUpdate:Xe,onOpenLensInfo:c,onActionRemove:(h,C,M)=>{const q=X(h,C).actions.find(ue=>ue.id===M);if(!q)return;const me=window.prompt("Please provide a reason for removing this action. This will be included in the JSON export audit log.");if(!me||!me.trim()){window.alert("Removal cancelled. A reason is required to remove an action.");return}o(ue=>{var jn;const Le=((jn=ue.currentDraft[h])==null?void 0:jn[C])||_t(),hn={...Le,actions:Le.actions.filter(mn=>mn.id!==M).map(Bd)},Oe={...ue.suppressedAutoActions};if(M.startsWith("vision-action:")||M.startsWith("case-for-change-action:")||M.startsWith("benefits-action:")||M.startsWith("sponsorship-action:")||M.startsWith("change-impact-action:")){const mn=Md(h,C),Pn=Oe[mn]||[];Pn.includes(M)||(Oe[mn]=[...Pn,M])}const fe={...ue,currentDraft:{...ue.currentDraft,[h]:{...ue.currentDraft[h],[C]:hn}},suppressedAutoActions:Oe};return{...kn(fe),auditLog:ve(ue,[{eventType:"action-removed",entityType:"action",entityId:M,summary:`Removed action from ${h} / ${C}`,componentId:h,lens:C,reason:me.trim(),before:{text:q.text,status:q.status,owner:q.owner,actionType:q.actionType},source:"local"}])}})},onObjectivesUpdate:v,onNavigateToTool:h=>A(h),hideGuidedWorkflow:!!I.hideGuidedWorkflow,onHideGuidedWorkflow:()=>H(h=>({...h,hideGuidedWorkflow:!0})),showAdditionalGuidanceLinks:he,showActionPriorityColours:!!I.showActionPriorityColours,currentUserId:b,currentUserProfileImageDataUrl:I.profileImageDataUrl,darkMode:!!I.darkMode,focusAction:ne,onFocusActionHandled:()=>oe(null)}),m==="action-plan"&&e.jsx(Ji,{actions:Ae,onComponentClick:W,onStatusChange:Cn,teamMembers:r.orgProfile.teamMembers||[],darkMode:!!I.darkMode}),m==="introduction"&&e.jsx(kl,{darkMode:!!I.darkMode,onGetStarted:()=>A("engine-explained")}),m==="engine-explained"&&e.jsx(zr,{darkMode:!!I.darkMode,onGetStarted:()=>A("project-details"),onComponentClick:W}),m==="roadmap-view"&&e.jsx(ol,{components:n,metrics:xe,getEntry:X,onComponentClick:W,pathway:r.orgProfile.cst.pathway,pathwayChecks:r.pathwayChecks,darkMode:!!I.darkMode}),m==="highlight-builder"&&e.jsx(hl,{store:r,metrics:xe,lenses:t,components:n,getEntry:X,trustName:r.orgProfile.trustName,projectName:r.orgProfile.projectName,themeColor:I.themeColor,currentUserId:b,darkMode:!!I.darkMode}),m==="force-field-analysis"&&e.jsx(Ri,{embedded:!0,onBack:()=>A("dashboard")}),m==="compare"&&e.jsx(Vi,{embedded:!0,onBack:()=>A("dashboard")}),m==="audit-log"&&e.jsx(Sr,{events:r.auditLog,darkMode:!!I.darkMode}),m==="settings"&&e.jsx(Rl,{userSettings:I,onUserSettingsUpdate:Gn,onLoadExampleData:je,onResetData:nn,darkMode:!!I.darkMode}),m==="profile"&&e.jsx(Ol,{orgProfile:r.orgProfile,onProfileUpdate:Fn,userSettings:I,onUserSettingsUpdate:Gn,currentUserId:b,onCurrentUserChange:w,objectives:tn,darkMode:!!I.darkMode})]}),d?e.jsx(vl,{lensName:d,onClose:()=>c(""),darkMode:!!I.darkMode}):null,O?e.jsx(xl,{report:O.report,myLabel:r.orgProfile.projectName||r.orgProfile.trustName||"Mine",theirLabel:((Xn=O.parsed.orgProfile)==null?void 0:Xn.projectName)||((dt=O.parsed.orgProfile)==null?void 0:dt.trustName)||O.file.name,onResolve:Fe,onCancel:Ee,darkMode:!!I.darkMode}):null,e.jsx(zi,{toolkitChoice:r.orgProfile.cst.toolkitChoice,darkMode:!!I.darkMode}),e.jsx(Yi,{open:m==="assessment"&&s==="vision"&&x.isOpen,onClose:x.close,darkMode:!!I.darkMode}),e.jsx(Ta,{open:ge!==null,onCancel:()=>be(null),onContinue:h=>{ge&&(h&&sn(st,!0),un(ge.componentId,ge.lens,ge.actionId,ge.status),be(null))},darkMode:!!I.darkMode})]})]})}export{au as AdoptionApp,au as default};
