...
`,Ms={componentId:"change_impact",actionPrefix:"change-impact-action",outcomePrefix:"change-impact:outcome",fallbackOutcomes:[{id:"change-impact:outcome:o1",text:"The impact of the change has been identified and understood"},{id:"change-impact:outcome:o2",text:"Impacts have been assessed, validated and prioritised"},{id:"change-impact:outcome:o3",text:"Change impacts are actively managed through plans, governance and support"}]},pd=Je(gd,Ms);function hd(t){return Xe(t,Ms,pd)}function fd(t){return Qe(t,Ms)}const bd=`{
  "component": {
    "id": "CHANGE_NETWORK",
    "name": "Change Network"
  },
...
`,Fs={componentId:"org_maturity",actionPrefix:"org-change-readiness-action",outcomePrefix:"org-change-readiness:outcome",fallbackOutcomes:[{id:"org-change-readiness:outcome:o1",text:"Organisational readiness has been assessed and understood"},{id:"org-change-readiness:outcome:o2",text:"Readiness gaps are being actively addressed"},{id:"org-change-readiness:outcome:o3",text:"The organisation is prepared to successfully absorb and sustain the change"}],lensAliases:{"Strategic Direction and Leadership":"Strategic Direction and Leadership","People Experience and Culture":"Skills and Behaviour","Planning and Measurement":"Skills and Behaviour",Design:"Skills and Behaviour",Governance:"Skills and Behaviour","Measurement and Evaluation":"Skills and Behaviour",Reinforcement:"Skills and Behaviour"}},Cd=Je(kd,Fs);function Ed(t){return Xe(t,Fs,Cd)}function Id(t){return Qe(t,Fs)}const Ad="pathway-auto-action:",Od="pathway:auto-objective:",_d="vision:auto-objective:";function Rd(t){return t.startsWith(Od)||t.startsWith(_d)}function Dd(t){const n=t.orgProfile.cst.pathway,s={...t.objectives||{}},a=Object.keys(t.currentDraft||{}).reduce((i,l)=>{const o=t.currentDraft[l]||{};return i[l]=Object.keys(o).reduce((c,d)=>{const m=o[d];return c[d]={...m,actions:(m.actions||[]).filter(r=>!r.id.startsWith(Ad))},c},{}),i},{});return tn.forEach(i=>{Wi(i.id,n)&&(s[i.id]=(s[i.id]||[]).filter(o=>!Rd(o.id)))}),{...t,currentDraft:a,objectives:s}}const Pd=`{
  "component": {
    "id": "PROCESS_CHANGE",
    "name": "Process Change"
  },
...
`,Us={componentId:"process_change",actionPrefix:"process-change-action",outcomePrefix:"process-change:outcome",fallbackOutcomes:[{id:"process-change:outcome:o1",text:"Current and future processes have been defined"},{id:"process-change:outcome:o2",text:"Process changes have been implemented and adopted"},{id:"process-change:outcome:o3",text:"Processes are optimised and continuously improved"}],lensAliases:{"Process and Sustainment":"Process and Sustainment","People Experience and Culture":"Skills and Behaviour","Planning and Risk":"Process and Sustainment","Analysis and Insight":"Process and Sustainment",Communication:"Skills and Behaviour","Dependency Management":"Process and Sustainment",Design:"Process and Sustainment",Governance:"Process and Sustainment",Implementation:"Process and Sustainment","Measurement and Evaluation":"Process and Sustainment",Reinforcement:"Skills and Behaviour","Testing and Validation":"Process and Sustainment"}},$d=Je(Pd,Us);function Td(t){return Xe(t,Us,$d)}function Ld(t){return Qe(t,Us)}const Md=`{
  "component": {
    "id": "REINFORCEMENT",
    "name": "Reinforcement"
  },
...
`,zs={componentId:"stakeholder",actionPrefix:"stakeholder-action",outcomePrefix:"stakeholder:outcome",fallbackOutcomes:[{id:"stakeholder:outcome:o1",text:"Stakeholders have been identified, analysed and prioritised"},{id:"stakeholder:outcome:o2",text:"Stakeholders are actively engaged and informed"},{id:"stakeholder:outcome:o3",text:"Engagement and communications support successful adoption"}],lensAliases:{"Strategic Direction and Leadership":"Strategic Direction and Leadership","People Experience and Culture":"People Experience and Culture",Reinforcement:"People Experience and Culture"}},im=Je(am,zs);function om(t){return Xe(t,zs,im)}function rm(t){return Qe(t,zs)}const lm=`{
  "component": {
    "id": "TRANSFER_TO_BAU",
