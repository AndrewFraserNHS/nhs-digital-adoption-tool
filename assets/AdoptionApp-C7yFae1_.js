...
`,Ns={componentId:"change_impact",actionPrefix:"change-impact-action",outcomePrefix:"change-impact:outcome",fallbackOutcomes:[{id:"change-impact:outcome:o1",text:"The impact of the change has been identified and understood"},{id:"change-impact:outcome:o2",text:"Impacts have been assessed, validated and prioritised"},{id:"change-impact:outcome:o3",text:"Change impacts are actively managed through plans, governance and support"}]},gi=$e(ui,Ns);function pi(n){return De(n,Ns,gi)}const hi=`{
  "component": {
    "id": "CHANGE_NETWORK",
    "name": "Change Network"
  },
...
`,$s={componentId:"vision",actionPrefix:"vision-action",outcomePrefix:"vision:outcome",fallbackOutcomes:[{id:"vision:outcome:o1",text:"A compelling future state has been defined"},{id:"vision:outcome:o2",text:"The vision is understood and shared"},{id:"vision:outcome:o3",text:"The vision is visible and guides the change"}]},Ji=$e(Yi,$s);function Xi(n){return De(n,$s,Ji)}const Ut="nhs-digital-adoption-user-settings",Vt="nhs-digital-adoption-report-reminder-dismissed",Mt="nhs-digital-adoption-engagement",Mn="nhs-digital-adoption-onboarding-seen",Ht="nhs-digital-adoption-current-user-id",Wt="Default",Qi=5*1024*1024,Zi=new Set(["application/json","text/json"]),er="Unknown user",nr=["#005eb8","#003366","#009b8a","#6c28d9","#059669","#dc2626"],tr={name:"",preferences:"",themeColor:"#005eb8",profileImageDataUrl:"",darkMode:!1,colorAccessibilityMode:"standard",phaseFocusMode:"auto",manualPhaseFocus:1},sr={xp:0,level:1,checkIns:{},emailDraftOpens:0,highlightLayoutSaves:0,onTimeFinalisations:0,lateFinalisations:0};function ar(n){return{...n,linkedTargets:(n.linkedTargets||[]).map(t=>({componentId:t.componentId,lens:t.lens}))}}function or(n,t){return`${n}:${t}`}function ir(n){return n.orgProfile.trustName||n.orgProfile.projectName?!1:!Object.values(n.currentDraft).some(t=>Object.values(t).some(s=>s.score>0))}function Ye(n){return Is(zi(vi(Oi(_i(ti(li(Fi(Ri(Wi(mi(Ti(bi(pi(Zo(Vi(oi(Xi(n))))))))))))))))))}function rr(n){return n.trim()||er}function lr(n,t,s){var l;const a=Ys[n];return((l=a==null?void 0:a[t])==null?void 0:l[s])||xt[s]||xt[0]}function cr(n=new Date){const t=String(n.getMonth()+1).padStart(2,"0");return`${n.getFullYear()}-${t}`}function dr(n=new Date){return new Date(n.getFullYear(),n.getMonth()-1,1).toLocaleString("en-GB",{month:"short",year:"numeric"})}function mr(n,t,s){return["Monthly Adoption Reporting Reminder","","Organisation",`${t||"Unconfigured Trust"}${s?` / ${s}`:""}`,"","Action Required",`Please finalise the ${n} adoption month if it has not already been captured.`,"","Attached","Point-in-time JSON report export generated from the latest working draft.","","Next Step","Review, confirm finalisation status, and circulate to the team."].join(`
`)}function ur(n){const t=new TextEncoder().encode(n);let s="";return t.forEach(a=>{s+=String.fromCharCode(a)}),window.btoa(s)}function gr(n,t=76){const s=[];for(let a=0;a<n.length;a+=t)s.push(n.slice(a,a+t));return s.join(`\r
`)}function Jn(n=new Date){return n.toISOString().slice(0,10)}function pr(n=new Date){const t=n.getDate(),s=new Date(n.getFullYear(),n.getMonth()+1,0).getDate();return t>=s-6}function hr(n=new Date){return n.toLocaleString("en-GB",{month:"short",year:"numeric"})}function Ts(n){return Math.max(1,Math.min(12,Math.floor(n/120)+1))}function pn(n,t){const s=n.xp+t;return{...n,xp:s,level:Ts(s)}}function fr(n,t){const s=n*30+Math.min(t,20)*4;return s>=170?"S":s>=130?"A":s>=95?"B":s>=60?"C":s>=30?"D":"E"}function br(n,t=new Date){let s=0;const a=new Date(t);let l=Jn(a);for(;n[l];)s+=1,a.setDate(a.getDate()-1),l=Jn(a);return s}function xr(n){const t=window.prompt(`Phase ${n} has changed. Enter delivery readiness grade (${Cn.join("/")}).`,"C");if(!t)return null;const s=t.trim().toUpperCase();if(!Cn.includes(s))return window.alert(`Invalid competence grade. Use one of ${Cn.join(", ")}.`),null;const a=window.prompt(`Enter confidence score for Phase ${n} (${En.join("-")}, where 1 is low and 5 is very high).`,"3");if(!a)return null;const l=Number(a.trim());return En.includes(l)?{competence:s,confidence:l}:(window.alert(`Invalid confidence score. Use a number from ${En.join(" to ")}.`),null)}function Ir(){var ut,gt;const n=Xn,t=g.useMemo(()=>[...Na],[]),[s,a]=g.useState("dashboard"),[l,i]=g.useState(n[0].id),[c,y]=g.useState(()=>typeof window>"u"?!0:window.innerWidth>=1024),[o,w]=g.useState(()=>{var q,B,z,H,oe,Ne,Ce,ie;const d=bt.getInstance();d.loadFromWindow();let f={};try{const Ee=Qe(Rt);f=rt(In(Ee))}catch(Ee){console.warn("Ignoring invalid persisted adoption data.",Ee)}const T=jn({view:"dashboard",orgProfile:(f==null?void 0:f.orgProfile)||((q=d.adoption)==null?void 0:q.orgProfile),currentDraft:(f==null?void 0:f.currentDraft)||((B=d.adoption)==null?void 0:B.currentDraft),objectives:(f==null?void 0:f.objectives)||((z=d.adoption)==null?void 0:z.objectives),suppressedAutoActions:(f==null?void 0:f.suppressedAutoActions)||((H=d.adoption)==null?void 0:H.suppressedAutoActions),auditLog:(f==null?void 0:f.auditLog)||((oe=d.adoption)==null?void 0:oe.auditLog),history:(f==null?void 0:f.history)||((Ne=d.adoption)==null?void 0:Ne.history),phaseOverrides:(f==null?void 0:f.phaseOverrides)||((Ce=d.adoption)==null?void 0:Ce.phaseOverrides),pathwayChecks:(f==null?void 0:f.pathwayChecks)||((ie=d.adoption)==null?void 0:ie.pathwayChecks)});return T.orgProfile.cstId||(T.orgProfile={...T.orgProfile,cstId:St()}),Ye(T)}),[E,u]=g.useState({}),[m,x]=g.useState(""),[S,O]=g.useState(()=>Qe(Ht)||""),[D,k]=g.useState(null),[v,W]=g.useState(()=>{const d=Qe(Ut);return{...tr,...d}}),[C,G]=g.useState(()=>{const d=Qe(Mt);return{...sr,...d,level:Ts((d==null?void 0:d.xp)||0),checkIns:(d==null?void 0:d.checkIns)||{}}}),U=Sn.useRef(null),me=Sn.useRef(null),[J,ce]=g.useState(""),de=Sn.useRef(null),le=g.useMemo(()=>cr(),[]),L=g.useMemo(()=>Jn(),[]),[Y,be]=g.useState(()=>Qe(Vt)||{}),[xe,j]=g.useState(()=>!!Qe(Mn)),[ee,h]=g.useState(()=>!Qe(Mn)),[P,X]=g.useState(!0),[ve,Q]=g.useState([]),[ne,ue]=g.useState(!1),he=Sn.useRef({}),Ie=g.useCallback(()=>{h(!1),xe||(j(!0),ln(Mn,!0))},[xe]),ye=g.useMemo(()=>{const d=new Date,f=dr(d),T=d.getDate()===1,q=o.history.some(B=>B.monthLabel===f);return{previousMonthLabel:f,isFirstDayOfMonth:T,hasFinalisedPreviousMonth:q,shouldNotify:T&&!q}},[o.history]),[p,_]=g.useState("test@test.com"),[I,R]=g.useState(""),[F,_e]=g.useState(""),fe=hr(),Oe=pr(),Ae=g.useCallback((d,f)=>(o.currentDraft[d]||(o.currentDraft[d]={}),o.currentDraft[d][f]||(o.currentDraft[d][f]=Bn()),o.currentDraft[d][f]),[o]),re=g.useMemo(()=>{const d=vt(o,n);return{...d,nextSteps:d.nextSteps.map(f=>({...f,toolkitLinks:Kt(Wt,f.componentId,"inputs").slice(0,3)}))}},[o]),en=v.phaseFocusMode==="manual"&&v.manualPhaseFocus?v.manualPhaseFocus:re.currentPhase,b=pa(o,d=>Wn(d)||n[0],Ae).sort((d,f)=>{const T=d.action.owner.localeCompare(f.action.owner);return T!==0?T:d.component.localeCompare(f.component)});g.useEffect(()=>{ln(Rt,o);const d=bt.getInstance();d.adoption={orgProfile:o.orgProfile,currentDraft:o.currentDraft,objectives:o.objectives,suppressedAutoActions:o.suppressedAutoActions,auditLog:o.auditLog,history:o.history,phaseOverrides:o.phaseOverrides,pathwayChecks:o.pathwayChecks}},[o]),g.useEffect(()=>{ln(Ut,v)},[v]),g.useEffect(()=>{ln(Ht,S)},[S]),g.useEffect(()=>{ln(Mt,C)},[C]),g.useEffect(()=>{ln(Vt,Y)},[Y]),g.useEffect(()=>{R(`Action required: finalise ${ye.previousMonthLabel} adoption report`),_e(mr(ye.previousMonthLabel,o.orgProfile.trustName,o.orgProfile.projectName||""))},[ye.previousMonthLabel,o.orgProfile.projectName,o.orgProfile.trustName]),g.useEffect(()=>{s==="dashboard"&&U.current&&setTimeout(()=>{var T,q,B;const d=(T=U.current)==null?void 0:T.querySelector("#adoption-radar-chart");if(d){const z=ua(o,t,n,Ae);ft(d,z)}const f=(q=U.current)==null?void 0:q.querySelector("#adoption-component-radar-chart");if(f){const z=ga(n,Ae,en);ft(f,z,{scales:{r:{min:0,max:5,ticks:{display:!0,stepSize:1,backdropColor:"transparent"}}}})}if(o.history.length>0){const z=(B=U.current)==null?void 0:B.querySelector("#adoption-line-chart");if(z){const H={labels:o.history.map(oe=>oe.monthLabel),datasets:[{label:"Adoption Score",data:o.history.map(oe=>oe.overallPercentage||0),borderColor:"#005EB8",backgroundColor:"rgba(0, 94, 184, 0.1)",fill:!0,tension:.4}]};Ks(z,H)}}},100)},[s,o,Ae,t,n,en]),g.useEffect(()=>{const d=()=>{y(window.innerWidth>=1024)};return d(),window.addEventListener("resize",d),()=>{window.removeEventListener("resize",d)}},[]),g.useEffect(()=>{typeof document<"u"&&(document.documentElement.dataset.nhsThemeMode=v.darkMode?"dark":"light")},[v.darkMode]),g.useEffect(()=>{var f;const d=s==="assessment"?`component:${l}`:`view:${s}`;(f=he.current[d])==null||f.scrollIntoView({block:"nearest",behavior:"smooth"})},[l,s]);const V=()=>typeof window>"u"?!1:window.innerWidth<1024,K=g.useCallback(()=>{var d;(d=me.current)==null||d.scrollTo({top:0,behavior:"auto"})},[]),te=g.useCallback(d=>{a(f=>f===d?f:(Q(T=>[f,...T].slice(0,20)),d)),V()&&y(!1)},[]),Se=d=>{te(d)},we=g.useCallback(()=>{Q(d=>{const[f,...T]=d;return f?(a(f),window.innerWidth<1024&&y(!1),T):(window.location.hash="#/",d)})},[]),ge=g.useCallback(d=>{Wn(d)&&(i(d),te("assessment"),K())},[te,K]);g.useEffect(()=>{K()},[K,s]);function se(d,f){if(!f.length)return d.auditLog;const T=rr(v.name||""),q=f.map(B=>yo({actor:T,eventType:B.eventType,entityType:B.entityType,entityId:B.entityId,summary:B.summary,trustName:B.trustName??d.orgProfile.trustName,projectName:B.projectName??d.orgProfile.projectName,componentId:B.componentId,lens:B.lens,reason:B.reason,before:B.before,after:B.after,source:B.source,importedAt:B.importedAt}));return kn([...d.auditLog||[],...q])}const Be=g.useCallback((d,f,T)=>{w(q=>{var Ce;const B=((Ce=q.currentDraft[d])==null?void 0:Ce[f])||Bn(),z={...q,currentDraft:{...q.currentDraft,[d]:{...q.currentDraft[d],[f]:Zt(T)}}},H=[];B.score!==T.score&&H.push({eventType:"entry-score-updated",entityType:"entry",entityId:`${d}:${f}`,summary:`Updated readiness score for ${d} / ${f}: ${B.score} -> ${T.score}`,componentId:d,lens:f,before:{score:B.score},after:{score:T.score},source:"local"}),(B.justification||"")!==(T.justification||"")&&H.push({eventType:"entry-justification-updated",entityType:"entry",entityId:`${d}:${f}`,summary:`Updated justification for ${d} / ${f}`,componentId:d,lens:f,before:{justification:B.justification||""},after:{justification:T.justification||""},source:"local"}),(B.evidence||"")!==(T.evidence||"")&&H.push({eventType:"entry-evidence-updated",entityType:"entry",entityId:`${d}:${f}`,summary:`Updated evidence for ${d} / ${f}`,componentId:d,lens:f,before:{evidence:B.evidence||""},after:{evidence:T.evidence||""},source:"local"});const oe=new Map(B.actions.map(ie=>[ie.id,ie]));return T.actions.forEach(ie=>{const Ee=oe.get(ie.id);if(!Ee){H.push({eventType:"action-created",entityType:"action",entityId:ie.id,summary:`Created action in ${d} / ${f}`,componentId:d,lens:f,after:{text:ie.text,status:ie.status,owner:ie.owner,actionType:ie.actionType},source:"local"});return}const on=JSON.stringify({text:Ee.text,status:Ee.status,owner:Ee.owner,actionType:Ee.actionType,notes:Ee.notes,dueDate:Ee.dueDate,startDate:Ee.startDate,evidence:Ee.evidence}),We=JSON.stringify({text:ie.text,status:ie.status,owner:ie.owner,actionType:ie.actionType,notes:ie.notes,dueDate:ie.dueDate,startDate:ie.startDate,evidence:ie.evidence});on!==We&&H.push({eventType:"action-updated",entityType:"action",entityId:ie.id,summary:`Updated action in ${d} / ${f}`,componentId:d,lens:f,before:{text:Ee.text,status:Ee.status,owner:Ee.owner,actionType:Ee.actionType},after:{text:ie.text,status:ie.status,owner:ie.owner,actionType:ie.actionType},source:"local"})}),{...Ye(z),auditLog:se(q,H)}})},[se]),Ge=g.useCallback((d,f)=>{w(T=>{const q=T.objectives[d]||[],B={...T,objectives:{...T.objectives,[d]:f}};return JSON.stringify(q)!==JSON.stringify(f)?{...B,auditLog:se(T,[{eventType:"objectives-updated",entityType:"objective",entityId:d,summary:`Updated component outcomes for ${d}`,componentId:d,before:{objectiveCount:q.length},after:{objectiveCount:f.length},source:"local"}])}:B})},[se]),ke=g.useCallback(d=>{const f=zs(o.orgProfile);if(f.isValid)return!0;const T=f.errors.map(q=>`- ${q.message}`).join(`
`);return window.confirm(`${d} has CST warnings:

${T}

Continue anyway?`)},[o.orgProfile]),r=g.useCallback(d=>{ce(d)},[]),N=g.useCallback(()=>{if(!ke("Export JSON"))return;const f=Dt(o);Nn(`adoption-assessment-${(o.orgProfile.trustName||"export").replace(/\s+/g,"_")}.json`,JSON.stringify(f,null,2),"application/json"),r("Assessment export downloaded.")},[r,ke,o]),A=g.useCallback(()=>{var d;(d=de.current)==null||d.click()},[]),Z=g.useCallback(async d=>{var B,z,H,oe;const f=(B=d.target.files)==null?void 0:B[0];if(!f)return;const T=f.name.toLowerCase().endsWith(".json"),q=!f.type||Zi.has(f.type);if(!T||!q){r("Import failed. Please choose a valid JSON file."),window.alert("Import failed. Please choose a valid JSON file."),d.target.value="";return}if(f.size>Qi){r("Import failed. The selected file is larger than 5 MB."),window.alert("Import failed. The selected file is larger than 5 MB."),d.target.value="";return}try{const Ne=await f.text(),Ce=In(JSON.parse(Ne)),ie=()=>{w(gn=>{const ze=Ye($t(Ce,gn));return ze.orgProfile.cstId||(ze.orgProfile={...ze.orgProfile,cstId:St()}),{...ze,auditLog:se(ze,[{eventType:"data-imported",entityType:"system",summary:`Imported assessment data from ${f.name}`,after:{fileName:f.name},source:"local"}])}}),a("dashboard"),r("Assessment import complete. Dashboard updated.")};if(ir(o)){ie();return}const Ee=(z=Ce.orgProfile)==null?void 0:z.cstId,on=o.orgProfile.cstId,We=o.orgProfile.projectName||o.orgProfile.trustName||"your currently loaded programme",un=((H=Ce.orgProfile)==null?void 0:H.projectName)||((oe=Ce.orgProfile)==null?void 0:oe.trustName)||f.name;if(Ee&&Ee!==on){if(!window.confirm(`"${un}" looks like a different programme than "${We}".
